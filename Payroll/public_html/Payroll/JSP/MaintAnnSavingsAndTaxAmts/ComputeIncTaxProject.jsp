...
<jsp:include page="../../../COMMON/JSP/menu.jsp" flush="true" />
  ...
  <html:form  action="CompIncTaxProj" name="frmCompIncTaxProj" type="FCIPAY.Payroll.WEBTIER.Form.CompIncTaxProjForm" scope="session">
 	 ...
 	 <TR height="200">
           ...
           <TABLE cellspacing="0" cellPadding="0" >
              <TR>
                ...
                <td bgcolor="#4682B4" nowrap class=actTabText >COMPUTE INCOME TAX PROJECTION DETAILS<img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
...
<html:hidden name="frmCompIncTaxProj"  property="screenName" value="ComputeIncomeTaxProjScreen" />
...
{  
      ...
      if (frmCompIncTaxProj.hdnAction.value != 'SUB') 
      {
        ...
        frmCompIncTaxProj.action="../../../computeITProj.do";
...
{
  //alert("Refresh");
  frmCompIncTaxProj.action="../../../refreshPage.do";
...
function doQueryMode()
{
  ...
  frmCompIncTaxProj.action="../../../IncomeProjQueryAction.do"
  frmCompIncTaxProj.submit();
}
