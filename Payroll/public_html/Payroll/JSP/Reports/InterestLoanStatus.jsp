...
<html:form  action="IntLoanStatReportBaseAction" name="LICReportForm" type="FCIPAY.Payroll.WEBTIER.Form.GenerateLICReportForm" scope="session" >
...
function doGetReport()
{
      ...
      window.open("http://<%=oReportReader.getAppServerName()%>:<%=oReportReader.getAppServerPortNumber()%>/<%=oReportReader.getAppServerReportPathAlias()%>/rwservlet?<%=oParamUtil.getKeyinfo("Payroll","GenerateLoanIntStat","GenerateLoanIntReportkey").trim()%>&YYMM="+LICReportForm.txtYYMM.value,'',win_option);
}
</script>
