...
<table>
<TR height=30>
  <TD  colSpan=12 class=mainHeader height=10>BF RECOVERY REPORT</TD>
</TR>
</TABLE>
...
<TBODY>
  <TR>
    <TD>
       ...
       <TR>
          <TD class=subHeader colspan=6> BF Recovery Report</TD>
        </TR>
        <TR>
 	 ...
 	 <TR height="100">
		...
		<!-- Detail table Container starts -->
              ...
              onclick="return ShowLovEmpNo();" >
                ...
                <html:hidden  property="txtPayCode" value="88"  />
                </tr>           
  ...
  <TR>
     <TD colspan="16" align=right bgColor=#4682b4 colSpan=8><IMG height=1 src="../includes/images/pixel.gif" width=1  border=0></TD>
      ...
      <TR>
               ...
               <td  bgcolor=#4682b4><html:button value=' BF RECOVERY REPORT'  onclick="doGetReport()" property="butInsert" styleClass="bottomBarText" /></td>
...
function doGetReport()
{
	...
	else
	{
		...
		{
			var winurl="BF_advanceRec.rdf&P_EMP_NUM="+LoanRecoveryRepForm.txtEmp.value+"&P_STARTYR="+LoanRecoveryRepForm.txtFromYYMM.value+"&P_ENDYR="+LoanRecoveryRepForm.txtToYYMM.value+"&P_LOCATION="+LoanRecoveryRepForm.loginLocCode.value+"&P_EMP_FLG="+LoanRecoveryRepForm.hdnEmpLbrFlag.value;
...
<!-- Container Table Ends -->
    ...
    <html:hidden name="LoanRecoveryRepForm"  property="screenName" value="BFRecoveryRep" />
...
<!--    <html:hidden property="txtEmp" name="LoanRecoveryRepForm"  />    -->     
    ...
    <html:hidden property="txtCpfCode" name="LoanRecoveryRepForm"  />          <!--added by dushyant on 20-08-2010-->          
...
{  
  ...
  if(mode != 'Q' )
  {
    LoanRecoveryRepForm.action="../../../BFRecoveryRepGetAccess.do";
...
function ShowLovEmpNo()
{
        ...
        LoanRecoveryRepForm.queryParam.value="txtSiteID="+ LoanRecoveryRepForm.loginLocCode.value +" " ; 
        LoanRecoveryRepForm.txtSearchFields.value = "Payroll.PaySlip.Emp,Payroll.PaySlip.EmpName,Payroll.Report.cpfCode";
...
function ShowLovLoanType()
{
        ...
        LoanRecoveryRepForm.queryParam.value="" ; 
