...
<table>
<TR height=30>
  <TD  colSpan=12 class=mainHeader height=10>ADVANCE OUTSTANDING REPORT</TD>
</TR>
</TABLE>
...
<TBODY>
  <TR>
    <TD>
       ...
       <TR>
          <TD class=subHeader colspan=6> Advance Outstanding Report</TD>
        </TR>
        <TR>
 ...
 <table cellspacing=0 cellpadding=0 border=0>
 	 ...
 	 <TR height="100">
		...
		<!-- Detail table Container starts -->
              <td class="labelText"  align="left">Outstanding as on (YYYYMM) </td><td>
              ...
              <TR >
                <TD class=labelText >                
                Advance Type</TD>
                <td  align="left"><html:text  property="txtPayCode" maxlength="10" size="23" styleClass="required" />
                <img src="../INCLUDES/IMAGES/lov.jpg" height="16" align="center" property="buttxtYYMM" 
              onclick="return ShowLovAdvType();" >
                <html:text property="txtPayCodeDesc" size="30" value="" styleClass="locked" readonly="true" /></td>
                </td>
                </tr>           
  ...
  <TR>
     <TD colspan="16" align=right bgColor=#4682b4 colSpan=8><IMG height=1 src="../includes/images/pixel.gif" width=1  border=0></TD>
      ...
      <TR>
               ...
               <td  bgcolor=#4682b4><html:button value=' ADVANCE OUTSTANDING REPORT'  onclick="doGetReport()" property="butInsert" styleClass="bottomBarText" /></td>
...
{
    if  (parseInt(document.all.txtPayCode.value)==61)
    {
      var winurl="PLI_adv.rdf&P_YYYYMM="+AdvRecoveryRepForm.txtFromYYMM.value+"&LOC_ID="+AdvRecoveryRepForm.loginLocCode.value+"&LOAN_TYPE="+AdvRecoveryRepForm.txtPayCode.value+"&P_EMP_TYPE="+AdvRecoveryRepForm.hdnEmpLbrFlag.value;
    }
    else
    {
      var winurl= "LOAN_adv.rdf&P_YYYYMM="+AdvRecoveryRepForm.txtFromYYMM.value+"&LOC_ID="+AdvRecoveryRepForm.loginLocCode.value+"&LOAN_TYPE="+AdvRecoveryRepForm.txtPayCode.value+"&P_EMP_TYPE="+AdvRecoveryRepForm.hdnEmpLbrFlag.value;
    }
...
<!-- Container Table Ends -->
    ...
    <html:hidden name="AdvRecoveryRepForm"  property="screenName" value="AdvOutRep" />
...
{  
  ...
  if(mode != 'Q' )
  {
    AdvRecoveryRepForm.action="../../../AdvOutRepGetAccess.do";
...
function ShowLovAdvType()
{
		...
		AdvRecoveryRepForm.queryParam.value = "hdnEmpLbrFlag="+AdvRecoveryRepForm.hdnEmpLbrFlag.value+",screenName="+AdvRecoveryRepForm.screenName.value+",screenMode="+AdvRecoveryRepForm.screenMode.value+",txtSiteID="+AdvRecoveryRepForm.loginLocCode.value; // added by swapnendu Dt 07 Sep 2012.
