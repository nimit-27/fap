...
<table>
<TR height=30>
  <TD  colSpan=12 class=mainHeader height=10>PAY SLIP REPORT</TD>
</TR>
</TABLE>
 ...
 <table cellspacing=0 cellpadding=0 border=0>
 	 ...
 	 <TR height="100">
		...
		<!-- Detail table Container starts -->
              <td class="labelText"  width="45%" align="center"><bean:message key="Payroll.PaySlip.Year" /></td>
              <td colspan=2>
              ...
              <table border=0 cellpadding=0>
               <TR height=40 >
                ...
                <bean:message key="Payroll.PaySlip.EmpNumber"  />  
                    <td  align="left">
                    <html:text  property="txtEmp" maxlength="10" size="20" styleClass="optional" 
                    onchange=
                      "if(!(checkEmployee(PaySlipReportForm.txtEmp.value,PaySlipReportForm.loginLocCode.value)))
                      {
                        PaySlipReportForm.txtEmp.value='';
                      }"
                    />
  ...
  <TR>
     <TD colspan="16" align=right bgColor=#4682b4 colSpan=8><IMG height=1 src="../includes/images/pixel.gif" width=1  border=0></TD>
        ...
        <TR>
              ...
              <td  bgcolor=#4682b4 id="genrptid"><html:button value='GENERATE PAY SLIP REPORT' onclick="return doGetReport();" property="butInsert" styleClass="bottomBarText" /> </td>
...
{  
	if(mandatory_Check('PaySlipReportForm'))
	{
		...
		if(lbr_flag == 'E')
		{
			var winurl ='payslip.rdf&P_EMP_NUM='+PaySlipReportForm.txtEmp.value+'&P_YYMM='+PaySlipReportForm.txtYYMM.value+'&P_LOCATION_CODE='+PaySlipReportForm.loginLocCode.value+'&P_EMP_FLG='+PaySlipReportForm.hdnEmpLbrFlag.value;
...
<!-- Container Table Ends -->
    ...
    <html:hidden name="PaySlipReportForm"  property="screenName" value="PaySlipReport" />
...
{  
  ...
  if(mode != 'Q' )
  {
    PaySlipReportForm.action="../../../PaySlipGetAccess.do";
...
/*function showStatus() 
{
    var responseStatus = <%= request.getAttribute("status")%>;
    alert(responseStatus);
    if(responseStatus == 'Downloaded')
    {
      document.getElementById('loader').style.visibility = 'hidden';
      document.PaySlipReportForm.butInsert.disabled = '';
    }
}showStatus()*/
...
function ShowLovEmpNo()
{
        ...
        PaySlipReportForm.queryParam.value="txtSiteID="+ PaySlipReportForm.loginLocCode.value +",hdnEmpLbrFlag="+PaySlipReportForm.hdnEmpLbrFlag.value ; 
