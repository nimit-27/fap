...
<TR height=30>
    <%if(lbrType.equals("L")){%>
        <TD  colSpan=12 class=mainHeader height=10>PAY SLIP REPORT (DEPARTMENTAL LABOURS)</TD>
    <%}else if(lbrType.equals("N")){%>
        <TD  colSpan=12 class=mainHeader height=10>PAY SLIP REPORT (NWNP LABOURS)</TD>
    <%}else{%>
        <TD  colSpan=12 class=mainHeader height=10>PAY SLIP REPORT (DPS LABOURS)</TD>
    <%}%>
</TR>
</TABLE>
...
if(mandatory_Check('PaySlipReportForm'))
{
	...
	if (lbr_flag == 'L')
	{
		var winurl="labour_payslip.rdf&P_EMP_NUM="+PaySlipReportForm.txtEmp.value+"&P_YYMM="+PaySlipReportForm.txtYYMM.value+"&P_LOCATION_CODE="+PaySlipReportForm.loginLocCode.value+"&P_EMP_FLG="+PaySlipReportForm.hdnEmpLbrFlag.value+"&P_Depot_CODE="+PaySlipReportForm.txtLocId.value+"&P_Gang_CODE="+PaySlipReportForm.headerPrimaryKey.value;
	}
	else
	{
	    var winurl="labour_payslip.rdf&P_EMP_NUM="+PaySlipReportForm.txtEmp.value+"&P_YYMM="+PaySlipReportForm.txtYYMM.value+"&P_LOCATION_CODE="+PaySlipReportForm.loginLocCode.value+"&P_EMP_FLG="+PaySlipReportForm.hdnEmpLbrFlag.value+"&P_Depot_CODE="+PaySlipReportForm.txtLocId.value+"&P_Gang_CODE="+PaySlipReportForm.headerPrimaryKey.value;
...
if(document.all.hdnEmpLbrFlag.value=='L')
  ...
  if(mode != 'Q' )
  {
    PaySlipReportForm.action="../../../PaySlipDepGetAccess.do"
