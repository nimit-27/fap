...
<html:html>
  ...
  <BODY scroll=no onload="lfnLoad();history.forward(1);" onbeforeunload="confWindowClose()" onunload="handleOnClose()" oncontextmenu="return false">
                                    ...
                                    <TABLE cellSpacing=0 cellPadding=0 border = 0 id="Detail">
                                      <TBODY>
                                        <TR height="20">
                                          ...
                                          <TD class=tableHeader width="10%">Pay Scale</TD>
                                        ...
                                        <logic:iterate id="splDutyAllowInfo" name="frmMaintSplDutyAllow" property="lstInstrIdaDtls" type="FCIPAY.Payroll.UTILITY.MaintSplDutyAllowBean" >
                                        <% ++i; %>
                                          <logic:notEqual name="splDutyAllowInfo" property="status" value="D" >                              
                                            <tr>   
                                              ...
                                              <td colspan="1"><html:select property="txtCtgry" name="splDutyAllowInfo" disabled="true" styleClass="required" alt="<%=String.valueOf(i)%>" onchange="checkDuplicacy(this.alt); return changed(this.alt)"  style="WIDTH: 100%"  >
                                              ...
                                              <td ><html:text property="txtPayScale" readonly="true" name="splDutyAllowInfo" size="9" styleClass="optional" style="width:87%;text-align:left" alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt)" />
                                                <img src="../INCLUDES/IMAGES/lov.jpg" height="16" align="center" alt="<%=String.valueOf(i)%>" property="buttxtPayScale" >
                                              </td> 
                                              <td colspan="1"><html:select property="txtArea" name="splDutyAllowInfo"  styleClass="optional" alt="<%=String.valueOf(i)%>" disabled="true" onchange="checkDuplicacy(this.alt); return changed(this.alt)"  style="WIDTH: 100%"  >
                                                              <html:option value="" >-----------Please Select-----------</html:option>      
                                                                <logic:present name="SplDutyCombo">
                                              ...
                                              <td ><html:text property="txtAllow" name="splDutyAllowInfo" size="9" maxlength="10" readonly="true" styleClass="required" style="width:100%;text-align:right" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 && event.keyCode!=46  || event.keyCode > 57))return false;" onchange="return changed(this.alt)" />
                                              </td>
                                              ...
                                              <td ><html:text property="txtPayScale" readonly="true" name="splDutyAllowInfo" size="9" styleClass="optional" style="width:87%;text-align:left" alt="<%=String.valueOf(i)%>" onchange="checkDuplicacy(this.alt); return changed(this.alt)" />
                                                <img src="../INCLUDES/IMAGES/lov.jpg" height="16" align="center" alt="<%=String.valueOf(i)%>" property="buttxtPayScale"  onclick="ShowLovPayScale(this.alt);" >
                                              </td> 
                                              ...
                                              <html:hidden property="txtDsgn" name="splDutyAllowInfo" />
                                          ...
                                          <logic:equal name="splDutyAllowInfo" property="status" value="D" >
                                            <tr>
                                              ...
                                              <td ><html:hidden property="txtPayScale" name="splDutyAllowInfo" /></td>
                                              <html:hidden property="txtDsgnId" name="splDutyAllowInfo" />
   ...
   <!-- Container Table Ends -->
      ...
      <html:hidden name="frmMaintSplDutyAllow"  property="screenName" value="SplDutyIdaScreen" />
...
function lfnLoad()
{
  ...
  function doBaseAddRow()
  {
    if(mandatory_Check("frmMaintSplDutyAllow"))
    {
      ...
      document.forms[0].action = "../../../SplDutyIdaAddRowAction.do";
  ...
  function SaveRecord()
  {
    ...
    { 
      ...
      document.all.butSave.disabled="true";
      document.all.butSave.src="../INCLUDES/IMAGES/save_dis.jpg";
      frmMaintSplDutyAllow.action = "../../../SplDutyIdaSaveAction.do";
  ...
  function doQueryMode()
  {
    ...
    frmMaintSplDutyAllow.action="../../../SplDutyIdaQueryAction.do"
    frmMaintSplDutyAllow.submit();
  }
  ...
  function GetDetail()
  {
    document.all.flagIda.value=true;
    document.all.screenMode.value='U'; 
    frmMaintSplDutyAllow.action="../../../SplDutyIdaGetDetailAction.do"
    frmMaintSplDutyAllow.submit();
  }

  function doRefresh()
  {
    frmMaintSplDutyAllow.action="../../../SplDutyIdaRefresh.do"
    frmMaintSplDutyAllow.submit();
  }
  ...
  if(strRecList!='')
  {
    ...
    document.forms[0].action = "../../../SplDutyIdaDeleteRowAction.do";
    document.forms[0].submit();  
  }
  ...
  function getTab(arg)
  {
    ...
    document.forms[0].action="../../../SplDutyIdaTabAction.do";
    document.forms[0].submit();
  }
  ...
  function JumpDetail()
  {
    ...
    frmMaintSplDutyAllow.action = "../../../SplDutyIdaNextDetailAction.do";
    frmMaintSplDutyAllow.submit();
  }
  
  function ShowLovPayScale(i)
  {
   frmMaintSplDutyAllow.lovKey.value = "SCAPayScale" +frmMaintSplDutyAllow.screenName.value + "N";
   frmMaintSplDutyAllow.txtDisplayFields.value = "txtPayScale";
...
function getHeaderRecord()
{
    ...
    frmMaintSplDutyAllow.action="../../../SplDutyIdaGetHeaderAction.do"
    frmMaintSplDutyAllow.submit();
}
...
{ 
    ...
    frmMaintSplDutyAllow.action="../../../SplDutyIdaGetNextHeader.do";
    frmMaintSplDutyAllow.submit();
}
...
{
  frmMaintSplDutyAllow.action="../../../SplDutyIdaInsertAction.do"
  frmMaintSplDutyAllow.submit();
}
