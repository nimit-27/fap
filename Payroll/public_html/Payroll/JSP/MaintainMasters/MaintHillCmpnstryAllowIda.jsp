                    ...
                    <TD colspan=11>
                      <TABLE cellSpacing=0 cellPadding=0 border=0>
                        <TBODY>
                         ...
                         <logic:iterate id="hillCmpnstryAllowInfo" name="frmMaintHillCmpnstryAllow" property="lstInstrIdaDtls" type="FCIPAY.Payroll.UTILITY.MaintHillCmpnstryAllowBean" >
                              <% ++i; %>
                                <logic:notEqual name="hillCmpnstryAllowInfo" property="status" value="D" >                              
                                   <tr>   <% ++j; %>
                                      ...
                                      <td align=center ><html:checkbox property="checked" name="frmMaintHillCmpnstryAllow" onclick="checkRecord();" value="false" /></td>
                                       ...
                                       <td colspan="1"><html:select property="txtCtgry" name="hillCmpnstryAllowInfo"  styleClass="required" alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt)"  style="WIDTH: 100%"  >
                                       ...
                                       <td ><html:text property="txtBasicFrom" name="hillCmpnstryAllowInfo" size="9" maxlength="10"  styleClass="required" style="width:100%;text-align:right" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt)" onblur="
                                   ...
                                   if(!(chk_ToAmount(this.value, this.alt)))
                                    ...
                                    "  /></td>  
                                       ...
                                       <td colspan="1"><html:select property="txtCtgry" name="hillCmpnstryAllowInfo" disabled="true" styleClass="required" alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt)"  style="WIDTH: 100%"  >
                                          <html:option value="" >-----------Please Select-----------</html:option>      
                                          <logic:present name="EmpCtgry">
                                            <html:optionsCollection label="label" value="value" property="ctgryList" name="EmpCtgry"/>
                                          </logic:present>
                                       ...
                                       <td ><html:text property="txtBasicFrom" name="hillCmpnstryAllowInfo" size="9" maxlength="10" readonly="true" styleClass="required" style="width:100%;text-align:right" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt)" onblur="
                                        if(!(chk_FromAmount(this.value, this.alt)))
                                        {
                                          this.focus();
                                          return false;
                                  ...
                                  <logic:equal name="hillCmpnstryAllowInfo" property="status" value="D" >
                                   <tr>
                                       ...
                                       <td ><html:hidden property="txtCtgry" name="hillCmpnstryAllowInfo" /></td>
...
<html:hidden property="txtPayScaleTyp" name="frmMaintHillCmpnstryAllow" value="IDA" />
<html:hidden name="frmMaintHillCmpnstryAllow"  property="screenName" value="HillCmpnstryIdaScreen" />
...
function doBaseAddRow()
{
  if(mandatory_Check("frmMaintHillCmpnstryAllow"))
  {
    ...
    document.forms[0].action = "../../../HillCmpnstryIdaAddRowAction.do";
...
function SaveRecord()
{
  ...
  var iTr2 = oTable.rows.length;
	...
	frmMaintHillCmpnstryAllow.action = "../../../HillCmpnstryIdaSaveAction.do";
...
function doQueryMode()
{
  ...
  frmMaintHillCmpnstryAllow.action="../../../HillCmpnstryIdaQueryAction.do"
  frmMaintHillCmpnstryAllow.submit();
}
...
function GetDetail()
{
  document.all.screenMode.value='U';
  document.all.flagIda.value='true';
  frmMaintHillCmpnstryAllow.action="../../../HillCmpnstryIdaGetDetailAction.do"
  frmMaintHillCmpnstryAllow.submit();
}

function doRefresh()
{
  frmMaintHillCmpnstryAllow.action="../../../HillCmpnstryIdaRefresh.do"
  frmMaintHillCmpnstryAllow.submit();
}
...
function doBaseDelRow()
{
  ...
  document.forms[0].action = "../../../HillCmpnstryIdaDeleteRowAction.do";
  document.forms[0].submit();  
}
...
function getTab(arg)
 {
   ...
   // frmMaintHillCmpnstryAllow.headerPrimaryKey[0].disabled="";
    ...
    document.forms[0].action="../../../HillCmpnstryIdaTabAction.do";
    document.forms[0].submit();
 }
...
//                document.getElementsByName("txtBasicFrom")[i-1].select(); 
 ...
 function JumpDetail()
 {
    ...
    frmMaintHillCmpnstryAllow.action = "../../../HillCmpnstryIdaNextDetailAction.do";
    frmMaintHillCmpnstryAllow.submit();
 ...
 function chkFromDt(i)
{
  ...
  {
    frmMaintHillCmpnstryAllow.action="../../../HillCmpnstryIdaInsertAction.do"
    frmMaintHillCmpnstryAllow.submit();
  }
 ...
 function getHeaderRecord()
{
    ...
    frmMaintHillCmpnstryAllow.action="../../../HillCmpnstryIdaGetHeaderAction.do"
    frmMaintHillCmpnstryAllow.submit();
}
...
{ 
    ...
    frmMaintHillCmpnstryAllow.action="../../../HillCmpnstryIdaGetNextHeader.do";
    frmMaintHillCmpnstryAllow.submit();
}
