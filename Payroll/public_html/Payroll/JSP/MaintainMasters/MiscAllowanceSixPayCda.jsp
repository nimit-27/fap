...
<!--container table starts -->
      <TABLE cellSpacing=0 cellPadding=0 border=0 >
       ...
       <!--  Header Row Starts -->
                <TR>
                  <TD class=subHeader colspan=6>Header For Miscellaneous Allowance - CDA</TD>
                </TR>
                <TR>
                                  ...
                                  <DIV id=divDtlTable style="height:380px" >
                                    ...
                                    <TABLE cellSpacing=0 cellPadding=0 id="Detail">
                                      <TBODY>
                                        ...
                                        <logic:iterate id="MiscAllowId" name="frmMiscellaneousAllowance" property="lstSCADtlsCDA" type="FCIPAY.Payroll.UTILITY.MiscAllowanceSixPayBean" indexId="idx">
                                        <% ++i; %>
                                          <logic:notEqual name="MiscAllowId" property="status" value="D" >                              
                                            <tr>
                                              ...
                                              <logic:equal name="MiscAllowId" property="status" value="N" >
													...
													<td colspan="1">
														<html:text property="txtGrade" name="MiscAllowId"  styleClass="required" maxlength="10"  alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="return changed(this.alt)" style="width:94%;text-align:right"  />
                                              ...
                                              <html:hidden property="cboCatg" name="MiscAllowId" />
...
<!-- Container Table Ends -->
      ...
      <html:hidden property="txtPayScaleTyp" name="frmMiscellaneousAllowance" value="CDA"  />
      <html:hidden name="frmMiscellaneousAllowance" property="screenName" value="MiscAllowanceScreenCDA" />
...
function chkFromDt(i)
{
  ...
  function doBaseAddRow()
  {
    if(mandatory_Check("frmMiscellaneousAllowance"))
    {
      ...
      document.forms[0].action = "../../../MiscAllowanceSixPayCdaAddRowAction.do";
  ...
  function SaveRecord()
  {
		if(mandatory_Check("frmMiscellaneousAllowance"))
		{
			...
			document.all.butSave.disabled="true";
			document.all.butSave.src="../INCLUDES/IMAGES/save_dis.jpg";
			frmMiscellaneousAllowance.action = "../../../MiscAllowanceSixPayCdaSaveAction.do";
  ...
  function doQueryMode()
  {
    ...
    frmMiscellaneousAllowance.action="../../../MiscAllowanceSixPayCdaQueryMode.do"
    frmMiscellaneousAllowance.submit();
  }

  function doInsertMode()
  {
    frmMiscellaneousAllowance.action="../../../MiscAllowanceSixPayCdaNewMode.do"
    frmMiscellaneousAllowance.submit();
  }
  ...
  function GetDetail()
  {
    document.all.screenMode.value='U';
    document.all.flagCda.value=true;
    frmMiscellaneousAllowance.action="../../../MiscAllowanceSixPayCdaDetailAction.do"
    frmMiscellaneousAllowance.submit();
  }

  function doRefresh()
  {
    frmMiscellaneousAllowance.action="../../../MiscAllowanceSixPayCdaRefresh.do"
    frmMiscellaneousAllowance.submit();
  }
  ...
  if(strRecList!='')
  {
    ...
    document.forms[0].action = "../../../MiscAllowanceSixPayCdaDeleteRowAction.do";
    document.forms[0].submit();  
  }
  ...
  function getTab(arg)
  {
    ...
    document.forms[0].action="../../../MiscAllowCdaTabAction.do";
    document.forms[0].submit();
  }
 ...
 function getHeaderRecord()
{
    ...
    frmMiscellaneousAllowance.action="../../../MiscAllowanceSixPayCdaGetHeaderAction.do"
    frmMiscellaneousAllowance.submit();
}
...
{ 
    ...
    frmMiscellaneousAllowance.action="../../../MiscAllowanceSixPayCdaGetNextHeader.do";
    frmMiscellaneousAllowance.submit();
}
