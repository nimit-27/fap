...
<html:html>
  ...
  <BODY scroll=no onload="lfnLoad();history.forward(1);" onbeforeunload="confWindowClose()" onunload="handleOnClose()" oncontextmenu="return false">
                                    ...
                                    <TABLE cellSpacing=0 cellPadding=0 border = 0 id="Detail">
                                      <TBODY>
                                        <TR height="20">
                                          ...
                                          <TD class=tableHeader width="8%">Remote Area</TD>
                                        ...
                                        <logic:iterate id="rmtAreaAllowInfo" name="frmMaintRmtAreaAllow" property="lstInstrCdaDtls" type="FCIPAY.Payroll.UTILITY.MaintRmtAreaAllowBean" >
                                        <% ++i; %>
                                          <logic:notEqual name="rmtAreaAllowInfo" property="status" value="D" >                              
                                            <tr>   
                                              ...
                                              <td ><html:text property="txtBasicFrom" name="rmtAreaAllowInfo" maxlength="10" readonly="true" size="9" styleClass="required" style="width:100%;text-align:right" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="return changed(this.alt)" onblur="
                                              ...
                                              <td colspan="1"><html:text property="txtBasicTo" name="rmtAreaAllowInfo" readonly="true" styleClass="required" maxlength="10" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="return changed(this.alt)" style="width:100%;text-align:right" onblur="
                                              ...
                                              <td ><html:text property="txtBasicFrom" name="rmtAreaAllowInfo" maxlength="10" size="9" styleClass="required" style="width:100%;text-align:right" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="return changed(this.alt)" onblur="
                                                    if(!(chk_FromAmount(this.value, this.alt)))
                                                    {
                                                      this.focus();
                                                      return false;
                                              ...
                                              <td colspan="1"><html:text property="txtBasicTo" name="rmtAreaAllowInfo"  styleClass="required" maxlength="10" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="return changed(this.alt)" style="width:100%;text-align:right" onblur="
                                                               if(!(chk_ToAmount(this.value, this.alt)))
                                                                    {
                                                                      this.focus();
                                                                        return false;
                                              ...
                                              <html:hidden property="txtCtgry" name="rmtAreaAllowInfo"  />
                                            </tr>
                                          </logic:notEqual>
   ...
   <!-- Container Table Ends -->
      ...
      <html:hidden name="frmMaintRmtAreaAllow"  property="screenName" value="RmtAreaCdaScreen" />
...
function lfnLoad()
{
  ...
  function doBaseAddRow()
  {
    if(mandatory_Check("frmMaintRmtAreaAllow"))
    {
     ...
     for(indx=0;indx < iTr2-1;indx++)
     {
      ...
      document.forms[0].action = "../../../RmtAreaCdaAddRowAction.do";
  ...
  function SaveRecord()
  {
    ...
    { 
     ...
     for(indx=0;indx < iTr2-1;indx++)
     {
      ...
      document.all.butSave.disabled="true";
      document.all.butSave.src="../INCLUDES/IMAGES/save_dis.jpg";
      frmMaintRmtAreaAllow.action = "../../../RmtAreaCdaSaveAction.do";
  ...
  function doQueryMode()
  {
    ...
    frmMaintRmtAreaAllow.action="../../../RmtAreaCdaQueryAction.do"
    frmMaintRmtAreaAllow.submit();
  }
  ...
  function GetDetail()
  {
    document.all.screenMode.value='U';
    document.all.flagCda.value=true;
    frmMaintRmtAreaAllow.action="../../../RmtAreaCdaGetDetailAction.do"
    frmMaintRmtAreaAllow.submit();
  }

  function doRefresh()
  {
    frmMaintRmtAreaAllow.action="../../../RmtAreaCdaRefresh.do"
    frmMaintRmtAreaAllow.submit();
  }
  ...
  if(strRecList!='')
  {
    ...
    document.forms[0].action = "../../../RmtAreaCdaDeleteRowAction.do";
    document.forms[0].submit();  
  }
  ...
  function getTab(arg)
  {
    ...
    document.forms[0].action="../../../RmtAreaCdaTabAction.do";
    document.forms[0].submit();
  }
 ...
 function getHeaderRecord()
{
    ...
    frmMaintRmtAreaAllow.action="../../../RmtAreaCdaGetHeaderAction.do"
    frmMaintRmtAreaAllow.submit();
}
...
{ 
    ...
    frmMaintRmtAreaAllow.action="../../../RmtAreaCdaGetNextHeader.do";
    frmMaintRmtAreaAllow.submit();
}
...
function doBasePrevDetail()
{
    ...
    frmMaintRmtAreaAllow.action = "../../../RmtAreaCdaNextDetailAction.do";
    frmMaintRmtAreaAllow.submit();
}
...
{
  frmMaintRmtAreaAllow.action="../../../RmtAreaCdaInsertAction.do"
  frmMaintRmtAreaAllow.submit();
}
