                                ...
                                <DIV id=divDtlTable style="height:320px" >
                                  ...
                                  <TABLE cellSpacing=0 cellPadding=0 border = 0 id="Detail">
                                    <TBODY>
                                      ...
                                      <logic:iterate id="trblAreaAllowInfo" name="frmMaintTrblAreaAllow" property="lstInstrIdaDtls" type="FCIPAY.Payroll.UTILITY.MaintTrblAreaAllowBean" >
                                      <% ++i; %>
                                        <logic:notEqual name="trblAreaAllowInfo" property="status" value="D" >                              
                                          <tr>   
                                            ...
                                            <td colspan="1"><html:select property="txtCtgry" name="trblAreaAllowInfo" disabled="true" styleClass="required" alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt)"  style="WIDTH: 100%"  >
                                            ...
                                            <td colspan="1"><html:text property="txtBasicTo" name="trblAreaAllowInfo" readonly="true" maxlength="10"  styleClass="required" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="return changed(this.alt)" style="width:100%;text-align:right" onblur="
                                            ...
                                            <td ><html:text property="txtAllow" name="trblAreaAllowInfo" readonly="true" maxlength="10" size="9" styleClass="required" style="width:100%;text-align:right" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="return changed(this.alt)" />
                                            </td>
                                            </logic:notEqual>
                                            
                                            <logic:equal name="trblAreaAllowInfo" property="status" value="N" >
                                            <td colspan="1"><html:select property="txtCtgry" name="trblAreaAllowInfo"  styleClass="required" alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt)"  style="WIDTH: 100%"  >
                                                              <html:option value="" >-----------Please Select-----------</html:option>      
                                                                <logic:present name="EmpCtgry">
                                                                  <html:optionsCollection label="label" value="value" property="ctgryList" name="EmpCtgry"/>
                                                                </logic:present>
                                            ...
                                            <td ><html:text property="txtAllow" name="trblAreaAllowInfo" maxlength="10" size="9" styleClass="required" style="width:100%;text-align:right" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="return changed(this.alt)" />
                                            </td>
                                            </logic:equal>
                                        ...
                                        <logic:equal name="trblAreaAllowInfo" property="status" value="D" >
                                          <tr>
                                            ...
                                            <td ><html:hidden property="txtCtgry" name="trblAreaAllowInfo" /></td>
...
<!-- Container Table Ends -->
    ...
    <html:hidden name="frmMaintTrblAreaAllow"  property="screenName" value="TrblAreaIdaScreen" />
...
function doBaseAddRow()
{
  if(mandatory_Check("frmMaintTrblAreaAllow"))
  {
    ...
    document.forms[0].action = "../../../TrblAreaIdaAddRowAction.do";
...
function SaveRecord()
{
  ...
  var iTr2 = oTable.rows.length;
	...
	document.all.butSave.disabled="true";
	document.all.butSave.src="../INCLUDES/IMAGES/save_dis.jpg";
	frmMaintTrblAreaAllow.action = "../../../TrblAreaIdaSaveAction.do";
...
function doQueryMode()
{
  ...
  frmMaintTrblAreaAllow.action="../../../TrblAreaIdaQueryAction.do"
  frmMaintTrblAreaAllow.submit();
}
...
function GetDetail()
{
  document.all.screenMode.value='U';
  document.all.flagIda.value=true;
  frmMaintTrblAreaAllow.action="../../../TrblAreaIdaGetDetailAction.do"
  frmMaintTrblAreaAllow.submit();
}

function doRefresh()
{
  frmMaintTrblAreaAllow.action="../../../TrblAreaIdaRefresh.do"
  frmMaintTrblAreaAllow.submit();
}
...
function doBaseDelRow()
{
  ...
  document.forms[0].action = "../../../TrblAreaIdaDeleteRowAction.do";
  document.forms[0].submit();  
}
...
function getTab(arg)
 {
   ...
   // frmMaintHillCmpnstryAllow.headerPrimaryKey[0].disabled="";
    ...
    document.forms[0].action="../../../TrblAreaIdaTabAction.do";
    document.forms[0].submit();
 }
...
//                document.getElementsByName("txtBasicFrom")[i-1].select(); 
   ...
   function JumpDetail()
 {
    ...
    frmMaintTrblAreaAllow.action = "../../../TrblAreaIdaNextDetailAction.do";
    frmMaintTrblAreaAllow.submit();
 ...
 function getHeaderRecord()
{
    ...
    frmMaintTrblAreaAllow.action="../../../TrblAreaIdaGetHeaderAction.do"
    frmMaintTrblAreaAllow.submit();
}
...
{ 
    ...
    frmMaintTrblAreaAllow.action="../../../TrblAreaIdaGetNextHeader.do";
    frmMaintTrblAreaAllow.submit();
}
...
{
  frmMaintTrblAreaAllow.action="../../../TrblAreaIdaInsertAction.do"
  frmMaintTrblAreaAllow.submit();
}
