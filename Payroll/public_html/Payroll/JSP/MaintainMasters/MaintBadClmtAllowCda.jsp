...
<html:html>
  ...
  <BODY scroll=no onload="lfnLoad();history.forward(1);" onbeforeunload="confWindowClose()" onunload="handleOnClose()" oncontextmenu="return false">
    ...
    <html:form  action="MaintBadClmtAllow" name="frmMaintBadClmtAllow" type="FCIPAY.Payroll.WEBTIER.Form.MaintBadClmtAllowForm" scope="session">
      ...
      <table>
        <TR height=30>
          <TD  colSpan=11 class=mainHeader height=10>Test BAD CLIMATE ALLOWANCE</TD>
        </TR>
                                  ...
                                  <!-- Detail table starts -->
                                    <TABLE cellSpacing=0 cellPadding=0 border = 0 id="Detail">
                                      <TBODY>
                                        ...
                                        <logic:iterate id="badClmtAllowInfo" name="frmMaintBadClmtAllow" property="lstInstrCdaDtls" type="FCIPAY.Payroll.UTILITY.MaintBadClmtAllowBean" >
                                        <% ++i; %>
   ...
   <!-- Container Table Ends -->
      ...
      <html:hidden property="txtPayScaleTyp" name="frmMaintBadClmtAllow" value="CDA"  />
      <html:hidden name="frmMaintBadClmtAllow"  property="screenName" value="BadClmtCdaScreen" />
...
function chkFromDt(i)
{
  ...
  function doBaseAddRow()
  {
    if(mandatory_Check("frmMaintBadClmtAllow"))
    {
      ...
      document.forms[0].action = "../../../BadClmtCdaAddRowAction.do";
  ...
  function SaveRecord()
  {
    if(mandatory_Check("frmMaintBadClmtAllow"))
    {
      ...
      document.all.butSave.disabled="true";
      document.all.butSave.src="../INCLUDES/IMAGES/save_dis.jpg";
      frmMaintBadClmtAllow.action = "../../../BadClmtCdaSaveAction.do";
  ...
  function doQueryMode()
  {
    ...
    frmMaintBadClmtAllow.action="../../../BadClmtCdaQueryAction.do"
    frmMaintBadClmtAllow.submit();
  }

  function doInsertMode()
  {
    frmMaintBadClmtAllow.action="../../../BadClmtCdaInsertAction.do"
    frmMaintBadClmtAllow.submit();
  }
  function GetDetail()
  {
    document.all.screenMode.value='U';
      document.all.flagCda.value=true;
    frmMaintBadClmtAllow.action="../../../BadClmtCdaGetDetailAction.do"
    frmMaintBadClmtAllow.submit();
  }

  function doRefresh()
  {
    frmMaintBadClmtAllow.action="../../../BadClmtCdaRefresh.do"
    frmMaintBadClmtAllow.submit();
  }
  ...
  if(strRecList!='')
  {
    ...
    document.forms[0].action = "../../../BadClmtCdaDeleteRowAction.do";
    document.forms[0].submit();  
  }
  ...
  function getTab(arg)
  {
    ...
    document.forms[0].action="../../../BadClmtCdaTabAction.do";
    document.forms[0].submit();
  }
  ...
  function JumpDetail()
  {
    ...
    frmMaintBadClmtAllow.action = "../../../BadClmtCdaNextDetailAction.do";
    frmMaintBadClmtAllow.submit();
  }
 ...
 function getHeaderRecord()
{
    ...
    frmMaintBadClmtAllow.action="../../../BadClmtCdaGetHeaderAction.do"
    frmMaintBadClmtAllow.submit();
}
...
{ 
    ...
    frmMaintBadClmtAllow.action="../../../BadClmtCdaGetNextHeader.do";
    frmMaintBadClmtAllow.submit();
}
