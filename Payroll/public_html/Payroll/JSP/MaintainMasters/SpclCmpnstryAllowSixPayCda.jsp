                                    ...
                                    <TABLE cellSpacing=0 cellPadding=0 id="Detail">
                                      <TBODY>
                                        <TR height="22">
                                          ...
                                          <TD class=tableHeader width="15%">Pay Band</TD>
                                          <TD class=tableHeader width="15%">Grade</td>
                                          <TD class=tableHeader width="15%">Rate</td>
                                        </tr> 
                                        <logic:iterate id="spclCompAllowId" name="frmSpclCmpnstryAllowSixPay" property="lstSCADtlsCDA" type="FCIPAY.Payroll.UTILITY.SpclCmpnstryAllowSixPayBean" indexId="idx">
                                        <% ++i; %>
                                          <logic:notEqual name="spclCompAllowId" property="status" value="D" >                              
                                            <tr>
                                              ...
                                              <logic:equal name="spclCompAllowId" property="status" value="N" >
													...
													<td colspan="1">
														<html:text property="txtGrade" name="spclCompAllowId"  styleClass="required" maxlength="10"  alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="return changed(this.alt)" style="width:94%;text-align:right"  />
														<img src="../INCLUDES/IMAGES/lov.jpg" height="16" align="center" alt="<%=idx%>" property="buttxtPayCode" onclick="ShowGradePay(this.alt);"  />
													</td>  
													<td>
                                              ...
                                              <logic:notEqual name="spclCompAllowId" property="status" value="N" >
													<td>
														<html:text property="txtPayBand" name="spclCompAllowId" size="9" maxlength="10" styleClass="required" style="width:94%;text-align:right" alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt);" />
														<img src="../INCLUDES/IMAGES/lov.jpg" height="16" align="center" alt="<%=idx%>" property="buttxtAgency" onclick="ShowPayBand(this.alt);"  />
													</td> 
													<td colspan="1">
														<html:text property="txtGrade" name="spclCompAllowId"  styleClass="required" maxlength="10"  alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="return changed(this.alt)" style="width:94%;text-align:right"  />
														<img src="../INCLUDES/IMAGES/lov.jpg" height="16" align="center" alt="<%=idx%>" property="buttxtPayCode" onclick="ShowGradePay(this.alt);"  />
                                              ...
                                              <html:hidden property="cboCatg" name="spclCompAllowId" />
...
<!-- Container Table Ends -->
      ...
      <html:hidden property="txtPayScaleTyp" name="frmSpclCmpnstryAllowSixPay" value="CDA"  />
      <html:hidden name="frmSpclCmpnstryAllowSixPay" property="screenName" value="SpclCmpnstryAllowScreenCDA" />
...
function chk_Status_AreaType()
{
	...
	function ShowPayBand(i)
	{
		...
		frmSpclCmpnstryAllowSixPay.lovKey.value = "SpclCompAllowPayBand" + frmSpclCmpnstryAllowSixPay.screenName.value + frmSpclCmpnstryAllowSixPay.screenMode.value;
	...
	function ShowGradePay(i)
	{
		...
		if(payband != "")
		{
			frmSpclCmpnstryAllowSixPay.lovKey.value = "SpclCompAllowGradePay" + frmSpclCmpnstryAllowSixPay.screenName.value + frmSpclCmpnstryAllowSixPay.screenMode.value;
			frmSpclCmpnstryAllowSixPay.txtDisplayFields.value = "txtGrade";
			frmSpclCmpnstryAllowSixPay.txtSearchFields.value = "";
			frmSpclCmpnstryAllowSixPay.queryParam.value = "txtPayBand="+payband;
			frmSpclCmpnstryAllowSixPay.txtIndex.value = i;
			frmSpclCmpnstryAllowSixPay.txtInputField.value ="txtGrade";
			showLov('<html:rewrite page="/Payroll/JSP/COMMON/JSP/CommonSearchScreen.jsp" />', 'frmSpclCmpnstryAllowSixPay');
			return true;
		}
		else
...
function chkFromDt(i)
{
  ...
  function doBaseAddRow()
  {
    if(mandatory_Check("frmSpclCmpnstryAllowSixPay"))
    {
      ...
      document.forms[0].action = "../../../SpclCmpnstryAllowSixPayCdaAddRowAction.do";
  ...
  function SaveRecord()
  {
		...
		document.all.butSave.disabled="true";
		document.all.butSave.src="../INCLUDES/IMAGES/save_dis.jpg";
		frmSpclCmpnstryAllowSixPay.action = "../../../SpclCmpnstryAllowSixPayCdaSaveAction.do";
  ...
  function doQueryMode()
  {
    ...
    frmSpclCmpnstryAllowSixPay.action="../../../SpclCmpnstryAllowSixPayCdaQueryMode.do"
    frmSpclCmpnstryAllowSixPay.submit();
  }

  function doInsertMode()
  {
    frmSpclCmpnstryAllowSixPay.action="../../../SpclCmpnstryAllowSixPayCdaNewMode.do"
    frmSpclCmpnstryAllowSixPay.submit();
  }
  ...
  function GetDetail()
  {
    ...
    document.all.screenMode.value='U';
    document.all.flagCda.value=true;
    frmSpclCmpnstryAllowSixPay.action="../../../SpclCmpnstryAllowSixPayCdaDetailAction.do"
    frmSpclCmpnstryAllowSixPay.submit();
  }

  function doRefresh()
  {
    frmSpclCmpnstryAllowSixPay.action="../../../SpclCmpnstryAllowSixPayCdaRefresh.do"
    frmSpclCmpnstryAllowSixPay.submit();
  }
  ...
  if(strRecList!='')
  {
    ...
    document.forms[0].action = "../../../SpclCmpnstryAllowSixPayCdaDeleteRowAction.do";
    document.forms[0].submit();  
  }
  ...
  function getTab(arg)
  {
    ...
    document.forms[0].action="../../../SpclCmpnstryCdaTabAction.do";
    document.forms[0].submit();
  }
 ...
 function getHeaderRecord()
{
    ...
    frmSpclCmpnstryAllowSixPay.action="../../../SpclCmpnstryAllowSixPayCdaGetHeaderAction.do"
    frmSpclCmpnstryAllowSixPay.submit();
}
...
{ 
    ...
    frmSpclCmpnstryAllowSixPay.action="../../../SpclCmpnstryAllowSixPayCdaGetNextHeader.do";
    frmSpclCmpnstryAllowSixPay.submit();
}
