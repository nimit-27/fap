...
<html:form  action="FreezeInt" name="frmCPFFinalPayForm" type="FCIPAY.Payroll.WEBTIER.Form.CPFFinalPaymentForm" scope="session">
<bean:define id="ParentForm" name="frmCPFFinalPayForm" toScope="request" />
<jsp:include page = "../INCLUDES/GenIconMenu.jsp" />
<html:errors/>
<table>
<TR height=30>
  <TD  colSpan=12 class=mainHeader height=10>FREEZE YEAR END INTEREST</TD>
</TR>
</TABLE>
...
<TBODY>
  <TR>
    <TD>
       ...
       <TR>
          <TD class=subHeader colspan=6>Freeze Interest</TD>
        </TR>
        <TR>
...
<html:hidden name="frmCPFFinalPayForm"  property="screenName" value="FreezeCpfScreen" />
...
function doQueryMode()
{
  ...
  frmCPFFinalPayForm.action="../../../FreezeIntQueryMode.do"
