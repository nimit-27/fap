...
<html:form  action="GenerateRevrRecoveries" name="frmGenerateRevrRecoveries" type="FCIPAY.Payroll.WEBTIER.Form.GenerateRevrRecoveriesForm" scope="session">
...
<!--container table starts -->
 ...
 <!-- <div id=divBody>-->
       ...
       <TR>
          <TD class=subHeader colspan=6>REVERSAL RECOVERIES</TD>
        </TR>
        <TR>
                          ...
                          <logic:notEqual name="GenBasicArrearInfo" property="status" value="D" >                              
                            <tr> <% ++j; %>                                                          
                                   ...
                                   <td ><html:text property="txtEmployeeNo" name="GenBasicArrearInfo"  styleClass="required" size="20" style="width:90%" alt="<%=String.valueOf(i)%>" onchange="
                                    ...
                                    <td><html:text property="txtFromDate" name="GenBasicArrearInfo"  styleClass="required" size="26" style="width:92%;text-align:center" alt="<%=String.valueOf(i)%>" onchange=
                                    "
                                    ...
                                    " />
                                       <logic:equal name="GenBasicArrearInfo" property="status" value="N">
                                        <img src="..\INCLUDES\IMAGES\cal.gif"  width=15 height=19 align="top" styleClass="lov" property="buttxtFromDate" alt="<%=String.valueOf(i)%>" onclick="showCalendar('txtFromDate',this)" />
                                       </logic:equal>                                      
                                       <logic:equal name="GenBasicArrearInfo" property="status" value="Q">
                                       <img src="..\INCLUDES\IMAGES\cal.gif"  width=15 height=19 align="top" styleClass="lov" property="buttxtFromDate" alt="<%=String.valueOf(i)%>" disabled onclick="showCalendar('txtFromDate',this)" />
                                       </logic:equal>                                      
                                       <logic:equal name="GenBasicArrearInfo" property="status" value="U">
                                       <img src="..\INCLUDES\IMAGES\cal.gif"  width=15 height=19 align="top" styleClass="lov" property="buttxtFromDate" alt="<%=String.valueOf(i)%>" disabled onclick="showCalendar('txtFromDate',this)" />
                                       </logic:equal>
...
<html:hidden name="frmGenerateRevrRecoveries"  property="screenName" value="ReversalRecoveryScreen" />
...
var chkMes;
 ...
 // document.all.screenMode.value='U';
    ...
    frmGenerateRevrRecoveries.action="../../../RevrRecoverFirstGetDetailAction.do"
  ...
  document.all.screenModeBasicArr.value = "U1";    
    frmGenerateRevrRecoveries.action="../../../RevrRecoverFirstGetHeaderAction.do";
    frmGenerateRevrRecoveries.submit();
  }
...
{ 
 ...
 document.all.screenModeBasic.value='U';
  document.all.screenModeBasicArr.value = "U1";    
    ...
    frmGenerateRevrRecoveries.action="../../../RevrRecoverGetNextHeader.do";
    frmGenerateRevrRecoveries.submit();
}
...
function PrevHeader()
{
  ...
  frmGenerateRevrRecoveries.action = "../../../RevrRecoverGetPrevHeader.do";
  frmGenerateRevrRecoveries.submit();
}
...
function JumpHeader()
{
  ...
  frmGenerateRevrRecoveries.screenModeBasicArr.value = "N1";
    frmGenerateRevrRecoveries.action = "../../../RevrRecoverAddRowAction.do";
    frmGenerateRevrRecoveries.submit();
  }
...
function doBaseDelRow()
{
  ...
  for(i=0; i < iTr2 -1; i++)
  {
    ...
    EnableFields();
  document.forms[0].action = "../../../RevrRecoverDeleteRowAction.do";
...
document.all.screenMode.value = "U";
 ...
 // frmGenerateBasicArrear.screenMode.value = "U";  
  ...
  frmGenerateRevrRecoveries.action = "../../../RevrRecoverSaveAction.do";
  frmGenerateRevrRecoveries.submit();
}
...
function  doInsertMode()
{
  ...
  frmGenerateRevrRecoveries.action="../../../RevrRecoverNewMode.do"
  frmGenerateRevrRecoveries.submit();
...
function doQueryMode()
{
 ...
 document.all.screenMode.value = "Q";
  ...
  frmGenerateRevrRecoveries.action="../../../RevrRecoverQueryMode.do"
  frmGenerateRevrRecoveries.submit();
...
function doBasePrevDetail()
{
    ...
    frmGenerateRevrRecoveries.action = "../../../RevrRecoverPrevDetailAction.do";
    frmGenerateRevrRecoveries.submit();
}
...
{
    frmGenerateRevrRecoveries.userPageRequested.value = 1*frmGenerateRevrRecoveries.pageRequested.value + 1;
    frmGenerateRevrRecoveries.action = "../../../RevrRecoverNextDetailAction.do";
    frmGenerateRevrRecoveries.submit();
}
...
function JumpDetail()
{
  ...
  function GenBasicArrear()
  {
        ...
        ac="../../../RevrRecoverAction.do?param1="+document.all.txtpayYYMM.value;
   ...
   function doRefresh()
    {
        ...
        frmGenerateRevrRecoveries.action = "../../../RevrRecoverRefresh.do";
        frmGenerateRevrRecoveries.submit();
    }
