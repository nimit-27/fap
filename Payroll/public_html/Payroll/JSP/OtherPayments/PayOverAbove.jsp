...
<!-- Tab table Row 3 starts -->
 ...
 <!-- Detail table Container starts -->
  			...
  			<!-- Detail table starts -->
                        <TABLE cellSpacing=0 cellPadding=0 border=0>
                          <TBODY>                     
                            ...
                            <tr>                             
                              ...
                              <td >                                                                       
                              <html:text  property="txtPayCodeDesc"  maxlength="10" size="23" styleClass="required" readonly="true" onchange="enableITDed();" />
                            ...
                            <TR> 
                              ...
                              <td ><html:text  property="txtSnctnDt"  disabled="true" readonly="true" styleClass = "optional" altKey="Payroll.EmpInfo.PermState" maxlength="25" size="23"  />
                              <logic:equal name="frmPayOverAbove" property="screenMode" value="N">
                              ...
                              <td ><html:text  property="txtSnctnAmnt" styleClass = "required" altKey="Payroll.EmpInfo.PermState" maxlength="5" onkeypress="if((event.keyCode < 48 || event.keyCode > 57)){ return false;}; " style="text-align:right" size="23" /></td>                                                                       
                              
                            </tr>
                            
                             <tr>                             
                              <td  width="15%" class=labelText>Invoice Id</td>                              
                       ...
                       <!--       <TD class=labelText width = 15% class=labelText>CPF Deduction</td>
                              <logic:notEqual name= "frmPayOverAbove"  property = "hdnCpfDed" value = "Y" > 
                              <td ><input type="checkbox" Id="chkCpfDed" onclick="onclickCheck('chkCpfDed',document.all.hdnCpfDed);" /></TD>                                                               
                              </logic:notEqual>                            
                              <logic:equal name= "frmPayOverAbove"  property = "hdnCpfDed" value = "Y" > 
                              <td ><input type="checkbox" Id="chkCpfDed" checked = "true" onclick="onclickCheck('chkCpfDed',document.all.hdnCpfDed);"  /></TD>                                                               
                              </logic:equal>
                              
                              <td  width="15%" class=labelText align="left" >CPF Employee Contribution</td>                              
                              <td >
                              <html:hidden  property="txtCpfEmplyrCntrb" />
                              <html:text  property="txtCpfEmpCntrb" disabled="true" styleClass = "locked" altKey="Payroll.EmpInfo.PermState" maxlength="25" size="23" style="text-align:right" /></td>                                                                                                    
                          ...
                          <tr>
                              ...
                              <td >                              
                              <html:text  property="txtDedIT" styleClass = "optional" altKey="Payroll.EmpInfo.PermState" maxlength="25" size="23" onkeypress="if((event.keyCode < 48 || event.keyCode > 57)){ return false;}; " style="text-align:right"  /></td>                                                                       
...
<!-- Bottom Blue Bar -->
   <TR>
      ...
      <td  bgcolor=#4682b4>
      <html:button property="butInv" value="Send Invoice" onclick="sendInv()" /></td>
      </logic:equal>
      <logic:notEqual name= "frmPayOverAbove"  property = "txtInvoceId" value = "" >
      <td  bgcolor=#4682b4>
      <html:button property="butInv" value="Send Invoice" disabled="true" /> </td>
      </logic:notEqual>     
...
function ShowEmpNum()
{
    ...
    if(frmPayOverAbove.screenMode.value == 'N')
    {
        ...
        frmPayOverAbove.txtSearchFields.value = "Payroll.Common.empNo,Payroll.Common.empName";
...
function ShowPayCodeNew()
{
  //  alert(+frmPayOverAbove.screenMode.value);
    ...
    frmPayOverAbove.queryParam.value = "txtPayCode="+document.all.txtPayCode.value;
	...
	if (!answer){
         ...
         if(document.all.txtNetAmt.value == 0)
       {
		  ...
		  ///added by sonia
             ...
             var checkDed=parseInt(document.all.txtSnctnAmnt.value-itDed);
...
/////end 
       ...
       //   if(document.all.chkCpfDed.checked)
       //     document.all.chkCpfDed.value='Y';
      //    else
      //      document.all.chkCpfDed.value='N';
     ...
     //     document.all.txtCpfEmpCntrb.disabled="";
      ...
      document.all.butSave.src="../INCLUDES/IMAGES/save_dis.jpg";
          ...
          alert(document.all.txtNetAmt.value);
