...
<table>
  <TR height=30>
    <TD  colSpan=11 class=mainHeader height=10>MAINTAIN LABOUR INFORMATION</TD>
  </TR>
  ...
  <TR>
    <TD>
       ...
       <TABLE cellSpacing=0 cellPadding=0 >
			...
			<logic:equal property= "screenMode" name= "frmDeptLabourInfoForm" value="U">
				<html:select  property="payRevFlag" name= "frmDeptLabourInfoForm"  styleClass = "locked" disabled="true" alt="payRevFlag" titleKey="Payroll.EmpInfo.payRevFlag" style="width:80%" >
					<html:option value="2"  ><bean:message   key="Payroll.2Pay" /></html:option> 
                                        <html:option value="3" ><bean:message   key="Payroll.3Pay" /></html:option> 
                                </html:select>	
			</logic:equal>
			...
			<logic:equal property= "screenMode" name= "frmDeptLabourInfoForm" value="N">
				<html:select  property="payRevFlag" name= "frmDeptLabourInfoForm"  styleClass = "locked"  alt="payRevFlag" titleKey="Payroll.EmpInfo.payRevFlag" style="width:80%" >
					<html:option value="2" ><bean:message   key="Payroll.2Pay" /></html:option> 
                                        <html:option value="3" ><bean:message   key="Payroll.3Pay" /></html:option> 
                                </html:select>	
			</logic:equal>
          ...
          <!--Added by dushyant on 15-May-2013 for cpf code TEMP-->
           ...
           <!--Added by dushyant on 15-May-2013 for cpf code TEMP-->
              <tr>      
                  ...
                  <td >
                  <logic:equal property= "screenMode" name= "frmDeptLabourInfoForm" value="U"> 
                  <html:select property="parentZone" name="frmDeptLabourInfoForm" titleKey="Payroll.EmpInfo.parentZone" disabled="true" styleClass="required" alt="<%=String.valueOf(i)%>"  onchange="if(document.all.screenMode.value!='Q'){lfnChanged(this.value);}"  style="WIDTH: 80%"  >
              ...
              <tr>
                  ...
                  <% if(empLbr.equals(new String("K"))) {%> 
                  <td class=labelText ><bean:message key="Payroll.Kotwal.LabourCode" /> </td>   
                  <td>                  
                  <logic:equal property= "screenMode" name= "frmDeptLabourInfoForm" value="Q">                  
                  <html:text  property="txtLabourCode" altKey="Payroll.Kotwal.LabourCode" titleKey="Payroll.Labour.LabourCode" maxlength="10" size="23" readonly="true" styleClass="optional" />
                  </logic:equal>
                  <logic:notEqual property= "screenMode" name= "frmDeptLabourInfoForm" value="Q">                              
                  <html:text  property="txtLabourCode" altKey="Payroll.Kotwal.LabourCode" titleKey="Payroll.Labour.LabourCode" maxlength="10" size="23" styleClass="required" onblur=" upper(this); lfnChanged(this.value); checkKotLbrCode(this.value);"/>
                  </logic:notEqual>
                  </td>
                  <%} else {  %>           
                  <td><html:hidden  property="txtLabourCode" altKey="Payroll.Kotwal.LabourCode"  /></td>  
                  <%}  %>              
...
function ShowEmpNum()
{
   ...
   {
     frmDeptLabourInfoForm.txtDisplayFields.value = "headerPrimaryKey,txtEmpFirstName,txtEmpMiddleName,txtEmpLastName"; 
     //frmDeptLabourInfoForm.txtSearchFields.value = "Payroll.Common.empNo,Payroll.EmpInfo.FirstName,Payroll.EmpInfo.LastName";     commented by devendra on 24 sept 2010

	 frmDeptLabourInfoForm.txtSearchFields.value = "Payroll.Common.empNo,Payroll.EmpInfo.FirstName,Payroll.EmpInfo.LastName,Payroll.Common.cpfCode";     //added by devendra on 24 sept 2010
...
{    
	...
	//below code added on 11 Mar 2013 start
...
{   
    if(alpha_Check(val))
    {     
      retrieveURL("../../../CheckKOTLbrCodeAction.do?kotVal="+escape(val));
    }  
}
