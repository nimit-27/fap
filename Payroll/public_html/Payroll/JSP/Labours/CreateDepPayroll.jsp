...
<html:form  action="CreateDepLbrPayroll" name="frmCreatePayroll" type="FCIPAY.Payroll.WEBTIER.Form.CreatePayrollForm" scope="session">
<bean:define id="ParentForm" name="frmCreatePayroll" toScope="request" />
<jsp:include page = "../INCLUDES/GenIconMenu.jsp" />
<html:errors/>
<table>
<TR height=30>
  <TD  colSpan=12 class=mainHeader height=10>CREATE LABOUR PAYROLL TRANSCATION FOR <bean:write name="frmCreatePayroll" property="payYYMM" /></TD>
</TR>
</TABLE>
...
<TBODY>
  <TR>
    <TD>
       ...
       <TR>
          <TD class=subHeader colspan=6> Create Labour Payroll Transaction</TD>
        </TR>
        <TR>
		...
		<!-- Detail table Container starts -->
  			...
  			<!-- Detail table starts -->
                  ...
                  -->
                              ...
                              <tr id="kot">
                              <td width=35%></td>                              
                              <TD width = 50%><html:checkbox property="selectAll"  value="" disabled="true" /> Incentive </TD>
                              <td width=15%></td>                                                            
                              </tr>
...
<!-- Bottom Blue Bar -->
        <TR>
               ...
               <td  bgcolor=#4682b4><html:button value=' Create Transaction'  onclick="createTransaction()" property="butInsert" styleClass="bottomBarText" /></td>
...
<!-- Container Table Ends -->
    ...
    <html:hidden name="frmCreatePayroll"  property="screenName" value="CreateDepLbrPayroll" />
    <html:hidden name="frmCreatePayroll"  property="loginLocCode"/>
	<html:hidden name="frmCreatePayroll"  property="hdnAction" /><!--///////////added by Dushyant on 31-01-2011 ///////////////-->
...
function createTransaction()
{
  ...
  str=str+'00';
  if(document.all.hdnEmpLbrFlag.value=='K')
    str=str+'1';
  else
    str=str+'0';
  if(str=='000000')
  ...
  else
  {
      ...
      /* commented by Dushyant on 31-01-2011 -----------
	  ac="../../../CreatePayrollTransaction.do?param1="+str+"&param2="+document.all.txtEmp.value;
      //document.all.butInsert.disabled="true"; // added by Dushyant on 31-01-2011 
      document.forms[0].action=ac;
      document.forms[0].submit(); ------------commented by Dushyant on 31-01-2011*/



///////////added by Dushyant on 31-01-2011///////////////
...
///////////end added by Dushyant on 31-01-2011///////////////
...
{
  frmCreatePayroll.hdnAction.value='Q'///////////added by Dushyant on 31-01-2011///////////////
...
function lfnLoad()
{
  ...
  {
    doQueryMode();
	frmCreatePayroll.hdnAction.value='';  ///////////added by Dushyant on 31-01-2011///////////////
  }
///////////added by Dushyant on 31-01-2011///////////////
...
///////////added by Dushyant on 31-01-2011///////////////
  batchMenuHandling();
  if(document.all.hdnEmpLbrFlag.value=='K')
    document.getElementById("kot").style.display='';
  else
...
function doRefresh()
{
  frmCreatePayroll.action="../../../CreateDepLbrPayrollRefresh.do";
