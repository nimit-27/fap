...
<html:html>
  ...
  <html:base/>
    ...
    <script language="JavaScript1.2" src="../INCLUDES/NWNPHrInfo.js"></script>          
  			...
  			<!-- Detail table starts -->
                    ...
                    <tr><td colspan=6>&nbsp;</td> </tr>
                     <tr><td colspan=6>&nbsp;</td> </tr>
                        ...
                        <TR>                            
                         <td  width="16%" class=labelText><bean:message key="Payroll.EmpInfo.casteCateg" /></td>
                          ...
                          <logic:equal property= "txtCasteCateg" name= "frmNWNPInfoForm" value="">
                          ...
                          <logic:notEqual property= "txtCasteCateg" name= "frmNWNPInfoForm" value="">
                          ...
                          <td colspan="1" >
                          <logic:equal property= "txtHandi" name= "frmNWNPInfoForm" value="Y">
                          <logic:equal property= "txtHandiType" name= "frmNWNPInfoForm" value="">
                         ...
                         <html:option value="" ><bean:message   key="Payroll.pleaseSelect" /></html:option>
                          ...
                          <logic:notEqual property= "txtHandiType" name= "frmNWNPInfoForm" value="">
                          <html:select  property="txtHandiType" titleKey="Payroll.EmpInfo.phtype" styleClass = "locked" disabled="true"style="width:80%" onchange="comboChange();" >                             
                           ...
                           <logic:notEqual property= "txtHandi" name= "frmNWNPInfoForm" value="Y">
                          ...
                          <td colspan="1" >
                          <logic:equal property= "txtReligion" name= "frmNWNPInfoForm" value="">
                          ...
                          <logic:notEqual property= "txtReligion" name= "frmNWNPInfoForm" value="">
                     ...
                     <TR>                            
                          ...
                          <td colspan="1" >
                          <logic:equal property= "txtExsrvcman" name= "frmNWNPInfoForm" value="">
                          ...
                          <logic:notEqual property= "txtExsrvcman" name= "frmNWNPInfoForm" value="">
                        ...
                        <td>
                        <logic:equal property= "txtAadharNum" name= "frmNWNPInfoForm" value="">
                     ...
                     "  style="text-align:left"  onchange="chkAadharNum(this.value);" /></td> 
                      ...
                      <logic:notEqual property= "txtAadharNum" name= "frmNWNPInfoForm" value=""> 
                     ...
                     <td width="15%" class=labelText><bean:message key="Payroll.EmpInfo.uan" /></td>
                        ...
                        <td >
                        <logic:equal property= "txtUanNum" name= "frmNWNPInfoForm" value="">
                        <html:text property="txtUanNum" alt="<%=String.valueOf(i)%>" maxlength="12" size="23" titleKey="Payroll.EmpInfo.uan" styleClass="required" onkeypress="                            
                          if((event.keyCode < 48 || event.keyCode > 57))
                                {
                                  return false;
                                };                           
                     ...
                     <logic:notEqual property= "txtUanNum" name= "frmNWNPInfoForm" value=""> 
