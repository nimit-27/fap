...
<html:form  action="GenerateDepBasicArrear" name="frmGenerateBasicArrear" type="FCIPAY.Payroll.WEBTIER.Form.GenerateBasicArrearForm" scope="session">
...
<html:hidden name="frmGenerateBasicArrear"  property="screenName" value="GenerateDepBasicArrearScreen" />
...
var chkMes;
 ...
 // document.all.screenMode.value='U';
    ...
    frmGenerateBasicArrear.action="../../../BasicArrDepFirstGetDetailAction.do"
  ...
  function getHeaderRecord()
  {
	...
	frmGenerateBasicArrear.action="../../../BasicArrDepFirstGetHeaderAction.do";
	frmGenerateBasicArrear.submit();
  }
...
{ 
 ...
 document.all.screenModeBasic.value='U';
  document.all.screenModeBasicArr.value = "U1";    
    ...
    frmGenerateBasicArrear.action="../../../BasicArrDepGetNextHeader.do";
    frmGenerateBasicArrear.submit();
}
...
function PrevHeader()
{
  ...
  frmGenerateBasicArrear.action = "../../../BasicArrDepGetPrevHeader.do";
  frmGenerateBasicArrear.submit();
}
...
function JumpHeader()
{
  ...
  frmGenerateBasicArrear.screenModeBasicArr.value = "N1";
    frmGenerateBasicArrear.action = "../../../BasicArrDepAddRowAction.do";
    frmGenerateBasicArrear.submit();
  }
...
function doBaseDelRow()
{
  ...
  for(i=0; i < iTr2 -1; i++)
  {
    ...
    EnableFields();
  document.forms[0].action = "../../../BasicArrDepDeleteRowAction.do";
...
document.all.screenMode.value = "U";
 ...
 // frmGenerateBasicArrear.screenMode.value = "U";  
  document.getElementById("txtpayYYMM").disabled="";  
	...
	frmGenerateBasicArrear.action = "../../../BasicArrDepSaveAction.do";
	frmGenerateBasicArrear.submit();
}
...
function  doInsertMode()
{
  ...
  frmGenerateBasicArrear.action="../../../BasicArrDepNewMode.do"
  frmGenerateBasicArrear.submit();
...
function doQueryMode()
{
 ...
 document.all.screenMode.value = "Q";
  ...
  frmGenerateBasicArrear.action="../../../BasicArrtDepQueryMode.do"
  frmGenerateBasicArrear.submit();
...
function ShowLovEmpNo(i)
{
   ...
   frmGenerateBasicArrear.txtSearchFields.value = "Payroll.Common.empNo,Payroll.Common.empName";
...
function doBasePrevDetail()
{
    ...
    frmGenerateBasicArrear.action = "../../../BasicArrDepPrevDetailAction.do";
    frmGenerateBasicArrear.submit();
}
...
{
    frmGenerateBasicArrear.userPageRequested.value = 1*frmGenerateBasicArrear.pageRequested.value + 1;
    frmGenerateBasicArrear.action = "../../../BasicArrDepNextDetailAction.do";
    frmGenerateBasicArrear.submit();
}
...
/*  function GenBasicArrear()
  {
        ...
        ac="../../../GenDepBasicArrearAction.do?param1="+document.all.txtpayYYMM.value;
  ...
  function GenBasicArrear()
  {
        frmGenerateBasicArrear.butAction.value = "Generate";
		 if (frmGenerateBasicArrear.hdnAction.value != 'SUB')
		 {
			...
			document.forms[0].action=ac;
			alert(frmGenerateBasicArrear.hdnAction.value)
			document.forms[0].submit();
	     }
	  else
      {
   ...
   function doRefresh()
    {
        ...
        frmGenerateBasicArrear.action = "../../../BasicArrDepRefresh.do";
        frmGenerateBasicArrear.submit();
    }
