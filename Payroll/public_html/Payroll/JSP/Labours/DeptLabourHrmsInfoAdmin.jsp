...
<html:html>
  ...
  <html:base/>
    ...
    <script language="JavaScript1.2" src="../INCLUDES/DeptLabourHrmsInfoAdmin.js"></script>          
                    ...
                    <TR>
                      ...
                      <!-- addition By swati -->
                         ...
                         <!-- <html:option value="SC" > <bean:message key="Payroll.EmpInfo.sc" /></html:option>
                          ...
                          <td colspan="1" ><html:select  property="txtHandiType" titleKey="Payroll.EmpInfo.phtype" styleClass = "optional" style="width:80%" onchange="comboChange();" >                             
                          <html:option value="" ><bean:message   key="Payroll.pleaseSelect" /></html:option>      
