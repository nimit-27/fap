...
<table>
  <TR height=30>
    <TD  colSpan=11 class=mainHeader height=10>NWNP LABOUR INFORMATION(Admin)</TD>
  </TR>
...
function ShowEmpNum()
{
   ...
   if(frmNWNPInfoForm.screenMode.value == 'N')
   {
     ...
     //  frmNWNPInfoForm.txtSearchFields.value = "Payroll.Common.empNo,Payroll.EmpInfo.FirstName,Payroll.EmpInfo.LastName"; commented by dushyant on 18-11-2010
   ...
   {
     frmNWNPInfoForm.txtDisplayFields.value = "headerPrimaryKey,txtEmpFirstName,txtEmpLastName,txtCpfCode";
    // frmNWNPInfoForm.txtSearchFields.value = "Payroll.Common.empNo,Payroll.EmpInfo.FirstName,Payroll.EmpInfo.LastName"; commented by dushyant on 18-10-2010
     frmNWNPInfoForm.txtSearchFields.value = "Payroll.Common.empNo,Payroll.EmpInfo.FirstName,Payroll.EmpInfo.LastName,Payroll.Common.cpfCode";
