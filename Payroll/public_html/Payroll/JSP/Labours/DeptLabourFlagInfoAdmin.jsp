...
<html:html>
    ...
    <html:base/>
      ...
      <script language="JavaScript1.2" src="../INCLUDES/DeptLabourFlagInfoAdmin.js"></script>      
  </head>
<BODY  onload="lfnFlagLoad();" onbeforeunload="confWindowClose()" onunload="handleOnClose()" oncontextmenu="return false">
<jsp:include page="../../../COMMON/JSP/menu.jsp" flush="true" />
<html:form  action="MaintDeptLabourAdminBase" name="frmDeptLabourInfoForm" type="FCIPAY.Payroll.WEBTIER.Form.DeptLabourInfoForm">
                            ...
                            <TABLE width="100%" cellpadding=0 cellspacing=0 border=0>
                              <tr>
                                ...
                                <tr>
                                  ...
                                  <td>
								  <!--input type="checkbox" name="selectSplDtyAllow" onclick="cmnFlagTxtDisab('selectSplDtyAllow','txtSplDtyAllowEffFrom,txtSplDtyAllowEffTill,butTxtSplDtyAllowEffFrom,butTxtSplDtyAllowEffTill'); lfnChange('1');" /><!--commented by devendra on 28 sept 2010-->
								  <input type="checkbox" name="selectSplDtyAllow" onclick="cmnFlagTxtDisab('selectSplDtyAllow','txtSplDtyAllowArea,txtSplDtyAllowEffFrom,txtSplDtyAllowEffTill,butTxtSplDtyAllowEffFrom,butTxtSplDtyAllowEffTill'); lfnChange('1');" /><!--added by devendra on 28 sept 2010-->
								  </td>                                                              
                                  </logic:notEqual>                            
                                  <logic:equal name= "frmDeptLabourInfoForm"  property = "hdnSplDtyAllowFlag" value = "Y" > 
                                  <td>
								  <!--input type="checkbox" name="selectSplDtyAllow" checked = "true" onclick="cmnFlagTxtDisab('selectSplDtyAllow','txtSplDtyAllowEffFrom,txtSplDtyAllowEffTill,butTxtSplDtyAllowEffFrom,butTxtSplDtyAllowEffTill'); lfnChange('1');" /><!--commented by devendra on 28 sept 2010-->
								  <input type="checkbox" name="selectSplDtyAllow" checked = "true" onclick="cmnFlagTxtDisab('selectSplDtyAllow','txtSplDtyAllowArea,txtSplDtyAllowEffFrom,txtSplDtyAllowEffTill,butTxtSplDtyAllowEffFrom,butTxtSplDtyAllowEffTill'); lfnChange('1');" /><!--added by devendra on 28 sept 2010-->
								  </td>                                                           
                                  </logic:equal>   
