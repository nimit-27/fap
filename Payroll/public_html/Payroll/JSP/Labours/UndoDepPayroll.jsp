...
<html:form  action="UndoDepLbrPayroll" name="frmUndoPayroll" type="FCIPAY.Payroll.WEBTIER.Form.UndoPayrollForm" scope="session">
...
<TBODY>
  <TR>
    <TD>
       ...
       <TR>
          <TD class=subHeader colspan=6> Undo Labour Payroll Transaction</TD>
        </TR>
        <TR>
 	 ...
 	 <TR height="200">
		...
		<!-- Detail table Container starts -->
            ...
            -->                             
                             ...
                             <tr id="kot">
                             <td width=35%></td>                              
                             <TD  width = 5% align=right><html:checkbox name="frmUndoPayroll" property="chkKotIncentive" disabled="true" /></TD>
                             <TD width = 60% class=checkText>Incentive</td>
...
<html:hidden name="frmUndoPayroll"  property="screenName" value="UndoDepLbrTranScreen" />
...
//       frmUndoPayroll.txtSearchFields.value = "Payroll.Compute.emp";
  ...
  function UndoTransaction()
  {
    ...
    var dflag = "";
      ...
      else
      {
        ...
        frmUndoPayroll.action = "../../../UndoDepLbrPayrollTransaction.do";
  ...
  {
          frmUndoPayroll.action = "../../../UndoDepLbrPayrollQueryMode.do";
          frmUndoPayroll.submit();
  }
function doRefresh()
{
  frmUndoPayroll.action="../../../UndoDepLbrPayrollRefresh.do";
  frmUndoPayroll.submit();
}
</script>