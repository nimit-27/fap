...
<html:form  action="CalcDpsWrkDoneParamAction" name="frmDpsWrkDone" type="FCIPAY.Payroll.Labour.WEBTIER.Form.CalcDpsWrkDoneForm" scope="session">
...
<html:hidden name="frmDpsWrkDone"  property="screenName" value="CalcDpsWrkDoneParamScreen" />
<html:hidden property="loginLocCode" name="frmDpsWrkDone"  />
<html:hidden property="screenFlag" name="frmDpsWrkDone" value="Y" />
...
function doQueryMode()
{
  ...
  frmDpsWrkDone.action="../../../CalcDpsWrkDoneParamQuery.do"
  frmDpsWrkDone.submit();
}

  function CalcWrkDone()
  {
      if(!(mandatory_Check('frmDpsWrkDone')))
          return false;
      if(!validateDate())
          return false;
      if (frmDpsWrkDone.hdnAction.value != 'SUB') 
      {
        ...
        frmDpsWrkDone.action = "../../../CalcDpsWrkDoneParam.do";
