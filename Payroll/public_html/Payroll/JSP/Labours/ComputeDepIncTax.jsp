...
<jsp:include page="../../../COMMON/JSP/menu.jsp" flush="true" />
  ...
  <html:form  action="CompDepIncTax" name="frmCompIncTax" type="FCIPAY.Payroll.WEBTIER.Form.CompIncTaxForm" scope="session">
...
<table>
<TR height=30>
  <TD  colSpan=12 class=mainHeader height=10>COMPUTE MONTHLY INCOME TAX PROCESS(Labours)</TD>
</TR>
</TABLE>
...
<html:hidden name="frmCompIncTax"  property="screenName" value="ComputeDepMonthlyIncomeTaxScreen" />
...
{  
      ...
      if (frmCompIncTax.hdnAction.value != 'SUB') 
      {
        ...
        frmCompIncTax.action="../../../computeDepITActual.do";
...
/* Commented by Balpreet as this process will not be employee specific.
function showLOVEmp()
{
   //alert("lov");
...
function doQueryMode()
{
  ...
  frmCompIncTax.action="../../../IncomeDepQueryAction.do"
