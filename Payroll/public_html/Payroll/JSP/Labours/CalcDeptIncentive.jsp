...
<html:form  action="CalcDeptIncentiveAction" name="frmDeptIncentive" type="FCIPAY.Payroll.Labour.WEBTIER.Form.CalcDeptIncentiveForm" scope="session">
...
<!-- Bottom Blue Bar -->
        <TR>
               ...
               <td  bgcolor=#4682b4><html:button value='Calculate Incentive'  onclick="if(checkFields()){CalcIncentive()}else{return false;}" disabled="false" property="butCalcIncentive" styleClass="bottomBarText" /></td>
...
<html:hidden name="frmDeptIncentive"  property="txtFrom" />
<html:hidden name="frmDeptIncentive"  property="txtTo" />
<html:hidden name="frmDeptIncentive"  property="screenFlag" value="N" />
...
<html:hidden name="frmDeptIncentive"  property="screenName" value="CalcDeptIncentiveScreen" />
...
function doQueryMode()
{
  ...
  frmDeptIncentive.action="../../../CalcDeptIncentiveQuery.do"
  ...
  function CalcIncentive()
  {
      if (frmDeptIncentive.hdnAction.value != 'SUB') 
      {
        ...
        frmDeptIncentive.action = "../../../CalcDeptIncentive.do";
        frmDeptIncentive.submit();
      }
      else
      {
