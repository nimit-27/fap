 ...
 <!-- Detail table Container starts -->
                             ...
                             <td width="15%" class=labelText>EPS Payment</td>
                              ...
                              <tr>                                             
                                 <td width="15%" class=labelText>EPS Separation Reason</td>
                                  <td colspan="1">                                                                 
                                  <html:select property="txtEpsSepRsn" name= "frmDPSInfoForm"  alt="txtMHSTyp" styleClass="locked" style="width:79%" disabled="true" onchange="lfnChanged(this.value);"  >
                                  <html:option value="" ><bean:message key="Payroll.pleaseSelect" /></html:option>      
       ...
       <!--Added by dushyant on 20-dec-2011 for pAN card-->
                                <td width="20%" class=labelText><bean:message key="Payroll.EmpInfo.txtPanNo" /></td>
                                   <td ><html:text  property="txtPanNo" name= "frmDPSInfoForm"  styleClass = "required" altKey="Payroll.EmpInfo.txtPanNo" maxlength="10" onkeypress="
    ...
    <td width="15%" class=labelText  ><bean:message key="Payroll.EmpInfo.pohw" /> </td> 
                                <td colspan="1">                                                                 
                                    <html:select property="txtPohwFlag" name= "frmDPSInfoForm"  alt="txtNpsFlag" styleClass="optional" style="width:79%"  onchange="lfnChanged(this.value);changePohwDate(this.value);"  >
                                    <html:option value="N" >No</html:option>
                                    <html:option value="Y" >Yes</html:option>
                                    </html:select>                              
                                </td>
