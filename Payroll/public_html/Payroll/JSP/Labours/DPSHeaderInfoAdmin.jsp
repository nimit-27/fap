...
<table>
  <TR height=30>
    <TD  colSpan=11 class=mainHeader height=10>DPS LABOUR INFORMATION(Admin)</TD>
  </TR>
       ...
       <TABLE cellSpacing=0 cellPadding=0 >
            ...
            <tr></tr>
              <table  cellSpacing=0 cellPadding=0 border=0>             
                <TR>
                  ...
                  <td ><html:select  property="prefix" name="frmDPSInfoForm" titleKey="Payroll.EmpInfo.prefix" styleClass = "optional" alt="prefix" style="width:80%" onchange="checkPrefix(this.value);"  >
              ...
              <tr>
                 ...
                 "  style="text-align:left"  onchange="upper(this); if(document.all.screenMode.value!='Q'){lfnChanged(this.value);}" />                  
                  </td> 
             ...
             <!--Added by dushyant on 18-May-2013-->
                  ...
                  <td>
                  <logic:equal property= "screenMode" name= "frmDPSInfoForm" value="Q">
                  <html:text property="txtOldCpfCode" name="frmDPSInfoForm" titleKey="Payroll.EmpInfo.OldCpfCode" styleClass="locked" readonly="true" style="WIDTH: 49%"  />
                  </logic:equal>
           ...
           <!--Added by dushyant on 18-May-2013-->
                  ...
                  <logic:notEqual property= "screenMode" name= "frmDPSInfoForm" value="Q">   
                    ...
                    <!--Added by dushyant on 09-May-2013 for cpf code disable-->
              ...
              <tr>                 
                  ...
                  <td >                  
                  <html:select property="parentZone" name="frmDPSInfoForm" titleKey="Payroll.EmpInfo.parentZone" styleClass="required" alt="<%=String.valueOf(i)%>"  onchange="if(document.all.screenMode.value!='Q'){lfnChanged(this.value);}"  style="WIDTH: 80%"  >
                  <html:option value="" >-----------Please Select-----------</html:option>      
                  <logic:present name="DPSLabourList">
                  <html:optionsCollection label="label" value="value" property="valueParentZoneArrayList" name="DPSLabourList"/>
                  </logic:present>
                  </html:select>                  
                  </td>
                  ...
                  <logic:notEqual property= "screenMode" name= "frmDPSInfoForm" value="U">
              ...
              <tr>       
                  ...
                  <td >
                  <logic:equal property= "screenMode" name= "frmDPSInfoForm" value="Q">
                  <html:select property="txtEmpStatus" name="frmDPSInfoForm"  titleKey="Payroll.EmpInfo.EmpStat" styleClass="required"style="WIDTH: 78%"  >
                  <html:option value="" >-----------Please Select-----------</html:option>      
                  <logic:present name="DPSLabourList">
                  <html:optionsCollection label="label" value="value" property="valueEmpStatAllArrayList" name="DPSLabourList"/>
                  </logic:present>
                  </html:select>
                  </logic:equal>
                  <logic:equal property= "screenMode" name= "frmDPSInfoForm" value="U">
                  <html:select property="txtEmpStatus" name="frmDPSInfoForm"  titleKey="Payroll.EmpInfo.EmpStat" styleClass="required" alt="<%=String.valueOf(i)%>"  disabled="true" onchange="if(document.all.screenMode.value!='Q'){lfnChanged(this.value);}"  style="WIDTH: 78%"  >
                  <html:option value="" >-----------Please Select-----------</html:option>      
                  <logic:present name="DPSLabourList">
                  <html:optionsCollection label="label" value="value" property="valueEmpStatAllArrayList" name="DPSLabourList"/>
                  </logic:present>
                  ...
                  <logic:equal property= "screenMode" name= "frmDPSInfoForm" value="N">
                  <html:select property="txtEmpStatus" name="frmDPSInfoForm"  titleKey="Payroll.EmpInfo.EmpStat" styleClass="required" alt="<%=String.valueOf(i)%>"  onchange="if(document.all.screenMode.value!='Q'){lfnChanged(this.value);}"  style="WIDTH: 78%"  >
                  <html:option value="" >-----------Please Select-----------</html:option>      
                  <logic:present name="DPSLabourList">
                  <html:optionsCollection label="label" value="value" property="valueEmpStatArrayList" name="DPSLabourList"/>
                  </logic:present>
                  </html:select>
                  </logic:equal>
                  </td>
                  ...
                  <td>
                  <logic:equal property= "screenMode" name= "frmDPSInfoForm" value="Q">
                  <html:text property="txtGangName" name="frmDPSInfoForm" titleKey="Labours.txtGangName" styleClass="locked" readonly="true" style="WIDTH: 78%"  />
                  <html:hidden property="txtGangId" name="frmDPSInfoForm" />
                  </logic:equal>
                  <logic:equal property= "screenMode" name= "frmDPSInfoForm" value="U">
                  <html:text property="txtGangName" name="frmDPSInfoForm" titleKey="Labours.txtGangName" styleClass="locked" readonly="true" style="WIDTH: 78%"  />
                  <html:hidden property="txtGangId" name="frmDPSInfoForm" />
     ...
     <!--Added by dushyant on 18-May-2013  -->
			  <tr>
                 <td width="15%" class=labelText  ><bean:message key="Payroll.EmpInfo.PF" /> </td>                            
                  <td ><logic:equal property= "screenMode" name= "frmDPSInfoForm" value="N">                              
                  <html:select  property="txtPFType" name="frmDPSInfoForm" titleKey="Payroll.EmpInfo.PF" styleClass = "required" style="width:80%" disabled="true" >                  
                  <!--<html:option value="" ><bean:message   key="Payroll.pleaseSelect" /></html:option>-->      
                  <html:option value="CPF" ><bean:message key="Payroll.DeptLbr.CPF" /></html:option>                                                
                  </html:select>
                  </logic:equal>
                  <logic:notEqual property= "screenMode" name= "frmDPSInfoForm" value="N">                              
                  <html:select  property="txtPFType" name="frmDPSInfoForm" titleKey="Payroll.EmpInfo.PF" styleClass = "locked" style="width:80%" disabled="true"  >
                  <!--<html:option value="" ><bean:message   key="Payroll.pleaseSelect" /></html:option>-->      
                  <html:option value="CPF" ><bean:message key="Payroll.DeptLbr.CPF" /></html:option>                                                
                  </html:select>
                  </logic:notEqual>
...
function ShowEmpNum()
{
   frmDPSInfoForm.lovKey.value = "DPSLabourInfo" + frmDPSInfoForm.screenName.value + frmDPSInfoForm.screenMode.value;
   frmDPSInfoForm.queryParam.value = "txtSiteID="+frmDPSInfoForm.loginLocCode.value+" ";
   if(frmDPSInfoForm.screenMode.value == 'N')
   {
       //frmDeptLabourInfoForm.txtDisplayFields.value = "headerPrimaryKey,txtEmpName,lstCateg,txtDsgn";
       frmDPSInfoForm.txtDisplayFields.value = "headerPrimaryKey,txtEmpFirstName,txtEmpLastName,txtCpfCode";
     //  frmDPSInfoForm.txtSearchFields.value = "Payroll.Common.empNo,Payroll.EmpInfo.FirstName,Payroll.EmpInfo.LastName"; commented by dushyant on 18-11-2010
	  frmDPSInfoForm.txtSearchFields.value = "Payroll.Common.empNo,Payroll.EmpInfo.FirstName,Payroll.EmpInfo.LastName,Payroll.Common.cpfCode";
       frmDPSInfoForm.txtIndex.value ="";      
   }
   if(frmDPSInfoForm.screenMode.value == 'Q')
   {
     frmDPSInfoForm.txtDisplayFields.value = "headerPrimaryKey,txtEmpFirstName,txtEmpLastName,txtCpfCode";
    // frmDPSInfoForm.txtSearchFields.value = "Payroll.Common.empNo,Payroll.EmpInfo.FirstName,Payroll.EmpInfo.LastName"; commented by dushyant on 18-10-2010
     frmDPSInfoForm.txtSearchFields.value = "Payroll.Common.empNo,Payroll.EmpInfo.FirstName,Payroll.EmpInfo.LastName,Payroll.Common.cpfCode";
...
function ShowLovEmpLoc()
{
   ...
   frmDPSInfoForm.lovKey.value = "DPSLbrEmpLoc" + frmDPSInfoForm.screenName.value + frmDPSInfoForm.screenMode.value;   
   frmDPSInfoForm.txtDisplayFields.value = "txtPresentPOP,txtPresentPOPDesc";
   frmDPSInfoForm.queryParam.value = "txtSiteID="+frmDPSInfoForm.loginLocCode.value+" ";
   frmDPSInfoForm.txtSearchFields.value = "Labours.txtSiteId,Labours.txtSiteName";
   frmDPSInfoForm.txtInputField.value =""; 
   frmDPSInfoForm.txtIndex.value =""; 
   showLov('<html:rewrite page="/Payroll/JSP/COMMON/JSP/CommonSearchScreen.jsp" />', 'frmDPSInfoForm');
...
{   
   ...
   {
       frmDPSInfoForm.lovKey.value = "DPSLabourDsgn" + frmDPSInfoForm.screenName.value + frmDPSInfoForm.screenMode.value;       
       frmDPSInfoForm.txtDisplayFields.value = "txtDsgnDesc,txtDsgn,txtCateg";
