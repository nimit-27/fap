...
<!-- Tab table Row 3 starts -->
 ...
 <!-- Detail table Container starts -->
                    ...
                    <TABLE cellSpacing=0 cellPadding=0 border=0 >
					 ...
					 <!--Added by dushyant on 26-April-2013 for pay status-->
					  ...
					  <!--Added by dushyant on 26-April-2013 for pay status-->
                              ...
                              <td width="22%" class=labelText>Current MGW</td>
                              <td width="12%"><html:text  property="txtCurMGW" styleClass = "locked" readonly="true" altKey="Payroll.EmpInfo.pstchdate" maxlength="15" size="15" onchange="lfnChanged(this.value)" /></td>
				      <!--Added by dushyant on 26-April-2013 for Pay Status Changed Date-->
							 <td width="20%" class=labelText  ><bean:message key="Payroll.EmpInfo.pstchdate" /> </td> 
							  <td>                  
							  <logic:equal property= "screenMode" name= "frmNWNPInfoForm" value="N">                              
								 <html:text  property="txtPayStsChnDate" styleClass = "required" altKey="Payroll.EmpInfo.pstchdate" maxlength="15" size="20" onchange="lfnChanged(this.value)" readonly="true"/><img src="..\INCLUDES\IMAGES\cal.gif" width=15 height=19 align="top" title="Calender" styleClass="lov" disabled="true" property="butTxtPayStsChnDate" alt="<%=(i-1) %>" />
						 
							  </logic:equal> 
							  <logic:notEqual property= "screenMode" name= "frmNWNPInfoForm" value="N">
								<html:text  property="txtPayStsChnDate" styleClass = "required" altKey="Payroll.EmpInfo.pstchdate" maxlength="15" size="15" onchange="lfnChanged(this.value)" readonly="true"/><img src="..\INCLUDES\IMAGES\cal.gif" width=15 height=19 align="top" title="Calender" styleClass="lov" property="butTxtPayStsChnDate" alt="<%=(i-1) %>" onclick="showCalendar('txtPayStsChnDate',this)" />
					  ...
					  <!--Added by dushyant on 26-April-2013 for Pay Status Changed Date-->
							...
							<logic:notEqual property= "screenMode" name= "frmNWNPInfoForm" value="Q">
                             ...
                             <td colspan="1">                                                                 
                                <html:select property="txtEpsFlag" name= "frmNWNPInfoForm" alt="txtMHSTyp" style="width:79%" disabled="false" styleClass="locked" onchange="checkEpsFlag();lfnChanged(this.value);">
                                    <html:option value="" ><bean:message key="Payroll.pleaseSelect" /></html:option>     
                              ...
                              <tr>                                             
                                 <td width="15%" class=labelText>EPS Separation Reason</td>
                                  <td colspan="1">                                                                 
                                  <html:select property="txtEpsSepRsn" name= "frmNWNPInfoForm"  alt="txtMHSTyp" styleClass="locked" style="width:79%" disabled="true" onchange="lfnChanged(this.value);"  >
                                  <html:option value="" ><bean:message key="Payroll.pleaseSelect" /></html:option>      
                                 ...
                                 <td class=labelText  >EPS Separation Date </td>                
                                  <td>
                                  <html:text  property="txtEpsSepDt" styleClass = "locked" maxlength="10"  size="15" onchange="lfnChanged(this.value)" readonly="true"/>
       ...
       <!--Added by dushyant on 20-dec-2011 for pAN card-->
                                <td width="20%" class=labelText><bean:message key="Payroll.EmpInfo.txtPanNo" /></td>
                                   <td ><html:text  property="txtPanNo" name= "frmNWNPInfoForm"  styleClass = "required" altKey="Payroll.EmpInfo.txtPanNo" maxlength="10" onkeypress="
    ...
    <td width="15%" class=labelText  ><bean:message key="Payroll.EmpInfo.pohw" /> </td> 
                                <td colspan="1">                                                                 
                                    <html:select property="txtPohwFlag" name= "frmNWNPInfoForm"  alt="txtNpsFlag" styleClass="optional" style="width:79%"  onchange="lfnChanged(this.value);changePohwDate(this.value);"  >
                                    <html:option value="N" >No</html:option>
                                    <html:option value="Y" >Yes</html:option>
                                    </html:select>                              
                                </td>
...
<input type="hidden" name="txtEpsFlag" />
