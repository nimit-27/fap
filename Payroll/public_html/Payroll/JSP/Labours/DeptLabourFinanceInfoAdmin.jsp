...
<html:html>
    ...
    <script language="JavaScript1.2" src="../INCLUDES/DeptLabourFinanceInfoAdmin.js"></script>          
  ...
  <html:form  action="MaintDeptLabourAdminBase" name="frmDeptLabourInfoForm" type="FCIPAY.Payroll.Labour.WEBTIER.Form.DeptLabourInfoForm">
  ...
  <jsp:include page="DeptLabourHeaderAdmin.jsp" flush="true" />
 ...
 <!-- Detail table Container starts -->
  			...
  			<!-- Detail table starts -->
                        <TABLE cellSpacing=0 cellPadding=0 border=0>
                          <TBODY>        
                            <TR>       
							<!--commented by devendra on 28th sept 2010 start--
                              ...
                              <html:option value="IDA" > <bean:message key="Payroll.EmpInfo.ida" /></html:option>                              
                               ...
                               <!--commented by devendra on 28th sept 2010 end-->
					...
					<!--Added by dushyant on 15-May-2013 for pay status-->  
                          ...
                          <TR>                              
                              ...
                              <td ><html:text  property="txtPayStsChnDate" styleClass = "required" altKey="Payroll.EmpInfo.pstchdate" maxlength="15" size="23" onchange="checkPayStatDate(this.value); lfnChanged(this.value)" readonly="true"/><img src="..\INCLUDES\IMAGES\cal.gif" width=15 height=19 align="top" title="Calender" styleClass="lov" property="butTxtPayStsChnDate" alt="<%=(i-1) %>" onclick="showCalendar('txtPayStsChnDate',this)" /></td>
                          ...
                          <tr>
                              ...
                              <td ><html:text  property="txtPanNo" styleClass = "optional" altKey="Payroll.EmpInfo.txtPanNo" maxlength="18" onkeypress="
                               ...
                               {}
                               else
                                {
                                  return false;
                                      ...
                                      lfnChanged(this.value);
                                 "style="text-align:Left" size="23" /></td>                            
                           ...
                           <td width="15%" class=labelText>EPS Payment</td>
                            <td colspan="1">                                                                 
                            <html:select property="txtEpsFlag" name= "frmDeptLabourInfoForm"  alt="txtMHSTyp" styleClass="optional" style="width:79%"  onchange="checkEpsFlag();lfnChanged(this.value);"  >
                        ...
                        <tr>
                           ...
                           <td width="15%" class=labelText>EPS Separation Reason</td>
                            <td colspan="1">                                                                 
                            <html:select property="txtEpsSepRsn" name= "frmDeptLabourInfoForm"  alt="txtMHSTyp" styleClass="optional" style="width:79%"  onchange="lfnChanged(this.value);"  >
                            <html:option value="" ><bean:message key="Payroll.pleaseSelect" /></html:option>      
                            <logic:present name="DeptLabourList">
...
<html:hidden name="frmDeptLabourInfoForm"  property="screenName" value="DeptLabourDetailAdminScreen" />
...
<html:hidden name="frmDeptLabourInfoForm"  property="screenNameForSuper" value="DeptLabourDetailAdminScreen" /><!--added by devendra on 1-10-2010-->
...
{
   frmDeptLabourInfoForm.lovKey.value = "DeptLabourBankCode" + frmDeptLabourInfoForm.screenName.value + frmDeptLabourInfoForm.screenMode.value;
...
function ShowLovBranchCode()
{
   ...
   frmDeptLabourInfoForm.lovKey.value = "DeptLabourBranchCode" + frmDeptLabourInfoForm.screenName.value + frmDeptLabourInfoForm.screenMode.value;
...
function chkVldn()
{
   //alert('inside chkVldn in deptlabourfinanceinfoadmin.jsp')
