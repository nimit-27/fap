...
<html:html>
  ...
  <BODY scroll=no onbeforeunload="confWindowClose()" onunload="handleOnClose()" onload="lfnLoad();">
    ...
    <TABLE cellSpacing=0 bgColor="#bdd0ef">
      <TR height=30>
        <TD  colSpan=11 class=mainHeader height=10>ENQUIRE LABOUR PAY IMAGE (INCENTIVE)</TD>
      </TR>
      <tr height="10">
    ...
    <div id=divDtlTable  style="height:800px" >
      <!--Table 11 starts-->
              ...
              <!--pay Scale Header Row Starts -->
				...
				<tr>
					<td colspan="10">
					  ...
					  <td bgcolor="#76A2C7" nowrap class=disTabText onclick=getTab("salary")>Salary<img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
					  <td><img src="../INCLUDES/IMAGES/formtab_lb.gif" width="10" height="21" border="0"></td>
					  
					  <td bgcolor="#4682B4" width="10"><img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
					  <td bgcolor="#4682B4" nowrap class=actTabText>Incentive<img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                                    ...
                                    <TBODY>
                                      <TR>
                                        <TD >   
                                          ...
                                          <!-- Detail table starts -->
                                            <!--Table 60 starts-->
                                            <TABLE cellSpacing=0 cellPadding=0 id="tblEarn">
                                              <TBODY>
                                                <TR height="20">
                                                ...
                                                <logic:iterate id="payImage" name="frmEnqPayImgGang" property="lstInstrDtlsInct" type="FCIPAY.Payroll.UTILITY.EnqPayImgBean" >
                                                <logic:lessThan name="payImage" property="txtPayCode1" value="997">
                                                <logic:equal name="payImage" property="txtPayMode1" value="1">
                                                   <tr>
                                                      <td width="9%"><html:text property="txtPayCode1" name="payImage" style="width:100%;text-align:center" readonly="true" /></td>
                                                      <td width="15%"><html:text property="txtDesc1" name="payImage" size = "31" readonly="true" /></td>
                                                      <td width="5%"><html:text property="txtSrlNo1" name="payImage" style="width:100%;text-align:center" readonly="true" /></td>
                                                      <td width="5%"><html:text property="txtPayMode1" name="payImage" style="width:100%;text-align:center" readonly="true" /></td>
                                                      <td width="6%"><html:text property="txtAmt1" name="payImage" style="width:100%;text-align:right" readonly="true" /></td>
                                                  </tr>    
                                                </logic:equal>
                                                <logic:equal name="payImage" property="txtPayMode1" value="4">
                                                   <tr>
                                                      <td width="9%"><html:text property="txtPayCode1" name="payImage" style="width:100%;text-align:center" readonly="true" /></td>
                                                      <td width="15%"><html:text property="txtDesc1" name="payImage" size = "31" readonly="true" /></td>
                                                      <td width="5%"><html:text property="txtSrlNo1" name="payImage" style="width:100%;text-align:center" readonly="true" /></td>
                                      ...
                                      <TR>
                                        <TD >   
                                          <!-- Detail table starts -->
                                            <!--Table 61 starts-->
                                          <DIV id=divDtlTable style="height:350px" >
                                            <TABLE cellSpacing=0 cellPadding=0 id="tblDed">
                                              <TBODY>
                                                 <TR height="20">
                                                  <td class=tableHeader width="9%"><bean:message key="Payroll.EnqPayImg.txtPayCode" /></td>
                                                  <td class=tableHeader width="15%"><bean:message key="Payroll.EnqPayImg.txtDesc" /></td>
                                                ...
                                                <logic:iterate id="payImage" name="frmEnqPayImgGang" property="lstInstrDtlsInct" type="FCIPAY.Payroll.UTILITY.EnqPayImgBean" >
                                                <logic:lessThan name="payImage" property="txtPayCode1" value="997">
                                                <logic:equal name="payImage" property="txtPayMode1" value="2">
                                                   <tr>
                                                      <td width="9%"><html:text property="txtPayCode1" name="payImage" style="width:100%;text-align:center" readonly="true" /></td>
                                                      <td width="15%"><html:text property="txtDesc1" name="payImage" size = "31" readonly="true" /></td>
                                                      <td width="5%"><html:text property="txtSrlNo1" name="payImage" style="width:100%;text-align:center" readonly="true" /></td>
                                                ...
                                                <logic:equal name="payImage" property="txtPayMode1" value="5">
                                                   <tr>
                                                      <td width="9%"><html:text property="txtPayCode1" name="payImage" style="width:100%;text-align:center" readonly="true" /></td>
                                                      <td width="15%"><html:text property="txtDesc1" name="payImage" size = "31" readonly="true" /></td>
                                                      <td width="5%"><html:text property="txtSrlNo1" name="payImage" style="width:100%;text-align:center" readonly="true" /></td>
                  ...
                  <td colspan = 6>     
                    ...
                    <table width = "100%"  cellspacing="0" cellpadding="0" border = 0>
                      ...
                      <tr>
                        ...
                        <% int flg1 = 0; %>     
                        <logic:iterate id="payImage" name="frmEnqPayImgGang" property="lstInstrDtlsInct" type="FCIPAY.Payroll.UTILITY.EnqPayImgBean" >
                        <logic:equal name="payImage" property="txtPayCode1" value="999">
                              <% flg1 = 1; %>
                              <td width="11%"><html:text property="txtAmt1" name="payImage" size = "11" style="text-align:right" readonly="true"/></td>
                          </logic:equal>
                       </logic:iterate>    
                       <% if (flg1 ==0) { %>
                          <td width="11%"><html:text size = "11" property = "txtAmt1" value = "" style="text-align:right" readonly="true" /></td>                       
                       <%  } %>
                          <% flg1 = 0; %>
                        <td class=labelText width = "18%"><bean:message key="pay.EnqPayImg.txtGrossEar" /></td>     
                        <logic:iterate id="payImage" name="frmEnqPayImgGang" property="lstInstrDtlsInct" type="FCIPAY.Payroll.UTILITY.EnqPayImgBean" >
                        <logic:equal name="payImage" property="txtPayCode1" value="997">
                              <% flg1 = 1; %>                        
                              <td width="10%" align = "right" ><html:text property="txtAmt1" name="payImage" size = "11" style="text-align:right" readonly="true"/></td>
                         </logic:equal>
                       </logic:iterate>
                       <% if (flg1 ==0) { %>
                          <td width="10%" align = "right" ><html:text size = "11" property = "txtAmt1" value = "" style="text-align:right" readonly="true" /></td>                       
                       <%  } %>         
                       <% flg1 = 0; %>                       
                        <td class=labelText width = "41%"><bean:message key="pay.EnqPayImg.txtGrossDed" /></td>     
                        <logic:iterate id="payImage" name="frmEnqPayImgGang" property="lstInstrDtlsInct" type="FCIPAY.Payroll.UTILITY.EnqPayImgBean" >
                        <logic:equal name="payImage" property="txtPayCode1" value="998">
                          <% flg1 = 1; %>
                          <td width="9%" align = "right"><html:text property="txtAmt1" name="payImage" size = "11" style="text-align:right" readonly="true"/></td>
                          </logic:equal>
                       </logic:iterate>                  
                       <% if (flg1 ==0) { %>
                          <td width="9%" align = "right"><html:text size = "11" property = "txtAmt1" value = "" style="text-align:right" readonly="true" /></td>                       
                       <%  } %>                                              
                       <td width="2%">&nbsp;</td>    
                      </tr> 
                    </table>
    ...
    <html:hidden name="frmEnqPayImgGang" property="screenName" value="PayImgGangWiseInctScreen" />
...
function doQueryMode()
{
  ...
  frmEnqPayImgGang.action="../../../EnqPayImageInctQueryMode.do"
...
function GetDetail()
{
  ...
  frmEnqPayImgGang.action="../../../EnqPayImgInctGetDetailAction.do"
  frmEnqPayImgGang.submit();
}
function doRefresh()
{
  frmEnqPayImgGang.action="../../../EnqPayImgInctRefresh.do"
  frmEnqPayImgGang.submit();
}
function getHeaderRecord()
{
	if(mandatory_Check("frmEnqPayImgGang")){
		...
		document.all.butSave.disabled="true";
		document.all.butSave.src="../INCLUDES/IMAGES/save_dis.jpg";
		frmEnqPayImgGang.action="../../../PayImgInctGetHeaderAction.do";
		frmEnqPayImgGang.submit();
	}
}
...
{ 
    ...
    frmEnqPayImgGang.action="../../../PayImgInctGetNextHeader.do";
    frmEnqPayImgGang.submit();
}
...
function JumpDetail()
{
    ...
    frmEnqPayImgGang.action = "../../../PayImgInctGetNextDetail.do";
    frmEnqPayImgGang.submit();
