...
<table>
  <TR height=30>
    <TD  colSpan=11 class=mainHeader height=10>DPS LABOUR INFORMATION</TD>
  </TR>
       ...
       <TABLE cellSpacing=0 cellPadding=0 >
           ...
           <!--Added by dushyant on 18-May-2013-->
              ...
              <tr>             
                  ...
                  <td >
                  <logic:equal property= "screenMode" name= "frmDPSInfoForm" value="U"> 
                  <html:select property="parentZone" name="frmDPSInfoForm" titleKey="Payroll.EmpInfo.parentZone" disabled="true" styleClass="required" alt="<%=String.valueOf(i)%>"  onchange="if(document.all.screenMode.value!='Q'){lfnChanged(this.value);}"  style="WIDTH: 80%"  >
...
function ShowEmpNum()
{
   ...
   if(frmDPSInfoForm.screenMode.value == 'N')
   {
     ...
     //  frmDPSInfoForm.txtSearchFields.value = "Payroll.Common.empNo,Payroll.EmpInfo.FirstName,Payroll.EmpInfo.LastName";         commented by dushyant on 15-11-2010
