...
<TBODY>
  ...
  <table cellspacing=0 cellpadding=0 border=0>
     ...
     <!-- added by dushyant on 12-09-2010 -->               
                    ...
                    <td bgcolor="#4682B4" nowrap class=actTabText > CPF Nominee Details<img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
  			...
  			<!-- Detail table starts -->
                        <TABLE cellSpacing="0" cellPadding="0" id="Detail" >
                          ...
                          <TR>
                            ...
                            <TD class=tableHeader width="5%"><bean:message  key="Payroll.EmpInfo.NomineeGuardian" /></TD>  
                            <TD class=tableHeader width="5%"><bean:message  key="Payroll.EmpInfo.NomineeShare" /></TD>                            
                            </TR>                          
                          <logic:iterate id="Gratuity" name="frmEmpNomineeInfoForm" property="lstInstrDtls2" type="FCIPAY.Payroll.UTILITY.EmpDepndntBean" >
                              <% ++i; %>
                                <logic:notEqual name="Gratuity" property="status" value="D" >                                                        
                            <tr> <% ++j; %>
                              <td  width="1%" align="center"><html:checkbox property="checked"  name="frmEmpNomineeInfoForm" onclick="checkRecord();"  /></td>
                              <td  width="5%" ><html:text property="txtGratuityName" name="Gratuity" styleClass="required" style="width:100%;text-align:right"  alt="<%=String.valueOf(i)%>" maxlength="30"  onchange="Chk_Char(this.alt,'txtGratuityName'); return changed(this.alt);"/></td>
                              <td  width="5%" ><html:text property="txtGratuityAge" name="Gratuity" styleClass="required" style="width:100%;text-align:right"  alt="<%=String.valueOf(i)%>" maxlength="3" onchange="lfnChange(this.value,this.alt);"/></td>
                              <td  width="5%" ><html:text property="txtGratuityRel" name="Gratuity" styleClass="required" maxlength="25" style="width:100%;text-align:right"  alt="<%=String.valueOf(i)%>" onchange="Chk_Char(this.alt,'txtGratuityRel'); return changed(this.alt);"/></td>                           
                              <td  width="5%" ><html:text property="txtGratGuardian" name="Gratuity" maxlength="50" style="width:100%;text-align:right"  alt="<%=String.valueOf(i)%>" onchange="Chk_Char(this.alt,'txtGratGuardian'); return changed(this.alt);"/></td>
                              <td  width="5%" ><html:text property="txtGratuityShare" name="Gratuity" styleClass="required" maxlength="5" style="width:100%;text-align:right"  alt="<%=String.valueOf(i)%>" onchange="lfnChangePer(this.value,this.alt); return changed(this.alt);"/></td>                            
                              <html:hidden property="itemChecked" name="Gratuity" />
                              <html:hidden property="txtNomineeId" name="Gratuity" />
							                <html:hidden property="txtGratuityId" name="Gratuity" />
                              <html:hidden property="txtDepndntId" name="Gratuity" /> 
							                <html:hidden property="txtDepndntName" name="Gratuity" /> 
							                <html:hidden property="txtDepndntAge" name="Gratuity" /> 
							                <html:hidden property="txtDepndntRel" name="Gratuity" />
                              <html:hidden property="txtDepndntGuard" name="Gratuity" /> 
							                <html:hidden property="txtNomineeShare" name="Gratuity" />
                              <html:hidden property="txtDepndntEffFrom" name="Gratuity" />
                              <html:hidden property="txtDepndntEffTill" name="Gratuity" />                              
                              <html:hidden property="status" name="Gratuity" />    
                              <html:hidden property="detailId" name="Gratuity" value="Default"/>
                          </tr>
                        </logic:notEqual>
                        <logic:equal name="Gratuity" property="status" value="D" >
                         <tr>
                            <td  width="1%" ><html:hidden property="checked" value="notchecked" /></td>
                            <td  width="5%" ><html:hidden property="txtGratuityName" name="Gratuity"  /></td>
                            <td  width="5%" ><html:hidden property="txtGratuityAge" name="Gratuity"  /></td>
                            <td  width="5%" ><html:hidden property="txtGratuityRel" name="Gratuity"  /></td> 
                            <td  width="5%" ><html:hidden property="txtGratGuardian" name="Gratuity"  /></td> 
                            <td  width="5%" ><html:hidden property="txtGratuityShare" name="Gratuity"  /></td>                                                        
...
<html:hidden name="frmEmpNomineeInfoForm"  property="screenName" value="EmpGratuityScreen" />
...
function lfnLoad()
{ 
    mode1=document.all.flagGratuity.value;
...
function Chk_Char_age(ind,name)
{
    ...
    for(i=0; i < iTr2 -1; i++)
    {
		if(document.getElementsByName("txtGratuityAge")[i].value!="")
		{
		   if((document.getElementsByName("txtGratuityAge")[i].value) < 18)
		   {
			var guard = document.getElementsByName("txtGratGuardian")[i];
			if(guard.value=="") 
			{
				
				document.getElementsByName("txtGratGuardian")[i].style.background="#ffffd3";
				document.getElementsByName("txtGratGuardian")[i].style.className="required"; 
...
{
    frmEmpNomineeInfoForm.lovKey.value = "EmpGratuity" + frmEmpNomineeInfoForm.screenName.value + frmEmpNomineeInfoForm.screenMode.value;
...
{    
    ...
    for(i=0; i < iTr2 -1; i++)
    {
        ...
        {                
            document.getElementsByName("txtGratuityName")[i].disabled=""; 
        }
    }  
   if(!mandatory_Check("frmEmpNomineeInfoForm"))
     return false;
      ...
      document.all.flagGratuity.value='true';
      frmEmpNomineeInfoForm.headerPrimaryKey.disabled="";    
      document.forms[0].action = "../../../EmpGratuityAddRowAction.do";
...
function doBaseDelRow()
{
    ...
    frmEmpNomineeInfoForm.headerPrimaryKey.disabled="";
    document.forms[0].action = "../../../EmpGratuityDeleteRowAction.do";
    document.forms[0].submit(); 
...
function SaveRecord()
{
    ...
    for(i=0; i < iTr2 -1; i++)
    {
        if (document.getElementsByName("status")[i].value == 'D')
          ...
          share = share +parseFloat(document.getElementsByName("txtGratuityShare")[i].value);            
    }
    ...
    frmEmpNomineeInfoForm.action = "../../../EmpGratuitySaveAction.do";
    frmEmpNomineeInfoForm.submit();
}
...
{    
    frmEmpNomineeInfoForm.action="../../../EmpGratuityNewMode.do"
    frmEmpNomineeInfoForm.submit();
}
...
function doQueryMode()
{
    ...
    frmEmpNomineeInfoForm.action="../../../EmpGratuityQueryMode.do"
    frmEmpNomineeInfoForm.submit();
...
function getHeaderRecord()
{
    ...
    frmEmpNomineeInfoForm.action="../../../EmpGratuityHeaderAction.do"
    frmEmpNomineeInfoForm.submit();
}
...
{ 
    ...
    frmEmpNomineeInfoForm.action="../../../EmpGratuityNextHeaderAction.do";
    frmEmpNomineeInfoForm.submit();
}
...
function doGetTab(arg)
{
    ...
    frmEmpNomineeInfoForm.action="../../../EmpGratuityTabAction.do";
    frmEmpNomineeInfoForm.submit();
}
...
function doBasePrevDetail()
{
    ...
    frmEmpNomineeInfoForm.action = "../../../EmpGratuityNextDetailAction.do";
    frmEmpNomineeInfoForm.submit();
}
...
function doRefresh()
{
		frmEmpNomineeInfoForm.action = "../../../EmpGratuityRefresh.do";
		frmEmpNomineeInfoForm.submit();
}
...
function checkSharePer()
{
    ...
    for(i=0;i<iTR-1;i++)
    {   
        sum=sum+ parseInt(document.getElementsByName("txtGratuityShare")[i].value,10);  
    } 
