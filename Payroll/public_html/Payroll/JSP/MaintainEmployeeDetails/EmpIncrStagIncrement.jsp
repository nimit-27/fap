  ...
  <table cellspacing=0 cellpadding=0 border=0>
      ...
      <TABLE cellspacing="0" cellPadding="0" >
              <TR>
                ...
                <td bgcolor="#76A2C7" nowrap class=disTabText onclick=getTab("advincrdtl")>Advance Increment Details <img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                <td><img src="../INCLUDES/IMAGES/formtab_r.gif" width="10" height="21" border="0"></td>
                
                
                 <td bgcolor="#4682B4" width="10"><img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                <td bgcolor="#4682B4" nowrap class=actTabText > Stagnation Increment Details<img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
            ...
            <TD colspan=14>
  			...
  			<!-- Detail table starts -->
                     <TABLE cellSpacing=0 cellPadding=0 border=0>
                      ...
                      <tr>
                       <logic:equal property="screenMode" name="frmEmpIncrForm" value="N">
                         <td class=labelText width="23%"><bean:message key="Payroll.EmpInfo.StagIncEffDate"/></td>
                             <td>
                    <html:text  property="txtStagEffDt"  maxlength="10" size="23"  styleClass= "required" readonly="false" onchange= " lfnChanged(this.value);" /> 
                    <img src="..\INCLUDES\IMAGES\cal.gif" title="Calender" width=15 height=19 align="top" styleClass="lov"  property="txtStagEffDt" name="effDate" 
                    onclick="showCalendar('txtStagEffDt',this)" />  
               
                                       
                </td>
                         <td class=labelText width="23%"><bean:message key="Payroll.EmpInfo.StrInc"/></td>
                                    <td>
                                          <html:text  property="txtStagIncrAmt"  maxlength="25" size="23" styleClass="required" readonly="false" style="text-align:right"/>               
                                    </td>
		       ...
		       <td class=labelText width="23%"><bean:message key="Payroll.EmpInfo.StagIncEffDate" /></td>
		          <td>
			     <html:text  property="txtStagEffDt"  maxlength="10" size="23"  styleClass= "locked"  onchange= " lfnChanged(this.value); " readonly="true"/> 
                         <img src="..\INCLUDES\IMAGES\cal.gif" title="Calender" width=15 height=19 align="top" styleClass="lov" name="effDate"  />  
                          ...
                          <td class=labelText width="23%"><bean:message key="Payroll.EmpInfo.StrInc"/></td>
                                    <td>
                                          <html:text  property="txtStagIncrAmt"  maxlength="25" size="23" styleClass="locked"  readonly="true" style="text-align:right"/>               
                                    </td>
    ...
    {          
       ...
       // {
            ...
            document.all.butSave.src="../INCLUDES/IMAGES/save_dis.jpg";
              document.all.forwardedPage.value="stagnation";
...
{   
	document.all.forwardedPage.value=arg;
        //document.getElementById("txttabtype").value=""
