...
<table>
  <TR height=30>
    <TD  colSpan=11 class=mainHeader height=10>EMPLOYEE PROMOTION/REVERSAL INFORMATION SIX PAY</TD>
  </TR>
            ...
            <TD colspan=14>
  			...
  			<!-- Detail table starts -->
                    ...
                    <tr>
                          ...
                          <td colspan="1">
                          <logic:equal property= "screenMode" name= "frmEmpPromotionForm6Pay" value="N">  
                          <html:text  property="gradePay" value="0" styleClass = "locked" alt="<%=String.valueOf(i)%>" maxlength="25" size="23" style="text-align:right" readonly="true" />                       
                          </logic:equal> 
                          <logic:notEqual property= "screenMode" name= "frmEmpPromotionForm6Pay" value="N">
                          <html:text  property="gradePay" styleClass = "locked" alt="<%=String.valueOf(i)%>" maxlength="25" size="23" style="text-align:right" readonly="true" />
                          </logic:notEqual>
                          </td>
                     </tr> 
...
<html:hidden name="frmEmpPromotionForm6Pay"  property="screenName" value="MaintEmpPromotionScreen6Pay" />
...
function SaveRecord()
{
    ...
    //{
        ...
        if(mandatory_Check("frmEmpPromotionForm6Pay"))
        {
            ...
            frmEmpPromotionForm6Pay.action = "../../../EmpPromoSaveAction6Pay.do";            
            frmEmpPromotionForm6Pay.submit();
          }
    //}  
    else
