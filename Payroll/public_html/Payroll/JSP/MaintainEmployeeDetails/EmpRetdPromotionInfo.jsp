...
<html:html>
  ...
  <html:base/>
    ...
    <script language="javascript" src="../../../COMMON/JavaScript/validate.js"
...
<BODY  onload="lfnLoad();history.forward(1);" >
<jsp:include page="../../../COMMON/JSP/menu.jsp" flush="true" />
<html:form  action="MaintRetdPromotionDetailBase" name="frmEmpPromotionForm" type="FCIPAY.Payroll.WEBTIER.Form.MaintEmpPromotionForm">
...
<table>
  <TR height=30>
    <TD  colSpan=11 class=mainHeader height=10>(EX)EMPLOYEE PROMOTION/REVERSAL INFORMATION</TD>
  </TR>
...
<!-- jatin -->
						...
						<td  align="right" colspan="3" class=labelText><bean:message key="Payroll.EmpInfo.newBasic" />
						</td>
                        <td colspan="1">
							 <%
									if (empLbr.equals("E") || empLbr.equals("L") ) 
...
<html:hidden name="frmEmpPromotionForm"  property="screenName" value="MaintEmpRetdPromotionScreen" /> 
<!--  ==================== Added by Avtar Dt 09 Jul 2013 (Promotion Super User) End==============================  -->
<html:hidden name="frmEmpPromotionForm"  property="retdscreenName" value="MaintEmpRetdPromotionScreen" />
...
function ShowEmpNum()
{
    frmEmpPromotionForm.lovKey.value = "EmpPromoRetd" + frmEmpPromotionForm.screenName.value + frmEmpPromotionForm.screenMode.value;    
...
function doQueryMode()
{
    ...
    frmEmpPromotionForm.action="../../../MaintRetdPromotionQueryMode.do"
...
{
    document.all.buttonFlag.value=''; 
    frmEmpPromotionForm.action="../../../MaintRetdPromotionRefresh.do"
    frmEmpPromotionForm.submit();
}
...
function doInsertMode()
{
    ...
    document.all.buttonFlag.value='';
    frmEmpPromotionForm.action="../../../MaintRetdPromotionNewMode.do"
    frmEmpPromotionForm.submit();
}
...
{
    document.all.buttonFlag.value='';
    frmEmpPromotionForm.action="../../../MaintRetdPromotionGetHeaderAction.do"
    frmEmpPromotionForm.submit();
}
...
{ 
    ...
    frmEmpPromotionForm.action="../../../MaintRetdPromotionGetNextHeader.do";
    frmEmpPromotionForm.submit();
}
...
function PrevHeader()
{
    document.all.buttonFlag.value='';
    frmEmpPromotionForm.userPositionRequested.value = 1*frmEmpPromotionForm.positionRequested.value - 1;
    frmEmpPromotionForm.action = "../../../MaintRetdPromotionGetPrevHeader.do";
    frmEmpPromotionForm.submit();
}
...
function SaveRecord()
{
    ...
    //{
        ...
        if(mandatory_Check("frmEmpPromotionForm"))
        {
            ...
            frmEmpPromotionForm.action = "../../../MaintRetdPromotionSaveAction.do";   
           //alert(document.getElementById("RetdscreenName").value);
            frmEmpPromotionForm.submit();
          }
    //}  
    else
