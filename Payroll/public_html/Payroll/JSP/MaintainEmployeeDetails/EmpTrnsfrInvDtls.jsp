 	 ...
 	 <TR height="100">
            ...
            <TABLE cellSpacing=0 cellPadding=0 border = 0 >
               <TR>          
                ...
                <td bgcolor="#4682B4" nowrap class=disTabText  onclick=doGetTabs("RlsSalryDet")> Release Salary<img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                <td><img src="../INCLUDES/IMAGES/formtab_r.gif" width="10" height="21" border="0"></td>

				<!--added by swapnendu-->
                <td bgcolor="#4682B4" width="10"><img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                <td bgcolor="#4682B4" nowrap class=disTabText onclick="doGetTabs('rlsIncentive')"> Release Incentive <img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                <td><img src="../INCLUDES/IMAGES/formtab_r.gif" width="10" height="21" border="0"></td>
				<!--added by swapnendu-->

				<td bgcolor="#76A2C7" width="10"><img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                <td bgcolor="#76A2C7" nowrap class=actTabText >Invoice Details<img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
 ...
 <!-- Detail table Container starts -->
  			...
  			<!-- Detail table starts -->
                        <TABLE cellSpacing=0 cellPadding=0 border=0>
                          ...
                          <td ><html:select property="txtInvNum" name="frmEmpTrnsfrForm"  titleKey="Payroll.EmpInfo.Inv" styleClass="optional"  >
...
<html:hidden property="txtIncentive" name="frmEmpTrnsfrForm"  />
...
function doGetTabs(arg)
{
	...
	if(emp_no != "")
	{
		...
		document.forms[0].action="../../../EmpTrsfrSalRlsTabAction.do";
		document.forms[0].submit(); 
	}
	else
	{
