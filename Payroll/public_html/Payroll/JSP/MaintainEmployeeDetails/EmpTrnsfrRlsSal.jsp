...
<table>
  <TR height=30>
    <TD  colSpan=11 class=mainHeader height=10>RELEASE SALARY</TD>
  </TR>
       ...
       <TABLE cellSpacing=0 cellPadding=0 >
            ...
            <table  cellSpacing=0 cellPadding=0 border=0> 
              ...
              <tr>
                  ...
                  <td ><html:text property="txtEmpStatus" name="frmEmpTrnsfrForm" size="23" readonly="true" styleClass="locked" alt="<%=String.valueOf(i)%>"  onchange="return changed(this.alt)" />
                  </td>             
                  
                  <td>&nbsp;</td>
		        </tr>
				 <!-- Added by dushyant on 14-Dec-2011 for DPS Salary release-->
                <%
				if (strEmpLbrFlag!=null)
				{
				  if(strEmpLbrFlag.equals("D")) 
					  {
				    %>
				  <TR>
 	 ...
 	 <TR height="100">
            ...
            <TABLE cellSpacing=0 cellPadding=0 border = 0 >
               <TR>          
                ...
                <td bgcolor="#76A2C7" nowrap class=actTabText >Release Salary<img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                <td><img src="../INCLUDES/IMAGES/formtab_lb.gif" width="10" height="21" border="0"></td>
                
				<!--added by swapnendu-->
                <td bgcolor="#4682B4" width="10"><img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                <td bgcolor="#4682B4" nowrap class=disTabText onclick="doGetTab('rlsIncentive')">Release Incentive <img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                        ...
                        <TABLE cellSpacing=0 cellPadding=0 border=0>
                          <TBODY>    
                            ...
                            <tr width="100%">                           
                              ...
                              <td ><html:select property="txtYYMM" titleKey="Payroll.EmpInfo.YYMM" styleClass="required"  >
                              <html:option value="" >---------Please Select---------</html:option>      
                              <logic:present name="SalaryYrMonth">
                              <html:optionsCollection label="label" value="value" property="valueSalRlsYrMnthList" name="SalaryYrMonth"/>
                              </logic:present>
                              </html:select>                            
                        </td>   
...
<!-- Bottom Blue Bar -->
      <TR>
        ...
        <td  bgcolor=#4682b4>
        <html:button property="butCancel" value="Release Salary" onclick="rlsSal()" />
        </td>
...
function ShowEmpNum()
{
   if(frmEmpTrnsfrForm.screenMode.value=='Q')
   {
     ...
     frmEmpTrnsfrForm.txtSearchFields.value = "Payroll.Common.empNo,Payroll.Common.empName";
...
{
    document.all.buttonFlag.value=''; 
    frmEmpTrnsfrForm.action="../../../EmpRlsSalRefresh.do"
    frmEmpTrnsfrForm.submit();
}
...
{   
    ...
    {
      document.all.forwardedPage.value=arg;
      document.forms[0].action="../../../RlsSalaryTabAction.do";
      document.forms[0].submit(); 
    }  
}
