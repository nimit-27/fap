...
<table>
  <TR height=30>
    <TD  colSpan=11 class=mainHeader height=10><%=lbrDisplayName%> SALARY RELEASE INFORMATION</TD>
  </TR>
  ...
  <table cellspacing=0 cellpadding=0 border=0>
      ...
      <TABLE cellspacing="0" cellPadding="0" >
              <TR>   
                ...
                <td bgcolor="#4682B4" nowrap class=actTabText >Salary Release<img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                     ...
                     <TABLE cellSpacing=0 cellPadding=0 border=0>
                      <TBODY>
                        <TR width="100%">                        
                          ...
                          <td ><html:select property="txtYYMM" name="frmEmpSuspensionForm"  titleKey="Payroll.EmpInfo.YYMM" styleClass="required"  >
...
<!-- Bottom Blue Bar -->
      <TR>
        ...
        <td  bgcolor=#4682b4><html:button value='   RELEASE SALARY   '  onclick="releaseSalary()" property="butInsert" styleClass="bottomBarText" /></td>
