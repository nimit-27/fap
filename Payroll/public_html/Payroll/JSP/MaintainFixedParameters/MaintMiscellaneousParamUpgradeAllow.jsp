...
<!--                    <td bgcolor="#76A2C7" width="10"><img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                    ...
                    <td><img src="../INCLUDES/IMAGES/formtab_lb.gif" width="10" height="21" border="0"></td>
<!--                    <td bgcolor="#76A2C7" width="10"><img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                    <td bgcolor="#76A2C7" nowrap class=disTabText onclick=doGetTab("other")> Other Allowance <img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                    <td><img src="../INCLUDES/IMAGES/formtab_lb.gif" width="10" height="21" border="0"></td>-->
                    <td bgcolor="#4682B4" width="10"><img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                    <td bgcolor="#4682B4" nowrap class=actTabText > Upgrade Allowance <img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                   ...
                   <!-- Detail table Container starts -->
                    <TD colspan=20>
                     ...
                     <TR>
                              ...
                              <td class=tableHeader width="4%"><bean:message key="pay.MaintMiscellaneousParam.categ" /></td>
<!--                              <td class=tableHeader width="4%"><bean:message key="pay.MaintMiscellaneousParam.AmtFrom" /></td>
                              <td class=tableHeader width="4%"><bean:message key="pay.MaintMiscellaneousParam.AmtTo" /> </td>   -->
                              <td class=tableHeader width="4%"><bean:message key="pay.MaintMiscellaneousParam.PayScaleGrade" /> </td>                               
                              <td class=tableHeader width="5%"><bean:message key="pay.MaintMiscellaneousParam.UpAllow" /> </td>
    
                        </tr> 
                          
                          <logic:iterate id="upgradeInfo" name="frmMaintMiscellaneousParam" property="lstUpgradeDtls" type="FCIPAY.Payroll.UTILITY.MiscellaneousParamDtlUpgradeBean" >
                              <% ++i; %>
                                <logic:notEqual name="upgradeInfo" property="status" value="D" >                                                        
                                <tr>
                                  <td align="center" ><html:checkbox property="checked" onclick="checkRecord();" /></td>
                                  <td>
                                      <html:select property="txtCateg" name="upgradeInfo" styleClass="required"  style="width:100%"  alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt);"  >
                                          <html:option value="" >-----------Please Select-----------</html:option>      
                                          <logic:present name="Cadre">
                                            <html:optionsCollection label="label" value="value" property="categList" name="Cadre"/>
                                          </logic:present>
                                        </html:select>
                                  </td>

                                  <!--<td ><html:text property="txtCateg" name="upgradeInfo"  styleClass="required" style="width:100%"  alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt);"  /></td>-->
                                  <td>
                                  <html:select property="txtPayScale"  styleClass="required" name="upgradeInfo" style="width:100%"  alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt);"  >
                                      <html:option value="" >-----------Please Select-----------</html:option>      
                                      <logic:present name="Cadre">
                                        <html:optionsCollection label="label" value="value" property="payScaleList" name="Cadre"/>
                                      </logic:present>
                                    </html:select>
                                  </td>
                                  
                                  <td ><html:text property="txtUpgradeAllow" name="upgradeInfo"  styleClass="required" style="width:100%;text-align:right"  alt="<%=String.valueOf(i)%>" onchange="lfnChange(this.value,this.alt);"  /></td>
                                   <html:hidden property="txtUpgradeSrl" name="upgradeInfo" />
                                   <html:hidden property="itemChecked" name="upgradeInfo" />
                                   <html:hidden property="status" name="upgradeInfo" />
                                   <html:hidden property="detailId" name="upgradeInfo" value="Default"/>
                               </tr>
                        </logic:notEqual>
                        <logic:equal name="upgradeInfo" property="status" value="D" >
                                <tr>
                                  <td align="center" ><html:hidden property="checked" value="notchecked" /></td>
                                  <td ><html:hidden property="txtCateg" name="upgradeInfo"  /></td>
                                   <td ><html:hidden property="txtPayScale" name="upgradeInfo" /></td>                                                                         
                                  <td ><html:hidden property="txtUpgradeAllow" name="upgradeInfo"  /></td>
                                   <html:hidden property="txtUpgradeSrl" name="upgradeInfo" />
                                   <html:hidden property="itemChecked" name="upgradeInfo" />
                                   <html:hidden property="status" name="upgradeInfo" />
                                   <html:hidden property="detailId" name="upgradeInfo" value="Default"/>
...
<html:hidden name="frmMaintMiscellaneousParam"  property="screenName" value="MiscUpgradeParamScreen" />
...
<html:hidden property="flagUpgrade" name="frmMaintMiscellaneousParam" />
...
function lfnLoad()
{
  ...
  tot = document.all.flagUpgrade.value;
  if(mode=='')
  {
      doQueryMode();
...
function doBaseAddRow()
{
  ...
  {
      document.forms[0].action = "../../../upgradeAddRowAction.do";
...
function doBaseDelRow()
{
  ...
  document.forms[0].action = "../../../upgradeDeleteRowAction.do";
  document.forms[0].submit();  
}
...
function GetDetail()
{
  ...
  frmMaintMiscellaneousParam.flagUpgrade.value = "true" ;
  frmMaintMiscellaneousParam.screenMode.value = "U" ;
  frmMaintMiscellaneousParam.action="../../../upgradeFirstGetDetailAction.do"
  frmMaintMiscellaneousParam.submit();
}

function doInsertMode()
{
  frmMaintMiscellaneousParam.action="../../../upgradeNewMode.do"
  frmMaintMiscellaneousParam.submit();
}

function doQueryMode()
{
  frmMaintMiscellaneousParam.action="../../../upgradeQueryMode.do"
  frmMaintMiscellaneousParam.submit();
}
...
function doRefresh()
{
  frmMaintMiscellaneousParam.action="../../../upgradeRefresh.do"
  frmMaintMiscellaneousParam.submit();
}
...
function SaveRecord()
{
  if(mandatory_Check("frmMaintMiscellaneousParam"))
  {
    ...
    if(!checkDuplicacy())
      ...
      frmMaintMiscellaneousParam.action = "../../../upgradeSaveAction.do";
      frmMaintMiscellaneousParam.submit();
  }
  else
  {
...
function doBasePrevDetail()
{
    ...
    frmMaintMiscellaneousParam.action = "../../../upgradeNextDetailAction.do";
    frmMaintMiscellaneousParam.submit();
}
...
function JumpDetail()
{
 ...
 function doGetTab(arg)
 {
    ...
    document.forms[0].action="../../../UpgradeTabAction.do";
    document.forms[0].submit();
 }
...
function checkDuplicacy()
{
  ...
  for (i = 0; i < lengthOfTable - 2; i++)
  {
    newComb = document.getElementsByName("txtCateg")[i].value + document.getElementsByName("txtPayScale")[i].value;  
    for(ind = i +1 ; ind < lengthOfTable - 1 ; ind ++ )
    {
          if((document.getElementsByName("status")[ind-1].value) != "D")
          {                      
              oldComb = document.getElementsByName("txtCateg")[ind].value + document.getElementsByName("txtPayScale")[ind].value;
              if(oldComb == newComb)
              {
                ...
                //event.srcElement.focus();
                //event.returnValue=false;
                document.getElementsByName("txtCateg")[ind].focus();                
                return false;
             }
          }
      }
