...
<html:hidden property="payScaleType" value="ALL" />
<%! int i=0,j=0; %>
<% i = 0;j=0; %>
    ...
    <TD>
       ...
       <TR>
        ...
        <tr>
            ...
            <td align="left">
            <html:text  property="txtEffectDate" altKey="Payroll.MaintTransport.date" maxlength="10" size="16" styleClass="required" />            <logic:equal property= "screenMode" name= "frmMaintConvAllowAndRecRates" value="Q">            
            ...
            <logic:notEqual property= "screenMode" name= "frmMaintConvAllowAndRecRates" value="Q">            
...
<!--                                              <TD class=tableHeader width="15%">Amount From</TD>
                                              ...
                                              <TD class=tableHeader width="15%">PayScale Grade</td>                                              
                                              <TD class=tableHeader width="15%">Allowance</td>
                                               </tr> 
                             <logic:iterate id="convallowinfo" name="frmMaintConvAllowAndRecRates" property="lstInstrDtls" type="FCIPAY.Payroll.UTILITY.MaintConvAllowBean" >
                              <% ++i; %>
                               <logic:notEqual name="convallowinfo" property="status" value="D" >  
                                   <tr>
                                       <td ><html:checkbox property="checked" onclick="checkRecord();"  value="" name="frmMaintConvAllowAndRecRates" /></td>
                               ...
                               <!--    <td ><html:text property="txtAllow" name="convallowinfo"  styleClass="required" size="6" style="width:100%" alt="<%=String.valueOf(i)%>" onchange="if (num_Check(this.value,1)) return changed(this.alt);" /></td> -->
                                  ...
                                  <td>
                                  <html:select property="txtPayScale"  styleClass="required" name="convallowinfo" style="width:100%"  alt="<%=String.valueOf(i)%>" onchange="return changed(this.alt);"  >
                                      <html:option value="" >-----------Please Select-----------</html:option>      
                                      <logic:present name="ConvAllowCity">
...
<html:hidden name="frmMaintConvAllowAndRecRates"  property="screenName" value="ConvAllowAllScreen" />
 ...
 function doBaseAddRows2()
{
    ...
    frmMaintConvAllowAndRecRates.screenModeConvAllow.value = "N1";
    frmMaintConvAllowAndRecRates.detailDataChanged.value = "false";    
    document.getElementById("txtEffectDate").disabled="";
    document.getElementById("headerPrimaryKey").disabled="";

    
    frmMaintConvAllowAndRecRates.action = "../../../ConvAllowALLAddRowAction.do";
...
function doBaseDelRow()
{
  ...
  document.forms[0].action = "../../../ConvAllowALLdeleteRowAction.do";
  document.forms[0].submit();  
}
  ...
  function GetDetail()
  {
   document.all.buttonFlag.value='';  
    document.all.screenModeAll.value='UG';
...
//    frmMaintConvAllowAndRecRates.headerPrimaryKey.value = frmMaintConvAllowAndRecRates.txtRevYYMM.value + "," + frmMaintConvAllowAndRecRates.lstPayScale.value;  
    frmMaintConvAllowAndRecRates.action="../../../ConvAllowALLFirstGetDetailAction.do";
    frmMaintConvAllowAndRecRates.submit();
  }
...
//  document.all.screenModePay1.value=document.all.screenModePay2.value;
  ...
  frmMaintConvAllowAndRecRates.payScaleType.value = "ALL";  
//  document.all.screenModePay2.value = "U";      
  document.all.butSave.disabled="true";
  document.all.butSave.src="../INCLUDES/IMAGES/save_dis.jpg";
  frmMaintConvAllowAndRecRates.action = "../../../ConvAllowALLSaveAction.do";
  frmMaintConvAllowAndRecRates.submit();
}
...
//  document.all.screenModeAll.value  = "N";
  ...
  frmMaintConvAllowAndRecRates.action="../../../ConvAllowAllNewMode.do"
  frmMaintConvAllowAndRecRates.submit();
}
...
function doQueryMode()
{
   ...
   frmMaintConvAllowAndRecRates.action="../../../ConvAllowAllQueryMode.do"
   frmMaintConvAllowAndRecRates.submit();
}
...
/*   if (frmMaintConvAllowAndRecRates.screenModeConvAllow.value == "Q"  && frmMaintConvAllowAndRecRates.screenModeAll.value != "Q")
        frmMaintConvAllowAndRecRates.screenModeAll.value = "Q"   
   if ( frmMaintConvAllowAndRecRates.screenModeConvAllow.value == "U" || frmMaintConvAllowAndRecRates.screenModeConvAllow.value == "U1") 
     { 
      if (frmMaintConvAllowAndRecRates.screenModeAll.value != "U" && frmMaintConvAllowAndRecRates.screenModeAll.value != "UG")
        {
        frmMaintConvAllowAndRecRates.screenModeAll.value = "U"   
        }
      }      
   if (frmMaintConvAllowAndRecRates.screenModeConvAllow.value == "I" )
        frmMaintConvAllowAndRecRates.screenModeAll.value = "N"    */
...
/* if (frmMaintConvAllowAndRecRates.screenMode.value == "Q")
 {
    ...
    if (frmMaintConvAllowAndRecRates.screenModeConvAllow.value=="N1")
      {
           if (frmMaintConvAllowAndRecRates.screenModeAll.value == "")
           {
              ...
              {
                frmMaintConvAllowAndRecRates.screenModeAll.value="UG";                
              }            
            }    
            else
            {
    ...
    {
      if (frmMaintConvAllowAndRecRates.screenModeAll.value != "UG")          
       frmMaintConvAllowAndRecRates.screenModeAll.value="U";
    }
    else if (frmMaintConvAllowAndRecRates.screenModeConvAllow.value=="U1") 
    {
      if ((frmMaintConvAllowAndRecRates.headerClick.value != "ALL") &&  (frmMaintConvAllowAndRecRates.screenMode.value != "Q"))
      {
  ...
  mode = frmMaintConvAllowAndRecRates.screenModeAll.value;
...
function doBasePrevDetail()
{
    ...
    frmMaintConvAllowAndRecRates.action = "../../../ConvAllowALLPrevDetailAction.do";
    frmMaintConvAllowAndRecRates.submit();
}
...
function doBaseNextDetail()
{
    ...
    frmMaintConvAllowAndRecRates.userPageRequested.value = 1*frmMaintConvAllowAndRecRates.pageRequested.value + 1;
    frmMaintConvAllowAndRecRates.action = "../../../ConvAllowALLNextDetailAction.do";
    frmMaintConvAllowAndRecRates.submit();
}
...
function doRefresh()
  {
      ...
      frmMaintConvAllowAndRecRates.action = "../../../ConvAllowALLRefresh.do";
      frmMaintConvAllowAndRecRates.submit();
  }


function DupliChecks()
{
            var oTable = document.getElementById("Detail");
            var iTr2 = oTable.rows.length;
            var flag =0;
            ...
            j = 0;
             ...
             for(i=0;i<iTr2-2;i++)
            {   
                alert(document.getElementsByName("txtPayScale")[i].value);            
                if (document.getElementsByName("status")[i].value != 'D')
                {                  
...
{
//  frmMaintConvAllowAndRecRates.screenTypeStd.value= "UNG";
//  frmMaintConvAllowAndRecRates.screenModeStd.value= "U";   
  document.all.buttonFlag.value='';
  frmMaintConvAllowAndRecRates.action="../../../ConvAllowAllGetHeaderAction.do";
  frmMaintConvAllowAndRecRates.submit();
}
...
//    document.all.screenModePay1.value = "U";
    ...
    document.all.headerClick.value = "ALL"; 
		document.all.butExecute.disabled="true";
	document.all.butExecute.src="../INCLUDES/IMAGES/execute_dis.jpg";
...
{ 
    ...
    document.all.buttonFlag.value='';
    frmMaintConvAllowAndRecRates.screenModeAll.value='U';
     frmMaintConvAllowAndRecRates.headerClick.value = "ALL";
    document.all.screenModeConvAllow.value = "U1"; 
    frmMaintConvAllowAndRecRates.userPositionRequested.value = 1*frmMaintConvAllowAndRecRates.positionRequested.value + 1;   
    frmMaintConvAllowAndRecRates.action="../../../ConvAllowAllGetNextHeader.do";
    frmMaintConvAllowAndRecRates.submit();
}
