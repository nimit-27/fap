...
<!--container table starts -->
      <TABLE cellSpacing=0 cellPadding=0 border=0 >
       ...
       <!--Account  Header Row Starts -->
                <TR>
                  <TD class=subHeader colspan=6>Header For Maintain CCA Rates</TD>
                </TR>
                <TR>
                ...
                <tr>
                 <td class="labelText"  width="25%" >Effective Date</td>
                  ...
                  <logic:equal property= "screenMode" name= "frmMaintCCARate" value="Q">            
                  ...
                  <logic:equal property= "screenMode" name= "frmMaintCCARate" value="N">            
                  ...
                  <td class="labelText"  width="25%" >Type Of City</td>
                                  ...
                                  <DIV id=divDtlTable style="height:280px" >
                                    ...
                                    <TABLE cellSpacing=0 cellPadding=0 id="Detail">
                                      ...
                                      <TR height="22">
                                        ...
                                        <TD class=tableHeader width="10%">Amount From</TD>
                                        <TD class=tableHeader width="10%">Amount To</td>
                                        <TD class=tableHeader width="10%">Allowance</td>
                                      </tr> 
                                      <logic:iterate id="ccainfo" name="frmMaintCCARate" property="lstIdaInstrDtlsIDA" type="FCIPAY.Payroll.UTILITY.MaintCCARatesBean" >
                                        <% ++i; %>
                                        <logic:notEqual name="ccainfo" property="status" value="D" >  
                                          <tr>
                                            ...
                                            <logic:notEqual name="ccainfo" property="status" value="N" >
                                            <td>
                                              <html:select property="txtCtgry" name="ccainfo" styleClass="required" disabled="true" style="width:100%">
                                                <html:option value="" >-----------Please Select-----------</html:option>      
                                                <logic:present name="CCACities">
                                                  <html:optionsCollection label="label" value="value" property="ctgryList" name="CCACities"/>
                                                </logic:present>
                                              </html:select>
                                            </td>
                                            <td ><html:text property="startField" name="ccainfo" size="5" maxlength="9" readonly="true" styleClass="required" style="width:100%;text-align:right" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="
                                            ...
                                            <td ><html:text property="endField" name="ccainfo" size="5" maxlength="9" readonly="true" styleClass="required" style="width:100%;text-align:right" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="
                                                if (!num_Check(this.value,1))
                                                  {
                                                    this.focus();
                                                    return false;
                                            ...
                                            <td ><html:text property="txtAllow" name="ccainfo"  styleClass="required" size="6" maxlength="9" readonly="true" style="width:100%;text-align:right" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="
                                                if (!num_Check(this.value,1))
                                                {
                                                  this.focus();
                                                  return false;
                                            ...
                                            <td>
                                              <html:select property="txtCtgry" name="ccainfo" styleClass="required" style="width:100%" onchange="
                                              if(!(chk_FromAmount(this.value, this.alt)))
                                                  {
                                                    this.focus();
                                                    return false;
                                            ...
                                            <td ><html:text property="startField" name="ccainfo" size="5" maxlength="9" styleClass="required" style="width:100%;text-align:right" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="
                                                if (!num_Check(this.value,1))
                                                  {
                                                    this.focus();
                                                    return false;
                                            ...
                                            <td ><html:text property="endField" name="ccainfo" size="5" maxlength="9" styleClass="required" style="width:100%;text-align:right" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="
                                                if (!num_Check(this.value,1))
                                                  {
                                                    this.focus();
                                                    return false;
                                            ...
                                            <td ><html:text property="txtAllow" name="ccainfo"  styleClass="required" size="6" maxlength="9" style="width:100%;text-align:right" alt="<%=String.valueOf(i)%>" onkeypress="if((event.keyCode < 48 || event.keyCode > 57))return false;" onchange="
                                                if (!num_Check(this.value,1))
                                                {
                                                  this.focus();
                                                  return false;
                                            ...
                                            <html:hidden property="txtStartDate" name="ccainfo" />
                                            <html:hidden property="txtEndDate" name="ccainfo" />
...
<!-- Container Table Ends -->
      ...
      <html:hidden name="frmMaintCCARate"  property="screenModeIDA"  />
      <html:hidden name="frmMaintCCARate"  property="screenName" value="CCARateIDAScreen" />
      ...
      <html:hidden property="userPositionRequested" name="frmMaintCCARate" />
      <html:hidden property="positionRequested" name="frmMaintCCARate" />
...
<script language="javascript">
  ...
  function changedDt(val)
  {
    ...
    if(!flgResult)
    {
      document.getElementsByName("txtEndDate")[val-1].value = '';
    }
  }
  ...
  function doBaseAddRow()
  {
    if(mandatory_Check("frmMaintCCARate"))
    {
     ...
     {  
      ...
      document.forms[0].action = "../../../ccaRateIDAAddRowAction.do";
  ...
  if(strRecList!='')
  {
    ...
    frmMaintCCARate.headerPrimaryKey.disabled="";
    document.forms[0].action = "../../../ccaRateIDAdeleteRowAction.do";
    document.forms[0].submit();  
  }
  ...
  function SaveRecord()
  {
    ...
    frmMaintCCARate.action = "../../../ccaRateIDASaveAction.do";
    frmMaintCCARate.submit();
  }
  ...
  function doGetTab(arg)
  {
    ...
    document.forms[0].action="../../../CCAIdaTabAction.do";
    document.forms[0].submit();
  }
  ...
  {
  frmMaintCCARate.action="../../../CcaRateIdaNewMode.do"
  frmMaintCCARate.submit();
  }
  ...
  function doQueryMode()
  {
    ...
    frmMaintCCARate.action="../../../CcaRateIdaQueryMode.do"
    frmMaintCCARate.submit();
  }
...
function lfnLoad()
{
    ...
    if (frmMaintCCARate.screenMode.value == 'U')
    { 
          if(mode1=='false')
          {
              frmMaintCCARate.butGetDetail.disabled="";
        ...
        if (frmMaintCCARate.screenMode.value == 'N')
    {
        frmMaintCCARate.butInsert.disabled="";
    }
...
function doBaseNextDetail()
{
    ...
    frmMaintCCARate.action = "../../../ccaRateIDAPrevDetailAction.do";
    frmMaintCCARate.submit();
}
...
{
    frmMaintCCARate.userPageRequested.value = 1*frmMaintCCARate.pageRequested.value + 1;
    frmMaintCCARate.action = "../../../ccaRateIDANextDetailAction.do";
    frmMaintCCARate.submit();
}

function JumpDetail()
{
    frmMaintCCARate.userPageRequested.value = 1*frmMaintCCARate.newPageRequested.value ;
    frmMaintCCARate.action = "../../../ccaRateIDANextDetailAction.do";
    frmMaintCCARate.submit();
}
...
function doRefresh()
    {
        ...
        frmMaintCCARate.action = "../../../ccaRateIdaRefresh.do";
        frmMaintCCARate.submit();
    }
 ...
 function getHeaderRecord()
{
    ...
    frmMaintCCARate.action="../../../ccaRateIdaHeaderAction.do"
    frmMaintCCARate.submit();
}
...
{ 
    document.all.flagIda.value="false";
    document.all.flagCda.value="false";
    frmMaintCCARate.userPositionRequested.value = 1*frmMaintCCARate.positionRequested.value + 1;
    frmMaintCCARate.action="../../../ccaRateIdaNextHeaderAction.do";
    frmMaintCCARate.submit();
}
...
function JumpHeader()
{
    document.all.flagIda.value="false";
    document.all.flagCda.value="false";
    frmMaintCCARate.userPositionRequested.value = 1*frmMaintCCARate.newPositionRequested.value;
    frmMaintCCARate.action = "../../../ccaRateIdaNextHeaderAction.do";
    frmMaintCCARate.submit();
}
