            ...
            <!-- Purchase Requisition Info Table Starts -->
             <TABLE cellSpacing=0 cellPadding=0 >
                ...
                <TR>
                    ...
                    <td bgcolor="#4682B4" nowrap class=actTabText > Over Time Allowance <img src="../INCLUDES/IMAGES/pixel.gif" width="10" height="1" border="0"></td>
                           ...
                           <TD >
                            <DIV id=divDtlTable style="height:320px" >
                              ...
                              <TABLE cellSpacing=0 cellPadding=0  id="Detail" >
                                <TBODY>
                         <TR>
                              <td class=tableHeader width="4%"><html:checkbox property="selectAll" value="" onclick="toggleCheckBox('selectAll');checkRecord();" /></td>
                              <td class=tableHeader width="32%"><bean:message key="pay.MaintMiscellaneousParam.amtfrm" /></td>
                              <td class=tableHeader width="32%"><bean:message key="pay.MaintMiscellaneousParam.amtto" /></td>
                              <td class=tableHeader width="32%"><bean:message key="pay.MaintMiscellaneousParam.0vrtm" /> </td>    
                        </tr> 
                          
                          <logic:iterate id="oTimeInfo" name="frmMaintMiscellaneousParam" property="lstOTimeDtls" type="FCIPAY.Payroll.UTILITY.MiscellaneousParamDtlovrtimeBean" >
                              <% ++i; %>
                                <logic:notEqual name="oTimeInfo" property="status" value="D" >                                                        
                                <tr>
                                  <td align="center" ><html:checkbox property="checked" onclick="checkRecord();" /></td>
                                  <td ><html:text property="startField" name="oTimeInfo"  styleClass="required" style="width:100%;text-align:right"  alt="<%=String.valueOf(i)%>" readonly="true" onchange="return changed(this.alt);"  /></td>
                                  <td><html:text property="endField" name="oTimeInfo"  styleClass="required" style="width:100%;text-align:right"  alt="<%=String.valueOf(i)%>" onchange="lfnChange(this.value,this.alt);changeDtlStartField('startField','endField',this.alt,'0');"  /></td>
                                  <td ><html:text property="txtOvrTimeAllow" name="oTimeInfo"  styleClass="required" style="width:100%;text-align:right"  alt="<%=String.valueOf(i)%>" onchange="lfnChange(this.value,this.alt);"  /></td>                 
                                   <html:hidden property="txtOverSrl" name="oTimeInfo" />
                                   <html:hidden property="itemChecked" name="oTimeInfo" />
                                   <html:hidden property="status" name="oTimeInfo" />
                                   <html:hidden property="detailId" name="oTimeInfo" value="Default"/>
                               </tr>
                          </logic:notEqual>
                          <logic:equal name="oTimeInfo" property="status" value="D" >
                                <tr>
                                  <td align="center" ><html:hidden property="checked" value="notchecked" /></td>
                                  <td ><html:hidden property="startField" name="oTimeInfo"  /></td>
                                  <td><html:hidden property="endField" name="oTimeInfo"  /></td>
                                  <td ><html:hidden property="txtOvrTimeAllow" name="oTimeInfo" /></td>                 
                                   <html:hidden property="txtOverSrl" name="oTimeInfo" />
                                   <html:hidden property="itemChecked" name="oTimeInfo" />
                                   <html:hidden property="status" name="oTimeInfo" />
                                   <html:hidden property="detailId" name="oTimeInfo" value="Default"/>
...
<html:hidden name="frmMaintMiscellaneousParam"  property="screenName" value="MiscOTimeParamScreen" />
...
<html:hidden property="flagOtime" name="frmMaintMiscellaneousParam" />
...
function lfnLoad()
{
  ...
  tot = document.all.flagOtime.value;
  if(mode=='')
  {
      doQueryMode();
...
function doBaseAddRow()
{
  ...
  {
      document.forms[0].action = "../../../oTimeAddRowAction.do";
...
function doBaseDelRow()
{
  ...
  document.forms[0].action = "../../../oTimeDeleteRowAction.do";
  document.forms[0].submit();  
}

function GetDetail()
{
  frmMaintMiscellaneousParam.flagOtime.value = "true" ;
  frmMaintMiscellaneousParam.headerPrimaryKey.value = "#" ;
  frmMaintMiscellaneousParam.screenMode.value = "U" ;
  frmMaintMiscellaneousParam.action="../../../oTimeFirstGetDetailAction.do"
  frmMaintMiscellaneousParam.submit();
}

function doInsertMode()
{
  frmMaintMiscellaneousParam.action="../../../oTimeNewMode.do"
  frmMaintMiscellaneousParam.submit();
}

function doQueryMode()
{
  frmMaintMiscellaneousParam.action="../../../oTimeQueryMode.do"
  frmMaintMiscellaneousParam.submit();
}

function doRefresh()
{
  frmMaintMiscellaneousParam.action="../../../oTimeRefresh.do"
  frmMaintMiscellaneousParam.submit();
}
...
function SaveRecord()
{
  if(mandatory_Check("frmMaintMiscellaneousParam"))
  {
      ...
      frmMaintMiscellaneousParam.action = "../../../oTimeSaveAction.do";
      frmMaintMiscellaneousParam.submit();
  }
  else
  {
...
function doBasePrevDetail()
{
    ...
    frmMaintMiscellaneousParam.action = "../../../oTimeNextDetailAction.do";
    frmMaintMiscellaneousParam.submit();
}
...
function JumpDetail()
{
 ...
 function doGetTab(arg)
 {
    ...
    document.forms[0].action="../../../OverTabAction.do";
    document.forms[0].submit();
 }
</script>
