...
function SaveRecord()
{
    ...
    if (frmDPSInfoForm.txtHandi.value == 'Y')
    {
        if (frmDPSInfoForm.txtHandiEffDate.value == '')
        {
            alert("Handicapped Effective Date is Mandatory if Handicapped is Yes");
            frmDPSInfoForm.txtHandiEffDate.focus(); 
            return false;
        }
        if (frmDPSInfoForm.txtHandiType.value == '')
        {
 ...
 // commented by manish jindal reference issue 43490
   /*  if(cmpDOBSysDate(frmDPSInfoForm.txtDOB.value)!=true)
      return false;    */ 
...
document.getElementById("txtUanNum").disabled = false;
        ...
        frmDPSInfoForm.action = "../../../DPSHrAdminSaveAction.do";        
    ...
    if(mode == 'N' || mode == 'U')
    {
       ...
       /*  if(cmpDOBSysDate(frmDPSInfoForm.txtDOB.value)!=true)
        ...
        if(mandatory_Check("frmDPSInfoForm"))
        {
          ...
          document.forms[0].action="../../../DPSInfoHrAdminTabAction.do";
...
{
    document.all.buttonFlag.value='';
    frmDPSInfoForm.action="../../../DPSHrAdminGetHeaderAction.do"
    frmDPSInfoForm.submit();
}
...
{ 
    ...
    frmDPSInfoForm.action="../../../DPSHrAdminGetNextHeader.do";
    frmDPSInfoForm.submit();
}
...
function doInsertMode()
{
    ...
    frmDPSInfoForm.action="../../../DPSPayAdminNewMode.do"
    frmDPSInfoForm.submit();
}
...
function doQueryMode()
{
    document.all.buttonFlag.value='';
    document.all.forwardedPage.value='';
    frmDPSInfoForm.action="../../../DPSPayAdminQueryMode.do"
    frmDPSInfoForm.submit();
}
...
{
    document.all.buttonFlag.value=''; 
    frmDPSInfoForm.action="../../../DPSHrAdminRefresh.do"
    frmDPSInfoForm.submit();
}
