...
function SaveRecord()
{
 retirDate=getyrmm(frmDeptLabourInfoForm.txtRetireDate.value);
  currDate=document.all.payYYMM.value;
    ...
    if (frmDeptLabourInfoForm.txtHandi.value == 'Y')
    {
        if (frmDeptLabourInfoForm.txtHandiEffDate.value == '')
        {
            alert("Handicapped Effective Date is Mandatory if Handicapped is Yes");
            frmDeptLabourInfoForm.txtHandiEffDate.focus(); 
            return false;
        }
        if (frmDeptLabourInfoForm.txtHandiType.value == '')
        {
    ...
    {     
		...
		document.all.hdnCCAFlag.value='';         //added by devendra on 28 sept 2010
        //document.all.hdnStationCompFlag.value=document.all.txtPayType.value=='IDA'? 'Y' : 'N';  commented by devendra on 28 sept 2010  
		document.all.hdnStationCompFlag.value='';       //added by devendra on 28 sept 2010        
        ...
        frmDeptLabourInfoForm.action = "../../../DeptLbrHrAdminSaveAction.do";                
    ...
    if(mode == 'N' || mode == 'U')
    {
     ...
     /*  if(!(currDate==retirDate))
        ...
        if(mandatory_Check("frmDeptLabourInfoForm"))
        {
          ...
          document.forms[0].action="../../../DeptLbrHrAdminTabAction.do";
...
{
    document.all.buttonFlag.value='';
    frmDeptLabourInfoForm.action="../../../DeptLbrHrAdminGetHeaderAction.do"
    frmDeptLabourInfoForm.submit();
}
...
function PrevHeader()
{
    document.all.buttonFlag.value='';
    frmDeptLabourInfoForm.userPositionRequested.value = 1*frmDeptLabourInfoForm.positionRequested.value - 1;
    frmDeptLabourInfoForm.action = "../../../DeptLbrHrAdminGetPrevHeader.do";
    frmDeptLabourInfoForm.submit();
}
...
{
    document.all.buttonFlag.value=''; 
    frmDeptLabourInfoForm.action="../../../DeptLbrHrAdminRefresh.do"
    frmDeptLabourInfoForm.submit();
}
