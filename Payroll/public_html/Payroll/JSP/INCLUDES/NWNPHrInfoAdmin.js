...
document.getElementById("txtUanNum").disabled = false;
        ...
        frmNWNPInfoForm.action = "../../../NWNPHrAdminSaveAction.do";        
    ...
    if(mode == 'N' || mode == 'U')
    {
       ...
       /*  if(cmpDOBSysDate(frmNWNPInfoForm.txtDOB.value)!=true)
        ...
        if(mandatory_Check("frmNWNPInfoForm"))
        {
          ...
          document.forms[0].action="../../../NWNPInfoHrAdminTabAction.do";
...
{
    document.all.buttonFlag.value='';
    frmNWNPInfoForm.action="../../../NWNPHrAdminGetHeaderAction.do"
    frmNWNPInfoForm.submit();
}
...
{ 
    ...
    frmNWNPInfoForm.action="../../../NWNPHrAdminGetNextHeader.do";
    frmNWNPInfoForm.submit();
}
...
{
    document.all.buttonFlag.value=''; 
    frmNWNPInfoForm.action="../../../NWNPHrAdminRefresh.do"
    frmNWNPInfoForm.submit();
}
