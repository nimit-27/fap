...
<TABLE border=0>
  ...
  <TR>
    <TD ><button  alt="GetDetail (Alt+T)"  onclick="GetDetail()" name="butGetDetail" class="bottomBarText">&nbsp;Get De<u>t</u>ail&nbsp;</button> 
	<button Alt="Convert Leave"  onclick="doBaseConvert()" disabled='disabled'name="butConvert" class="bottomBarText" >Convert Leave</button>
	<button Alt="Record History"  onclick="doBaseShowHistory()" name="butHistory" class="bottomBarText" >Record History</button></TD>
    <td width=39%> </td>	
