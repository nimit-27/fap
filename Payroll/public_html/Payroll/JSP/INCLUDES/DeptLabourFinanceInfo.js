...
//alert("First value"+frmDeptLabourInfoForm.txtEpsFlag.value); 
var flag=0;
 mode = document.all.screenMode.value;      
    ...
    //alert("second value"+frmDeptLabourInfoForm.txtEpsFlag.value); 
    if(mode=='Q')
    {         
    ...
    //alert("Third value"+frmDeptLabourInfoForm.txtEpsFlag.value); 
    //checkPFType();      
    //checkDepuType();
    //checkPayMode();  
    //checkEpsFlag(); commented by swapnendu Dt 08 Apr 2013
//	checkEpsFlagOnLoad(); commented by Ravindra Dt 06 May 2019
    hedMenuHandling(mode);    
//alert("Fourth value"+frmDeptLabourInfoForm.txtEpsFlag.value); 
var ageStatus=0;
var getDob;
var getDoj;
getDob=document.all.txtDOB.value;
//alert("DOJ+"+document.all.txtDojFCI.value);
//getDoj=document.all.txtDojFCI.value;
//flag=epsDOJ(getDoj);
//alert(flag);
...
if(epsFlag=='N')    //added by Ravindra Dt 03 May 2019.
		document.getElementById("txtEpsFlag").disabled = "true";
 
 //alert("last value"+frmDeptLabourInfoForm.txtEpsFlag.value);   
document.getElementById("txtEpsFlag").value = frmDeptLabourInfoForm.txtEpsFlag.value;
//alert("ok");
handlePohwOnLoad();
}
...
{    
    ...
    frmDeptLabourInfoForm.action="../../../DeptLbrGetHeaderAction.do"
...
{ 
    ...
    frmDeptLabourInfoForm.action="../../../DeptLbrGetNextHeader.do";
    frmDeptLabourInfoForm.submit();
}
...
function PrevHeader()
{
    document.all.buttonFlag.value='';
    frmDeptLabourInfoForm.userPositionRequested.value = 1*frmDeptLabourInfoForm.positionRequested.value - 1;
    frmDeptLabourInfoForm.action = "../../../DeptLbrGetPrevHeader.do";
    frmDeptLabourInfoForm.submit();
}
...
{   
    document.all.buttonFlag.value=''; 
    frmDeptLabourInfoForm.action="../../../DeptLbrFinRefresh.do"
    frmDeptLabourInfoForm.submit();
}

function SaveRecord()
{
    //alert('inside SaveRecord function in deptlabourfnanceinfo.js....')
    document.all.buttonFlag.value='';
    ...
    {     
        ...
        if(frmDeptLabourInfoForm.txtEpsFlag.value=="Y")
        {
          if(frmDeptLabourInfoForm.txtEpsEntDt.value== "")
          {
        ...
        frmDeptLabourInfoForm.txtCasteCateg.disabled=false;
        frmDeptLabourInfoForm.txtHandiType.disabled=false;
        frmDeptLabourInfoForm.txtReligion.disabled=false;
         frmDeptLabourInfoForm.txtExsrvcman.disabled=false;
        ...
        frmDeptLabourInfoForm.action = "../../../DeptLbrFinSaveAction.do";              
        frmDeptLabourInfoForm.submit();
    }
...
{
    //alert('inside function SavePayrollTabData.. in deptlabourfinanceinfo.js')
    document.all.buttonFlag.value='';
  ...
  if(mode == 'N' || mode == 'U')
    {
        ...
        //if(mandatory_Check("frmDeptLabourInfoForm"))  commented by devendra on 20 sept 2010
        {
			...
			document.getElementById("txtEpsFlag").disabled= "";  // Added by dushyant on 18-May-2013
			document.all.forwardedPage.value=arg;
            document.forms[0].action="../../../DeptLbrPayTabAction.do";
    ...
    for(i=0; i < flagArr.length; i++)
    {
        ...
        {          
           if (flagArr[i] == payCodeArr[j]) 
           {
			  ...
			  //alert('setting value for '+ document.getElementById(flagHdnArr[i]).value+'  as Y');
...
//added by Ravindra Dt 03 May 2019 start .
...
flag=epsDOJ(getDoj);                   
		...
		if (flag==1)
		{
			document.getElementById("txtEpsFlag").value= 'N';
                ...
                //added by Ravindra Dt 03 May 2019 End.
...
function epsDOJ(cdate)       //added by Ravindra Dt 03 May 2019.
{
var flag=0;
 if (trim(cdate) == "")
    {
    ...
    if((firstIndex != -1) && (lastIndex != -1) && (firstIndex != lastIndex))
    {
        ...
        var monthindex=findInArray(dojmonth);
        if(dojyear>=2014){
        if(monthindex>8){
        if(dojday>13){
        return 1;
