...
{    
    ...
    frmDPSInfoForm.action="../../../DPSPayFirstGetHeaderAction.do"
...
{ 
    ...
    frmDPSInfoForm.action="../../../DPSPayGetNextHeader.do";
    frmDPSInfoForm.submit();
}
...
function PrevHeader()
{
    document.all.buttonFlag.value='';
    frmDPSInfoForm.userPositionRequested.value = 1*frmDPSInfoForm.positionRequested.value - 1;
    frmDPSInfoForm.action = "../../../DPSPayGetPrevHeader.do";
    frmDPSInfoForm.submit();
}
...
{   
    document.all.buttonFlag.value=''; 
    frmDPSInfoForm.action="../../../DPSPayRefresh.do"
    frmDPSInfoForm.submit();
}
...
function SaveRecord()
{
    ...
    { 
      //  frmDPSInfoForm.txtEmpNo.value=frmDPSInfoForm.headerPrimaryKey.value;
        frmDPSInfoForm.txtPFType.disabled="";
        frmDPSInfoForm.parentZone.disabled="";
        if(frmDPSInfoForm.txtEpsFlag.value=="Y")
        {
          if(frmDPSInfoForm.txtEpsEntDt.value== "")
          {
        ...
        frmDPSInfoForm.txtCasteCateg.disabled=false;
        frmDPSInfoForm.txtHandiType.disabled=false;
        frmDPSInfoForm.txtReligion.disabled=false;
         frmDPSInfoForm.txtExsrvcman.disabled=false;
		document.getElementById("txtPayStatus").disabled="";   // Added by dushyant on 17-May-2013
		document.all.butSave.src="../INCLUDES/IMAGES/save_dis.jpg";
        frmDPSInfoForm.action = "../../../DPSPaySaveAction.do";              
        frmDPSInfoForm.submit();
    }
...
function SavePayrollTabData()
{
    ...
    {     
        ...
        frmDPSInfoForm.detailDataChanged.value = "false";  
        if(frmDPSInfoForm.screenMode.value == "N")
            frmDPSInfoForm.headerDataChanged.value = "false";    
        frmDPSInfoForm.headerFields.value = "true";        
        return true;
    }
...
{  
    ...
    //{
        ...
        document.forms[0].action="../../../DPSInfoPayTabAction.do";
...
function checkDojFci(cdate)
{
    ...
    if (dateDiff(udate, cdate) < 0 || dateDiff(sysDate, cdate) >0)
    {
        ...
        frmDPSInfoForm.txtDojFCI.select();
        frmDPSInfoForm.txtDojFCI.focus();
        frmDPSInfoForm.txtDojFCI.value="";
        return false;
    }
...
function checkEpsFlagOnLoad()  //added by swapnendu Dt 06 Dec 2012
{
    ...
    if (trim(cdate) != "")
    {
		...
		//alert('uEpsyear' + uEpsyear);        
		//alert('epsDate' + epsDate);
