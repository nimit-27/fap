...
{    
    ...
    frmDPSInfoForm.action="../../../DPSPayAdminGetHeaderAction.do"
...
{ 
    ...
    frmDPSInfoForm.action="../../../DPSPayAdminGetNextHeader.do";
    frmDPSInfoForm.submit();
}
...
function PrevHeader()
{
    document.all.buttonFlag.value='';
    frmDPSInfoForm.userPositionRequested.value = 1*frmDPSInfoForm.positionRequested.value - 1;
    frmDPSInfoForm.action = "../../../DPSPayAdminGetPrevHeader.do";
    frmDPSInfoForm.submit();
}
...
{   
    document.all.buttonFlag.value=''; 
    frmDPSInfoForm.action="../../../DPSPayAdminRefresh.do"
    frmDPSInfoForm.submit();
}
...
function SaveRecord()
{
    ...
    { 
      //  frmDPSInfoForm.txtEmpNo.value=frmDPSInfoForm.headerPrimaryKey.value;
        ...
        frmDPSInfoForm.action = "../../../DPSPayAdminSaveAction.do";              
        frmDPSInfoForm.submit();
    }
...
{  
    ...
    //{
        ...
        document.forms[0].action="../../../DPSInfoPayAdminTabAction.do";
