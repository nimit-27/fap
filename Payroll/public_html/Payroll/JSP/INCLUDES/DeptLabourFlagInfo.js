...
function getHeaderRecord()
{
    ...
    frmDeptLabourInfoForm.action="../../../DeptLbrFlagGetHeaderAction.do"
...
{ 
    ...
    frmDeptLabourInfoForm.action="../../../DeptLbrFlagGetNextHeader.do";
    frmDeptLabourInfoForm.submit();
}
...
function PrevHeader()
{
    document.all.buttonFlag.value='';
    frmDeptLabourInfoForm.userPositionRequested.value = 1*frmDeptLabourInfoForm.positionRequested.value - 1;
    frmDeptLabourInfoForm.action = "../../../DeptLbrFlagGetPrevHeader.do";
    frmDeptLabourInfoForm.submit();
}
...
{
    document.all.buttonFlag.value=''; 
    frmDeptLabourInfoForm.action="../../../DeptLbrFlagRefresh.do"
    frmDeptLabourInfoForm.submit();
}
...
function SaveRecord()
{
    //alert('inside SaveRecord in deptlabourflaginfo.js.....')
    document.all.buttonFlag.value='';
    saveCheckBox();
      ...
      if(checkCurBasicLimit())
      {
        ...
        frmDeptLabourInfoForm.txtReligion.disabled=false;
         frmDeptLabourInfoForm.txtExsrvcman.disabled=false;
            ...
            frmDeptLabourInfoForm.action = "../../../DeptLbrFlagSaveAction.do";            
            frmDeptLabourInfoForm.submit();
        }
      }
    }
...
{ 
   //alert('inside saveCheckBox() in deptlabourflaginfo.js....')
	...
	//alert('document.all.hdnCCAFlag.value::'+document.all.hdnCCAFlag.value+',,, document.all.hdnSplCmpAllowFlag.value::'+    document.all.hdnSplCmpAllowFlag.value);
}
...
function doGetTab(arg)
{
    ...
    document.forms[0].action="../../../DeptLbrFlagTabAction.do";
...
function doGetTabs(arg)
{
    ...
    if(mode == 'N' || mode == 'U')
    {
        ...
        if(flagMandatory_Check())
        {
            //if(mandatory_Check("frmDeptLabourInfoForm")) commented by devendra on 20th sept 2010
            {
                document.all.forwardedPage.value=arg;
                document.forms[0].action="../../../DeptLbrFlagTabAction.do";
                document.forms[0].submit(); 
