...
<TABLE border=0>
  ...
  <TR>
    <TD ><button  alt="GetDetail (Alt+T)"  onclick="GetDetail()" name="butGetDetail" class="bottomBarText">&nbsp;Get De<u>t</u>ail&nbsp;</button> <button Alt="Cancel Invoice"  onclick="cancelInvoice()" name="butCancelInvoice"  class="bottomBarText">&nbsp;&nbsp;Cancel <u>I</u>nvoice&nbsp;&nbsp;</button></TD>
    <td width=50%> </td>	
