...
<TABLE border=0>
  ...
  <TR>
    <TD ><button  alt="GetDetail (Alt+T)"  onclick="GetDetail()" name="butGetDetail" class="bottomBarText">&nbsp;Get De<u>t</u>ail&nbsp;</button> <button Alt="AddRow (Alt+R)"  onclick="doBaseAddRow()" name="butInsert"  class="bottomBarText">&nbsp;&nbsp;Add <u>R</u>ow&nbsp;&nbsp;</button><button Alt="DeleteRow (Alt+D)"  onclick="doBaseDelRow()" name="butDelete" class="bottomBarText" ><u>D</u>elete Row</button>
    <button Alt="Compute income Tax"  onclick="doBaseComputeIT()" name="butIncmTax" class="bottomBarText" >&nbsp;<u>C</u>ompute Income Tax</button>
    <button Alt="Send Invoice"  onclick="doBaseSendInvoice()" name="butSendInv" class="bottomBarText" >&nbsp;<u>S</u>end Invoice</button>
	<button Alt="Record History"  onclick="doBaseShowHistory()" name="butHistory" class="bottomBarText" >&nbsp;<u>R</u>ecord History</button></TD>
    <td width=50%> </td>	
