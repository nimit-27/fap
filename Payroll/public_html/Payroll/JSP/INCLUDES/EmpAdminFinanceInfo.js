function EmpFinLoad()
{
    ...
    //alert('in EmpFinLoad function , mode ::'+mode);
	//alert('in EmpFinLoad function , payRevFlag ::'+ document.all.payRevFlag.value+',  mode ::'+mode);
    if(mode == '')
    {
        doQueryMode();
    }
  ...
  ///////////////ADDED BY MILAN-----
	...
	var payRevFlag=frmEmpFinInfoForm.payRevFlag.value;
			if(payRevFlag=='5')
			{		
				if(mode == 'U')
				{	
...
function checkEmpType()
{
    ...
    if(document.all.screenMode.value =='N' || document.all.screenMode.value =='U')
    {
...
function onLoadcheckEmpType()
{
  ...
  // alert('inside onLoadcheckEmpType function............frmEmpFinInfoForm.txtEmpTypeId.value:::'+frmEmpFinInfoForm.txtEmpTypeId.value+' and frmEmpFinInfoForm.txtCateg.value :::'+frmEmpFinInfoForm.txtCateg.value +' and document.all.screenMode.value :::'+document.all.screenMode.value);
   ...
   if(frmEmpFinInfoForm.txtEmpTypeId.value=='EMPTYPE$REG')
   {
    document.all.txtEmpStatus.disabled="true";    
    if(frmEmpFinInfoForm.txtCateg.value == "EMPCTGRY$I")
    {
...
{
	 alert("inside onChangePModeType")
...
{    
    ...
    frmEmpFinInfoForm.action="../../../EmpAdminFinFirstGetHeaderAction.do"
...
{ 
    ...
    frmEmpFinInfoForm.action="../../../EmpAdminFinGetNextHeader.do";
    frmEmpFinInfoForm.submit();
}
...
function PrevHeader()
{
    ...
    document.all.forwardedPage.value='';
    frmEmpFinInfoForm.userPositionRequested.value = 1*frmEmpFinInfoForm.positionRequested.value - 1;
    frmEmpFinInfoForm.action = "../../../EmpAdminFinGetPrevHeader.do";
    frmEmpFinInfoForm.submit();
}
...
function doInsertMode()
{
    ...
    document.all.buttonFlag.value='';
    document.all.forwardedPage.value='';
    frmEmpFinInfoForm.action="../../../EmpAdminFinNewMode.do"
    frmEmpFinInfoForm.submit();
}
...
function doQueryMode()
{
    document.all.buttonFlag.value='';
    document.all.forwardedPage.value='';
    frmEmpFinInfoForm.action="../../../EmpAdminFinQueryMode.do"
    frmEmpFinInfoForm.submit();
}
function doRefresh()
{   
    ...
    if(document.all.screenMode.value=='N')
      document.all.forwardedPage.value='';
    frmEmpFinInfoForm.action="../../../EmpAdminFinRefresh.do"
    frmEmpFinInfoForm.submit();
}
...
function SaveRecord()
{
    ...
    {     
        ...
        document.all.txtEmpStatus.disabled='';
        document.getElementById("txtMHSTyp").disabled="";
        document.getElementById("txtHandiEffDate").disabled = false;
        ...
        if (frmEmpFinInfoForm.txtHandi.value == 'Y')
    {
        ...
        if (frmEmpFinInfoForm.txtHandiType.value == '')
        {
        ...
        frmEmpFinInfoForm.action = "../../../EmpAdminFinSaveAction.do";              
        frmEmpFinInfoForm.submit();
    }
...
{   
    payRevFlag=document.all.payRevFlag.value;
   //alert('inside saveCheckBox() function, payRevFlag :::'+payRevFlag);
    ...
    // added by devendra on 24 sept 2010 start
    ...
    {      
	 ...
	 // added by devendra on 24 sept 2010 end
}
...
function cmnFlagTxtDisab(argFlag,argTxt)
{
    ...
    else 
    {
        ...
        for(i=0;i<arrArgTxt.length;i++)
        {
		  ...
		  //alert('unchecking checkbox , clearing value of field ::'+document.getElementById(arrArgTxt[i]).value);
...
{  
   //alert('nailed doGetTab()')
	mode = document.all.screenMode.value;      
    if(mode == 'N' || mode == 'U')
    {
       // if(mandatory_Check("frmEmpFinInfoForm"))
      //  {
            //document.all.hdnCCAFlag.value='Y'; commented by devendra on 17th aug 2010
            //document.all.selectCCAFlag.checked="true"; commented by devendra on 17th aug 2010
      ...
      //  }
	 //alert('document.all.hdnCCAFlag.value::'+document.all.hdnCCAFlag.value+'  and document.all.selectCCAFlag.checked::: '+document.all.selectCCAFlag.checked)
    }
    else
    {
        document.all.forwardedPage.value=arg;
...
function checkHandicap()
{
    if (document.all.txtHandi.value=="Y")
    {
       ...
       document.getElementById("txtHandiType").style.className="required";
    }  
    else 
    {
...
//                          ------added by sonali
function checkNpsFlag()
{
  var mode = document.all.screenMode.value;  
  if(document.all.txtNpsFlag.value=='Y')
  {
	if (mode=='U')  //added by sonali
	{
  ...
  else
  {
	...
	document.getElementById("txtPranNo").value = "";
...
function checkNpsFlagOnLoad()  //added by sonali
{
	var mode = document.all.screenMode.value;  
	if(document.all.txtNpsFlag.value=='Y')
	{
...
//                     
//                }               
//		else if (document.all.txtNpsFlag.value=='Y')
//		{
//                    
//			if (document.getElementById("txtPranNo").value=='')
//			{
...
//				
//				document.getElementById("txtPranNo").readOnly = "";
//                                document.getElementById("txtPranNo").locked="";
//				document.getElementById("txtPranNo").onclick="";
//                                
//            }
//		} 
