...
<TABLE border=0>
  ...
  <TR>
    <TD ><button  alt="GetDetail (Alt+T)"  onclick="GetDetail()" name="butGetDetail" class="bottomBarText">&nbsp;Get De<u>t</u>ail&nbsp;</button></TD>
     <!--<button Alt="AddRow (Alt+R)"  onclick="doBaseAddRow()" name="butInsert"  class="bottomBarText">&nbsp;&nbsp;Get De<u>t</u>ail(InsertMode)&nbsp;&nbsp;</button><button Alt="DeleteRow (Alt+D)"  onclick="doBaseDelRow()" name="butDelete" class="bottomBarText" ><u>D</u>elete Row</button>-->
    <td width=50%> </td>	
