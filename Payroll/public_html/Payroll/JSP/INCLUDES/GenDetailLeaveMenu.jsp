...
<TABLE border=0>
  ...
  <TR>
    <TD ><button  alt="GetDetail (Alt+T)"  onclick="GetDetail()" name="butGetDetail" class="bottomBarText">&nbsp;Get De<u>t</u>ail&nbsp;</button> <button Alt="AddRow (Alt+R)"  onclick="doBaseAddRow()" name="butInsert"  class="bottomBarText">&nbsp;&nbsp;Add <u>R</u>ow&nbsp;&nbsp;</button><button Alt="DeleteRow (Alt+D)"  onclick="doBaseDelRow()" name="butDelete" class="bottomBarText" >Delete Row</button><button Alt="DeleteRow (Alt+D)"  onclick="doBaseCancel()" name="butCancel" class="bottomBarText" >Cancel Leave</button></TD>
	<TD><button Alt="Record History"  onclick="doBaseShowHistory()" name="butHistory" class="bottomBarText" >Record History</button></TD>
    <td width=39%> </td>	
