...
function SaveRecord()
{
    ...
    if (frmDPSInfoForm.txtHandi.value == 'Y')
    {
        ...
        if (frmDPSInfoForm.txtHandiType.value == '')
        {
            ...
            frmDPSInfoForm.txtHandiType.focus(); 
            return false;
        }
    }
  // commented by manish jindal reference issue 43490
    ...
    {         
        ...
        frmDPSInfoForm.action = "../../../DPSHrSaveAction.do";        
...
function doGetTab(arg)
{
    ...
    if(mode == 'N' || mode == 'U')
    {
        ...
        if(mandatory_Check("frmDPSInfoForm"))
        {
          ...
          document.forms[0].action="../../../DPSInfoHrTabAction.do";
...
{
    document.all.buttonFlag.value='';
    frmDPSInfoForm.action="../../../DPSHrFirstGetHeaderAction.do"
    frmDPSInfoForm.submit();
}
...
{ 
    ...
    frmDPSInfoForm.action="../../../DPSHrGetNextHeader.do";
    frmDPSInfoForm.submit();
}
...
{
    document.all.buttonFlag.value=''; 
    frmDPSInfoForm.action="../../../DPSHrRefresh.do"
    frmDPSInfoForm.submit();
}
