...
<html:form  name="CreateSearchPayScreen"  action="/OnlineSearchPayScreenMap"  type="FCIPAY.Payroll.common.webtier.form.NewLovForm" method="post">
<!-- Hidden Fields -->     
...
<table width="100%">
  </table><center></center><td align="left" ><strong><font color="blue" ><bean:write name="CreateSearchPayScreen" property="txtHidTotRows" /> Matching Rows Found</font></strong></td></center>
</table>
</logic:greaterThan>
...
{   
	...
	if(CreateSearchPayScreen.searchField1.value=="" && CreateSearchPayScreen.searchField2.value=="" &&
		CreateSearchPayScreen.searchField3.value=="" && CreateSearchPayScreen.searchField4.value=="" &&
		CreateSearchPayScreen.searchField5.value=="" && CreateSearchPayScreen.searchField6.value=="")
	{
