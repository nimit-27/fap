...
<html:form  name="CommonSearchPayScreen"  action="/CommonSearchPayScreenMap" type="FCIPAY.Payroll.common.webtier.form.BaseLOVForm" method="post">
<!-- Hidden Fields -->     
...
<input type="hidden" name="openerFieldName21" >
...
<html:hidden property="hdnLOVFlag" name="CommonSearchPayScreen" />


<bean:define id="SearchField1" name="CommonSearchPayScreen" property="searchFieldName1"/>
<bean:define id="SearchField2" name="CommonSearchPayScreen" property="searchFieldName2"/>
<bean:define id="SearchField3" name="CommonSearchPayScreen" property="searchFieldName3"/>
<bean:define id="SearchField4" name="CommonSearchPayScreen" property="searchFieldName4"/><!--added by devendra on 16th aug 2010-->
<bean:define id="lovFlag" name="CommonSearchPayScreen" property="hdnLOVFlag"/>


<table cellpadding="0" cellspacing="0" class="blueBar"  >
  <tr >
     <logic:notEqual name="CommonSearchPayScreen" property="searchFieldName1" value="NULL" >
      <td width="15%" align="right"><bean:message key="<%=String.valueOf(SearchField1)%>" /></td>
      <td width="30%" align="left"><html:text property="searchField1" size="15"  onkeypress="
                             if((event.keyCode < 48 || event.keyCode > 57))
                              {
                                return false;
                              }; lfnChanged(this.value);" /></td>
     </logic:notEqual>
     <logic:notEqual name="CommonSearchPayScreen" property="searchFieldName2" value="NULL" >
     ...
     <logic:notEqual name="CommonSearchPayScreen" property="searchFieldName3" value="NULL" >
        <td width="15%" align="right"><bean:message key="<%=String.valueOf(SearchField3) %>" /></td>
        <td width="30%" align="left"><html:text property="searchField3" size="15" /></td>
     </logic:notEqual>
	 <!-- added by devendra on 16th aug 2010 start-->
		<logic:notEqual name="CommonSearchPayScreen" property="searchFieldName4" value="NULL" >
        <td width="15%" align="right"><bean:message key="<%=String.valueOf(SearchField4) %>" /></td>
        <td width="30%" align="left"><html:text property="searchField4" size="15" /></td>
     </logic:notEqual>
...
<%if(lovFlag.equals("1")){%>
<logic:greaterThan name="CommonSearchPayScreen" property="txtHidTotRows" value="0" >
<table width="100%">
  <center><td align="left" ><strong><font color="blue" ><bean:write name="CommonSearchPayScreen" property="txtHidTotRows" /> Matching Rows Found</font></strong></td></center>
</table>
</logic:greaterThan>
<logic:lessEqual name="CommonSearchPayScreen" property="txtHidTotRows" value="0" >
<table width="100%">
...
<table id="tableId" cellpadding="0" cellspacing="0">
  <logic:greaterThan name="CommonSearchPayScreen" property="txtHidTotRows" value="0" >
  <bean:define id="oVisib" name="CommonSearchPayScreen" property="visibilityList" type="java.util.ArrayList" />
  <tr>    
    <logic:equal name="CommonSearchPayScreen" property="multipleFlag" value="true" >
    <td width="5%" class="tableHeader" ><html:checkbox property="selectAll"  onclick="toggleCheckBox('selectAll');checkRecord();"  /></td>
    </logic:equal>
    <logic:notEqual name="CommonSearchPayScreen" property="multipleFlag" value="true" >
    <td width="5%" class="tableHeader" >Select</td>
    </logic:notEqual>
   
   <logic:iterate name="CommonSearchPayScreen" property="headerList" id="Index" indexId="hIdx">
...
<logic:iterate name="CommonSearchPayScreen" property="detailList" id="oDtlList" type="FCIPAY.Payroll.common.bean.LOVBean" indexId="iDtl">
<tr >
    ...
    <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="1">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="2">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="3">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="4">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="5">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="6">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="7">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="8">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="9">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="10">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="11">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="12">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="13">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="14">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="15">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="16">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="17">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="18">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="19">
  ...
  <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="20">
   ...
   <logic:greaterEqual name="CommonSearchPayScreen" property="txtHidTotCols" value="21">
    <%if(oVisib.get(20).equals(EnrgiseConstants.VISIBLE)){%>
	
      <td align="center">
       <html:text property="detailField21" name="oDtlList" style="width:100%" readonly="true" />
      </td>
    <%}else{%>
      <html:hidden property="detailField21" name="oDtlList" />   
    <%}%>    
  </logic:greaterEqual>
...
<bean:define id="colCount" name="CommonSearchPayScreen" property="txtHidTotCols" />
...
function setSearchFields(fieldString)
{
  ...
  if(arySearch[0]){
    CommonSearchPayScreen.searchFieldName1.value = arySearch[0];
  }
  else{
    CommonSearchPayScreen.searchFieldName1.value = "NULL";
  }
  
  if(arySearch[1]){
    CommonSearchPayScreen.searchFieldName2.value = arySearch[1];
  }
  else{
    CommonSearchPayScreen.searchFieldName2.value = "NULL";
  }
  
  if(arySearch[2]){
    CommonSearchPayScreen.searchFieldName3.value = arySearch[2];
  }
  else{
    CommonSearchPayScreen.searchFieldName3.value = "NULL";
  }  
  // added by devendra on 16th aug 2010 start
  if(arySearch[3]){
    CommonSearchPayScreen.searchFieldName4.value = arySearch[3];
  }
  else{
    CommonSearchPayScreen.searchFieldName4.value = "NULL";
  }
  // added by devendra on 16th aug 2010 end
}
...
function checkOnLoad(){
   ...
   //--------------------------------------------------
  // alert(opener.document.getElementById("txtDisplayFields"))
   ...
   if(opener.document.all.item("multipleFlag")){
    CommonSearchPayScreen.multipleFlag.value=opener.document.all.item("multipleFlag").value;
   ...
   if(opener.document.all.item("queryParam")){
     CommonSearchPayScreen.queryParam.value=opener.document.all.item("queryParam").value;
   }
   ...
   if(opener.document.all.item("lovKey"))
     CommonSearchPayScreen.lovKey.value=opener.document.all.item("lovKey").value;
   else
     alert('lovKey not defined as hidden field in jsp page'); 
    
    //ColCount is used to check for first submit.
    //-------------------------------------------
    if(CommonSearchPayScreen.colCount.value=="0"){
      CommonSearchPayScreen.txtHidAction.value="FirstTime";
      CommonSearchPayScreen.submit();
   }
}

function setSelectedValue(Val)
{
   CommonSearchPayScreen.txtHidSelectedValue.value=Val;
   //alert('Val : '+Val)
}

function Search()
{      
      CommonSearchPayScreen.hdnLOVFlag.value="1";
      CommonSearchPayScreen.txtHidAction.value="SearchRecords";
...
{ 
   ...
   if(CommonSearchPayScreen.txtHidSelectedValue.value!="")
   {                
      //If Multiple flag is true
      //------------------------
      if(CommonSearchPayScreen.multipleFlag.value=="true"){
          var iCols=CommonSearchPayScreen.colCount.value;          
          ...
          if(j=="" ){
            for(i=0;i<iOpenerFieldCount;i++){
              var sOpenerField=document.getElementById("openerFieldName"+(i+1));  
               opener.document.getElementById(sOpenerField.value).value=document.getElementsByName("detailField"+(i+1))[CommonSearchPayScreen.txtHidSelectedValue.value].value;              
              //alert(sOpenerField.value);
            }
          }
          ...
          //-------------------------
            ...
            for(i=0;i<iOpenerFieldCount;i++){
             ...
             oOpenerDtlField.value=document.getElementsByName("detailField"+(i+1))[CommonSearchPayScreen.txtHidSelectedValue.value].value; 
   ...
   CommonSearchPayScreen.txtHidSelectedValue.value="";   
   if(CommonSearchPayScreen.insertFlag.value=="Y")
   {
       opener.doGetInsertData();
       
   }
    CommonSearchPayScreen.txtHidAction.value="Exit";
    if(inputfield!="")
    {
        if(j=="")
        {
...
{ 
  ...
  for(i = 0; i < oTable.rows.length - 1; i ++)
  {
    ...
    {
      CommonSearchPayScreen.txtHidSelectedValue.value=1;
