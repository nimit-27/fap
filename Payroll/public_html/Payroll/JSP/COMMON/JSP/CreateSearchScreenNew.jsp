...
<html:form  name="CreateSearchPayScreen"  action="/CreateSearchPayScreenMapNew"  type="FCIPAY.Payroll.common.webtier.form.NewLovForm" method="post">
<!-- Hidden Fields -->     
...
<table width="100%">
</table><center></center><td align="left" ><strong><font color="red" >No Matching Rows Found</font></strong></td></center>
</table>
</logic:lessEqual>
<%}%>
