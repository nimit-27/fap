...
<html:form  action="SingleMonthUpdate" name="frmMonthUpdate" type="FCIPAY.Payroll.WEBTIER.Form.PerformMonthEndUpdateForm" scope="session" >
...
<table>
<TR height=30>
  <TD  colSpan=12 class=mainHeader height=10>PERFORM SINGLE MONTH END UPDATE FOR <bean:write name="frmMonthUpdate" property="payYYMM" /></TD>
</TR>
</TABLE>
...
<!-- Bottom Blue Bar -->
        <TR>
          <td align=center bgcolor=#4682b4 width="40%"></td>
               ...
               <td bgcolor=#4682b4 width="20%"><html:button value='Perform Month End'  onclick="MonthEndTransaction()" property="butInsert" styleClass="bottomBarText" /></td>
...
<html:hidden name="frmMonthUpdate" property="screenName" value="SingleMonthUpdateScreen" />
...
{
  frmMonthUpdate.action="../../../EmpWaitingToJoinInSingle.do"
...
function doQueryMode()
{
  ...
  frmMonthUpdate.action="../../../ComputeSingleMonthEndQuery.do"
  frmMonthUpdate.submit();
}
		...
		if(confirm("Have you transferred out the employees ?")) //added by Swapnendu Dt 15 Feb 2011.
		{
			if (no_emp_join > 0)
			{
							...
							"Press Cancel to proceed to month end update.")) //added by Swapnendu Dt 15 Feb 2011.
				{
					...
					frmMonthUpdate.action = "../../../ComputeSingleMonthEnd.do";
					frmMonthUpdate.submit();
				}
			}
			else
