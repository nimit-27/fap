...
public class ReportingOfficerScreenAccessForm extends ActionForm 
{
    ...
    private ArrayList newLocList=new ArrayList();
    ...
    public void setLocList(ArrayList newLocList)
    {
     ...
     public ArrayList getNewLocList()
    {
        return newLocList;
    }

    public void setNewLocList(ArrayList newNewLocList)
    {
        newLocList = newNewLocList;
    }
