...
import FCIPAY.Payroll.WEBTIER.Form.MaintHouseRentRcptForm;
...
// This statement is added to get the details records after insertion & change its its screen mode to U. 
      
      if (sScreenName.equals("WrkSlipScreen") || sScreenName.equals("NormScreen")|| sScreenName.equals("DPSWrkSlipScreen")||sScreenName.equals("GangMasterScreen")||sScreenName.equals("OTAPymntScreen")||sScreenName.equals("DeptOTAPymntScreen")||sScreenName.equals("HouseRentRcptScreen"))
      {   
        oBaseForm.setScreenMode("U"); 
        if(sScreenName.equals("HouseRentRcptScreen"))
        {
          MaintHouseRentRcptForm oMaintHouseRentRcptForm=(MaintHouseRentRcptForm)oBaseForm;
          oMaintHouseRentRcptForm.setScreenModeFlag(false);
          oBaseForm=oMaintHouseRentRcptForm;
        }        
      }
      ...
      if(sScreenName.equals("LeaveScreen") && oBaseForm.getScreenMode().equals("C"))
      {
     ...
     if (oBaseForm.getScreenName().equals("ECSDataFileScreen"))
    {
          ECSDataFileForm oForm = (ECSDataFileForm)oBaseForm;   
          String sMessage = oForm.getHdnMessage();
          ArrayList oArguments = new ArrayList();          
          oArguments.add(new String(sMessage));
