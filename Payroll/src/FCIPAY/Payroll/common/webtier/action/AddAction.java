  ...
  public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
     ...
     /* if(oBaseForm.getScreenMode().equals(EnrgiseConstants.NEW_MODE) || oBaseForm.getHeaderPrimaryKey() == null)
      ...
      try
      {
        ...
        {
//          String [] sStatus  = BeanUtils.getArrayProperty(oBaseForm,"status");
          String [] sStatus  = oBaseForm.getStatus();          
          String [] sStartField = BeanUtils.getArrayProperty(oBaseForm,"startField");
          String [] sEndField = BeanUtils.getArrayProperty(oBaseForm,"endField");
          // Get the last field
          ...
          if (iFlag)
            sNextStart = Long.toString(Long.parseLong(sEndField[iIndex]) + 1); 
          else
          sNextStart = "0";
          
        }
      }
      catch(NoSuchMethodException oNoMet)
      {
      ...
      BeanUtils.setProperty(oBaseDetailBean,"startField",sNextStart);
