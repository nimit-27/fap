...
public class ComputeFscBusinessObject extends BaseBO
{
  public ComputeFscBusinessObject() 
  {
  }
 ...
 public void initializeBOImpl(String sScreenName)
  ...
  public String ComputeFSC(long lUserID,long lSiteID, String sFinYear) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    ArrayList oOutArray; //Output 
      ...
      oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,new String(String.valueOf(sFinYear))));            
      ...
      oOutArray = oBean.callProc(oParameters,"PKG_GENERATE_FSC.Ysp_GenerateFSC(?,?,?,?,?)");      
