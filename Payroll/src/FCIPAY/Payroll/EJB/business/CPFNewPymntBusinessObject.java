...
public class CPFNewPymntBusinessObject extends BaseBO 
{

  public CPFNewPymntBusinessObject()
  {
  }
...
// THIS METHOD CANCELS THE SANCTION ORDER.
  ...
  public String saveNewHeaderImpl(BaseHeaderBean oBaseHeaderBean) throws EnrgiseSystemException,EnrgiseApplicationException
  {
    ...
    ArrayList oOutArray=new ArrayList(); //Output   
      ...
      if(oCPFFinalPaymentBean.getHdnSancType().equals("A")||oCPFFinalPaymentBean.getHdnSancType().equals("P"))
      {
        ...
        oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,new String(oCPFFinalPaymentBean.getTxtUserID())));
        oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.VARCHAR,new String(oCPFFinalPaymentBean.getTxtSiteID()))); 
        oParameters.add(new DBObject(5,DBObject.IN,ParameterTypes.VARCHAR,new String(oCPFFinalPaymentBean.getEmpContri())));  
         oParameters.add(new DBObject(6,DBObject.IN,ParameterTypes.VARCHAR,new String(oCPFFinalPaymentBean.getEmplyrContri()))); 
        oParameters.add(new DBObject(7,DBObject.IN,ParameterTypes.VARCHAR,new String(oCPFFinalPaymentBean.getVpfContri())));      
          oParameters.add(new DBObject(8,DBObject.IN,ParameterTypes.VARCHAR,new String(oCPFFinalPaymentBean.getSancAmount()))); 
        oParameters.add(new DBObject(9,DBObject.IN,ParameterTypes.VARCHAR,new String(oCPFFinalPaymentBean.getSancOrderNo())));
        ...
        oOutArray = oBean.callProc(oParameters,"PKG_CPF_FCI.Proc_supplimentary_adjt(?,?,?,?,?,?,?,?,?,?,?,?)",true,true);        
       }
      else
      {
        oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,new String(oCPFFinalPaymentBean.getTxtEmpNo())));      
      ...
      return oOutObject.getObject().toString(); 
  ...
  public RecordMetaInfo getCPFNewPayHeaderMetaInfo(CPFFinalPaymentQueryVO oCPFFinalPaymentQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR,new String(oCPFFinalPaymentQueryVO.getHdnEmpLbrFlag())));        
    ...
    if (screenName.equals("CPFNewPaymentScreen"))    
      oOutArray = oBean.callProc(oParameters,"PKG_CPF_FCI.proc_getcpfsupplcnt(?,?,?,?,?,?)");
    else
      oOutArray = oBean.callProc(oParameters,"PKG_CPF_FCI.proc_getcpfsupplcnt(?,?,?,?,?,?)");
  ...
  //  oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.BIGINT,new Long(lStartPosition)));
   // oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.BIGINT,new Long(lLastPosition)));
    ...
    if (screenName.equals("CPFNewPaymentScreen"))    
      oOutArray = oBean.callProc(oParameters,"PKG_CPF_FCI.proc_get_supp_dtl(?,?,?,?,?)");
    else
      oOutArray = oBean.callProc(oParameters,"PKG_CPF_FCI.proc_get_supp_dtl(?,?,?,?,?)");
    ...
    while(oIt.hasNext())
    {
        ...
        // added by geetika on 16/12/13 to add new sanction num
     ...
     //   oCPFFinalPaymentBean.setRemarks(oRow.get("remarks").getString());    
        ...
        oCPFFinalPaymentBean.setTxtInvID(oRow.get("invoice_num").getString());
         ...
         //addedy by himanshu on 10-jan-2015
        String Invoice_num = oRow.get("invoice_num").getString();
       //end
       ...
       // oCPFFinalPaymentBean.setTxtDedIT(oRow.get("IT_DEDUCTED").getString());
        ...
        //added by himanshu on 13-jan-2015 
        ArrayList oParam = new ArrayList();
        DBUtilitiesBean oBeanDtl = new DBUtilitiesBean();
        
        oParam.add(new DBObject(1, DBObject.IN, ParameterTypes.VARCHAR,Invoice_num));
        oParam.add(new DBObject(2, DBObject.OUT,ParameterTypes.INTEGER));
        oParam.add(new DBObject(3, DBObject.OUT,ParameterTypes.VARCHAR));
        oParam.add(new DBObject(4, DBObject.OUT,ParameterTypes.INTEGER));
        oOutArray = oBeanDtl.callProc(oParam,"PKG_CPF_FCI.proc_sup_cancel_status(?,?,?,?)",true,true);
        Integer apps_status = (Integer)(((DBObject)(oOutArray.get(0))).getObject());
        String apps_cancel_date = (String)(((DBObject)(oOutArray.get(1))).getObject()); 
        Integer error = (Integer)(((DBObject)(oOutArray.get(2))).getObject());
        
         if(!error.equals(new Integer(0)))
      {
        throw new EnrgiseApplicationException("Pay.Payroll_ERROR",EnrgiseConstants.MESSAGE); 
      }
      
      if(apps_status.equals(new Integer(0)))
      {
          oCPFFinalPaymentBean.setTxtappscancel(apps_cancel_date);
      }
      else
      {   
          String Notcancelled="N";
          oCPFFinalPaymentBean.setTxtappscancel(Notcancelled); 
      }
    //end
  ...
  {  
   ...
   // oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,new String(oLovQueryVO.getProperty("hdnEmpLbrFlag"))));
    ...
    oParameters.add(new DBObject(5,DBObject.OUT,ParameterTypes.CURSOR));
    oParameters.add(new DBObject(6,DBObject.OUT,ParameterTypes.INTEGER));
    oOutArray = oBean.callProc(oParameters,"pkg_cpf_fci.proc_cpf_supp_emplovn(?,?,?,?,?,?)");
    DBObject oOutObject=(DBObject)oOutArray.get(0);
    oList=(ArrayList)(oOutObject.getObject());
 ...
 public String realeaseCPFNewPay(BaseHeaderBean oBaseHeaderBean) throws EnrgiseSystemException, EnrgiseApplicationException
 {
    ...
    ArrayList oOutArray; //Output  
        ...
        oParameters.add(new DBObject(9,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getHeaderPrimaryKey())); 
        ...
        oOutArray = oBean.callProc(oParameters,"PKG_CPF_FCI.Proc_Release_supp_final(?,?,?,?,?,?,?,?,?,?,?)",true,true); 
 ...
 public BaseHeaderBean getIntInst(CPFFinalPaymentQueryVO oCPFFinalPaymentQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
 {
  ...
  public String calcCpfYrInt(BaseHeaderBean oBaseHeaderBean) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getTxtEmpNo()));
    oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.TIMESTAMP,EnrgiseUtil.convertToSqlDate(oCPFFinalPaymentBean.getSancDate())));
    oParameters.add(new DBObject(5,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getTxtUserID()));
    oParameters.add(new DBObject(6,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getTxtSiteID()));
    ...
    oOutArray = oBean.callProc(oParameters,"PKG_CPF_FCI.Update_year_end(?,?,?,?,?,?,?,?)",true,true); 
    DBObject oOutObject = (DBObject)oOutArray.get(1);
    Integer errCode = (Integer)(oOutObject.getObject());
...
//added by himanshu on 14-jan-2015
  public  String cancelCPFNewPay(BaseHeaderBean oBaseHeaderBean) throws EnrgiseSystemException, EnrgiseApplicationException
 {
    ...
    ArrayList oOutArray; //Output  
    oParameters = new ArrayList();
    oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getTxtEmpNo()));
    oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.TIMESTAMP,EnrgiseUtil.convertToSqlDate(oCPFFinalPaymentBean.getSancDate())));
    oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getTxtUserID()));
    oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getTxtSiteID()));
    oParameters.add(new DBObject(5,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getEmpContri()));
    oParameters.add(new DBObject(6,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getEmplyrContri()));
    oParameters.add(new DBObject(7,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getVpfContri()));
    oParameters.add(new DBObject(8,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getSancAmount()));
    oParameters.add(new DBObject(9,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getSancOrderNo()));
    oParameters.add(new DBObject(10,DBObject.IN,ParameterTypes.VARCHAR,oCPFFinalPaymentBean.getHeaderPrimaryKey()));
    oParameters.add(new DBObject(11,DBObject.OUT,ParameterTypes.VARCHAR));
    oParameters.add(new DBObject(12,DBObject.OUT,ParameterTypes.INTEGER));
    oOutArray = oBean.callProc(oParameters,"PKG_CPF_FCI.Proc_supplimentary_adjt_cancel(?,?,?,?,?,?,?,?,?,?,?,?)",true,true);
    DBObject oErrMsg = (DBObject)oOutArray.get(0);
    ...
    {
      Cancel_success ="Y";
      oCPFFinalPaymentBean.setCancelStatus(Cancel_success);
      ArrayList oArguments = new ArrayList();
      oArguments.add((String)oErrMsg.getObject());
