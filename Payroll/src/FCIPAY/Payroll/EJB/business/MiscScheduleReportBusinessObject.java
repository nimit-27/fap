...
public class MiscScheduleReportBusinessObject extends BaseBO
{
  public MiscScheduleReportBusinessObject()
  {
  }
...
// end by dushaynt on 13-10-2010 for gratuity detail
  ...
  {  
    ...
    String sDesgn,sCPF,sName;
    sName=oLovQueryVO.getSearchField1();
    sCPF=oLovQueryVO.getSearchField2();
    sDesgn=oLovQueryVO.getSearchField3();
    ...
    oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.VARCHAR, sDesgn));   
...
public LovVO getPayCodeLOVData(LovQueryVO oLovQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {  
    ...
    count = 0;
      ...
      oParameters.add(new DBObject(4,DBObject.OUT,ParameterTypes.INTEGER));
      oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG_EXT.proc_GetPayCodeLov(?,?,?,?)");*/
 ...
 // added by dushyant for maintain direct payroll Audit on 30-11-2010
  ...
  //  arylstVisibility.add(EnrgiseConstants.VISIBLE);
    ...
    oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG_EXT.proc_GetEmpMainDirectPayLov(?,?,?,?,?,?,?)");
    DBObject oOutObject=(DBObject)oOutArray.get(0);
    oList=(ArrayList)(oOutObject.getObject());
...
// added by dushyant for Medical Register on 30-11-2010
 public LovVO getMedicalRegLOVData(LovQueryVO oLovQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  ...
  // added by dushyant for Medical Register on 01-12-2010
