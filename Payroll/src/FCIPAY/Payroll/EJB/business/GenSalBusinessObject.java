...
public class GenSalBusinessObject extends BaseBO
{
  public GenSalBusinessObject()
  {
  }
  ...
  public String GenSalJV(long lUserID,long lSiteID) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    ArrayList oOutArray; //Output 
      ...
      oOutArray = oBean.callProc(oParameters,"PKG_GEN_SALARY_JV.Ysp_GenSalJV(?,?,?,?)");      
