...
import FCIPAY.Payroll.WEBTIER.Form.MaintEmpPromotionForm;

public class EmpPromotionBusinessObject extends BaseBO 
{

  public EmpPromotionBusinessObject()
  {
  }
  ...
  public void updateHeaderImpl(BaseHeaderBean oBaseHeaderBean) throws EnrgiseSystemException
  {
    ...
    String sPayModeType;
    int count = 0;
    MaintEmpPromotionBean oEmpPromotionBean = (MaintEmpPromotionBean)oBaseHeaderBean;
  ...
  public String saveNewHeaderImpl(BaseHeaderBean oBaseHeaderBean) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    MaintEmpPromotionBean oEmpPromotionBean = (MaintEmpPromotionBean)oBaseHeaderBean;
   // MaintEmpPromotionForm  oEmpPromotionForm =(MaintEmpPromotionForm)oEmpPromotionForm;
    String  RetdScreen=oEmpPromotionBean.getRetdscreenName();
    ArrayList oOutArray; //Output   
    if (RetdScreen==null)
          {
          RetdScreen="retd";         
    ...
    if(oEmpPromotionBean.getTxtPayType().equalsIgnoreCase("IDA")){
    gradepay="0.0";    
    }
    else {
    gradepay=oEmpPromotionBean.getNewGradePay();
    
    }
    // ==================== Added by Avtar Dt 09 Jul 2013 (Promotion Super User) End============================== 

      if (RetdScreen.equals("MaintEmpRetdPromotionScreen")) 
      {
      ...
      //oParameters.add(new DBObject(5,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getNewPromoBasic())));
      ...
      oParameters.add(new DBObject(14,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getNewPayScaleCode())));           
      ...
      oParameters.add(new DBObject(18,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getTxtGradePay())));
      oParameters.add(new DBObject(19,DBObject.IN,ParameterTypes.VARCHAR,new String(gradepay)));       
      oParameters.add(new DBObject(20,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getTxtUserID())));
      oParameters.add(new DBObject(21,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getTxtSiteID()))); 
      oParameters.add(new DBObject(22,DBObject.OUT,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getTxtEmpNo())));
      oParameters.add(new DBObject(23,DBObject.OUT,ParameterTypes.INTEGER));      

      oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG.proc_insertempretdpromdetail(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",true,true);        
      
      DBObject oOutObject = (DBObject)oOutArray.get(0);
      String vEmpNo = (String)oOutObject.getObject();
      return vEmpNo;      
      ...
      oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG.proc_InsertEmpPromDetail(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",true,true);        
      
      //DBObject oOutObject = (DBObject)oOutArray.get(0);
      Integer err_code = (Integer)((DBObject)oOutArray.get(1)).getObject();
      String vEmpNo = (String)((DBObject)oOutArray.get(0)).getObject();
      String err_msg="Promotion type reversal is not alloed for this employee";
      //added by geetika 11/9/2013 (start)
       if(err_code.intValue() == 2)
       {
         oArguments.add(err_msg);
         oArguments.add(new Integer(count));
         throw new EnrgiseApplicationException("Payroll.EmpProm.CheckReversal",oArguments);
       }
       if(err_code.intValue() == 3)
       {
         oArguments.add(err_msg);
         oArguments.add(new Integer(count));
         throw new EnrgiseApplicationException("Payroll.EmpProm.CheckPromoType",oArguments);
       }										  
       //added by geetika 11/9/2013 (end)
       if(err_code.intValue() == 4)
       {
         oArguments.add(err_msg);
         oArguments.add(new Integer(count));
         throw new EnrgiseApplicationException("Payroll.EmpProm.CheckGangEntry",oArguments);
       } 
	  if(err_code.intValue() == 5)
      {
        oArguments.add(err_msg);
        oArguments.add(new Integer(count));
        throw new EnrgiseApplicationException("Payroll.EmpProm.wrongbasic",oArguments);
      }  
	  //added by amresh
      if(err_code.intValue() == 6)
          {
          oArguments.add(err_msg);
          oArguments.add(new Integer(count));
          throw new EnrgiseApplicationException("Payroll.EmpProm.existingpromotion",oArguments);
          }	  
      return vEmpNo;  
      }
  }
  ...
  public RecordMetaInfo getPromotionHeaderMetaInfo(EmpPromotionQueryVO oEmpPromotionQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    if (screenName.equals("MaintEmpPromotionScreen")) 
    {
...
// ==================== Added by Avtar Dt 09 Jul 2013 (Promotion Super User) End============================== 
  else if (screenName.equals("MaintEmpRetdPromotionScreen")) 
  
  {
      ...
      oParameters.add(new DBObject(5,DBObject.OUT,ParameterTypes.TIMESTAMP));
      oParameters.add(new DBObject(6,DBObject.OUT,ParameterTypes.INTEGER));
      oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG.proc_getempretdpromdetailcount(?,?,?,?,?,?)");
  }
  // ==================== Ended by Avtar Dt 09 Jul 2013 (Promotion Super User) End============================== 
  ...
  
  {
      ...
      oParameters.add(new DBObject(6,DBObject.OUT,ParameterTypes.CURSOR));
      oParameters.add(new DBObject(7,DBObject.OUT,ParameterTypes.INTEGER));
      oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG_EXT.proc_getempretdpromdetail(?,?,?,?,?,?,?)");
  }
  // ==================== Ended by Avtar Dt 09 Jul 2013 (Promotion Super User) End============================== 
    ...
    MaintEmpPromotionBean oEmpPromotionBean;
    count = 0;
    QueryRow oRow = null;
    ...
    while(oIt.hasNext())
    {
        ...
        oEmpPromotionBean = new MaintEmpPromotionBean();
        ...
        oEmpPromotionBean.setTxtGradePay(oRow.get("GRADE_PAY").getString()); // added by sonia on 08-04-2011
        oEmpPromotionBean.setTxtPayType(oRow.get("PAY_SCALE_TYPE").getString()); //added by sonia on 08-04-2011
...
private ArrayList getDPSFinComboRecords(String sProc, String sField_id, String sField_desc)  throws EnrgiseSystemException, EnrgiseApplicationException 
{
          DBUtilitiesBean oBean = new DBUtilitiesBean();
          ArrayList oParameters = new ArrayList();
          ArrayList oOutArray;
  ...
  public EmpPromotionComboVO getEmpPromComboDetails()  throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    oPromTypeListDPS = getDPSFinComboRecords("PAYROLL_PKG.proc_GetDPSPromTypelov(?,?)","promType_id","promType_desc");
    oEmpProm.setValueDPSPromTypeArrayList(oPromTypeListDPS);
  ...
  {  
    ...
    arylstHeaderNames.add("Kotwal Flag");
    ...
    while(iter.hasNext())
    {
      ...
      oLOVBean = new LOVBean();
        ...
        oLOVBean.setDetailField19(oRow.get("pay_scale_code").getString());
        oLOVBean.setDetailField20(oRow.get("grade_pay").getString());
        oLOVBean.setDetailField21(oRow.get("kotwal_labour").getString());
  ...
  public void additionalFieldValidationImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName, String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    if(bHeaderDataChanged)
    {
      ...
      if (sScreenName.equals("MaintEmpPromotionScreen") && sScreenMode.equals("N"))
      {
        checkPenaltyImposed(oBaseHeaderBean); 
         checkPromDate(oBaseHeaderBean,sScreenMode);
      }

       if (sScreenName.equals("MaintEmpRetdPromotionScreen") && sScreenMode.equals("N"))
      {
         checkPromDate(oBaseHeaderBean,sScreenMode);     
      }
    }
    ...
    // ==================== End by Avtar Dt 09 Jul 2013 (Promotion Super User) End==============================  -->
...
//    checkFirst(oBaseHeaderBean,oList);
      ...
      {
        if (!(oEmpPromotionBean.getHdnEmpLbrFlag().equals("D"))) // Added by dushyant on 31-Aug-2012
        {
            checkEmpCurBasicLimit(oBaseHeaderBean,oList);
            reportError(oList); 
        }
        // checkEmpCurBasicLimit(oBaseHeaderBean,oList); // Uncommented on 31-Aug-2012 by dushyant
          //checkEmpNo(oBaseHeaderBean,oList); 
          //checkEmpCurBasicLimit(oBaseHeaderBean,oList);
          checkEmpprocatIItoI(oBaseHeaderBean,oList);  // Added by dushyant on 17-MAy-2013
      }  
...
//  checkEmpPFLimit(oBaseHeaderBean,oList);                    
  ...
  private void checkPromDate(BaseHeaderBean oBaseHeaderBean,String sScreenMode) throws EnrgiseSystemException, EnrgiseApplicationException
  {  
    ArrayList oList = new ArrayList();
...
//    checkFirst(oBaseHeaderBean,oList);
      oList = new ArrayList();
      MaintEmpPromotionBean oEmpPromotionBean = (MaintEmpPromotionBean)oBaseHeaderBean;
      checkPromRetdDate(oEmpPromotionBean.getTxtEmpNo(),oEmpPromotionBean.getNewPromEffDate());
     // reportError(oList);
     // if(sScreenName.equals(EnrgiseConstants.NEW_MODE))
     // {
        //if (!(oEmpPromotionBean.getHdnEmpLbrFlag().equals("D"))) // Added by dushyant on 31-Aug-2012
...
//  checkEmpPFLimit(oBaseHeaderBean,oList);                    
    ...
    private void checkPromRetdDate(String EmpNo, String NewPromEffDate) throws EnrgiseSystemException, EnrgiseApplicationException
{
    ArrayList oParameters = new ArrayList(); //Input Parameters
    DBUtilitiesBean oBean = new DBUtilitiesBean();
    ArrayList oOutArray; //Output 
 ...
 //   String gradepay=null;
   ...
   // oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getTxtSiteID())));
   // oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getHdnEmpLbrFlag())));
    oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR,NewPromEffDate)); 
   // oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.VARCHAR,new String(gradepay)));     
    ...
    oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG.proc_checkPromDate(?,?,?,?)",true,true);
    
    DBObject oOutObject = (DBObject)oOutArray.get(0);    
    String error_msg = (String)oOutObject.getObject();  
     DBObject oOutObject1 = (DBObject)oOutArray.get(1);    
    Integer error_code = (Integer)oOutObject1.getObject(); 
  ...
  private void checkEmpCurBasicLimit(BaseHeaderBean oBaseHeaderBean, ArrayList oList) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getTxtEmpNo())));
    oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getTxtPayType())));
    oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getNewPayScaleCode())));
    oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getNewBasic()))); 
  ...
  {     
    ...
    oParameters.add(new DBObject(4,DBObject.OUT,ParameterTypes.INTEGER));
    //oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG.proc_GetPromotionDsgnLov(?,?,?,?)"); // commented by sonia on 08-04-2011
	 oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG.proc_GetPromotionDsgnIDALov(?,?,?,?)"); // added by sonia on 08-04-2011	
    DBObject oOutObject=(DBObject)oOutArray.get(0);
    oList=(ArrayList)(oOutObject.getObject());
...
// Added by dushyant FOR CR-161 on 16-May-2013
 private void checkEmpprocatIItoI(BaseHeaderBean oBaseHeaderBean, ArrayList oList) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ArrayList oParameters = new ArrayList(); //Input Parameters
    DBUtilitiesBean oBean = new DBUtilitiesBean();
    ArrayList oOutArray; //Output 
    ...
    oParameters = new ArrayList();
    oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,new String(empNo)));
    oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR,"P"));
    oParameters.add(new DBObject(3,DBObject.OUT,ParameterTypes.VARCHAR));
    oParameters.add(new DBObject(4,DBObject.OUT,ParameterTypes.INTEGER));
    oOutArray = oBean.callProc(oParameters,"APPS.FCI_PKG_CR_161.PROC_GETCPFENTRY(?,?,?,?)",true,true);
...
// ==================== Added by Avtar Dt 09 Jul 2013 (Promotion Super User) End============================== 
 ...
 public LovVO getQueryEmpRetdPromotionLOVData(LovQueryVO oLovQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {  
    ...
    oParameters.add(new DBObject(5,DBObject.OUT,ParameterTypes.CURSOR));
    oParameters.add(new DBObject(6,DBObject.OUT,ParameterTypes.INTEGER));
    oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG.proc_getempretdpromotionlov(?,?,?,?,?,?)");
    DBObject oOutObject=(DBObject)oOutArray.get(0);
    oList=(ArrayList)(oOutObject.getObject());
 ...
 public LovVO getEmpRetdPromotionLOVData(LovQueryVO oLovQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {  
    ...
    oParameters.add(new DBObject(5,DBObject.OUT,ParameterTypes.CURSOR));
    oParameters.add(new DBObject(6,DBObject.OUT,ParameterTypes.INTEGER));
    oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG.proc_getempretdnewpromotionlov(?,?,?,?,?,?)");
    DBObject oOutObject=(DBObject)oOutArray.get(0);
    oList=(ArrayList)(oOutObject.getObject());
  ...
  // ==================== End by Avtar Dt 09 Jul 2013 (Promotion Super User) End==============================  -->
// end by dushyant
  private void checkPenaltyImposed(BaseHeaderBean oBaseHeaderBean) throws EnrgiseSystemException, EnrgiseApplicationException
  {  
    ArrayList oParameters = new ArrayList();
    oParameters = new ArrayList();
      ArrayList oOutArray;
      ...
      {    
        throw new EnrgiseApplicationException("payroll.EmpInfo.IncrementStatusPromotionCheck");
      }             
  }  
}