...
public class EmpPayFixBusinessObject extends BaseBO 
{

  public EmpPayFixBusinessObject()
  {
  }
  ...
  public void updateHeaderImpl(BaseHeaderBean oBaseHeaderBean) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    String sPayModeType;
    int count = 0;
    EmpPayFixBean oEmpPayFixBean = (EmpPayFixBean)oBaseHeaderBean;
  ...
  else
  {
      ...
      oParameters.add(new DBObject(5,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPayFixBean.getTxtFixationFlag())));
      oParameters.add(new DBObject(6,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPayFixBean.getTxtUserID())));
      oParameters.add(new DBObject(7,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPayFixBean.getTxtSiteID())));
      ...
      oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG_EXT.PROC_UPDATE_BASIC_FIXATION(?,?,?,?,?,?,?,?,?)",true,true);   
  ...
  //  String screenName=oEmpPromotionQueryVO.getScreenName();
    ...
    EmpPayFixBean oEmpPromotionBean;
    count = 0;
    QueryRow oRow = null;
    ...
    while(oIt.hasNext())
    {
        ...
        oEmpPromotionBean = new EmpPayFixBean();
        ...
        //oEmpPromotionBean.setTxtCategDesc(oRow.get("EMP_CATEGORY_DESC").getString());        
        oEmpPromotionBean.setTxtEmpType(oRow.get("PAY_SCALE_TYPE").getString());                
        ...
        oEmpPromotionBean.setTxtEmpStatus(oRow.get("EMP_TYPE_DESC").getString());  
       ...
       // oEmpPromotionBean.setTxtStagInc(oRow.get("new_Stag_incr").getString());        
        ...
        oEmpPromotionBean.setNewStagInc(oRow.get("stag_incr").getString());
        oEmpPromotionBean.setPayBand(oRow.get("PAY_SCALE_TYPE").getString());
        oEmpPromotionBean.setGradePay(oRow.get("grade_pay_amt").getString());
       // oEmpPromotionBean.setNewGradePay(oRow.get("new_grade_pay").getString());
        ...
        oEmpPromotionBean.setTxtFixationFlag(oRow.get("final_flag").getString());   
        oEmpPromotionBean.setNewPromEffDate(FCIPAY.Payroll.common.utility.EnrgiseUtil.convertToString(oRow.get("eff_from_date").getDate()));        
...
//    checkFirst(oBaseHeaderBean,oList);
      oList = new ArrayList();
      EmpPayFixBean oEmpPromotionBean = (EmpPayFixBean)oBaseHeaderBean;
...
//  checkEmpPFLimit(oBaseHeaderBean,oList);                    
  ...
  private void checkEmpCurBasicLimit(BaseHeaderBean oBaseHeaderBean, ArrayList oList) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getTxtPayType()+"1")));
    oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpPromotionBean.getPayBand())));
