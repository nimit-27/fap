...
import FCIPAY.Payroll.UTILITY.MaintDetIncHeaderBean;
...
public class DetIncBusinessObject extends BaseBO 
{
  public DetIncBusinessObject()
  {
  }
  ...
  public void updateHeaderImpl(BaseHeaderBean oBaseHeaderBean) throws EnrgiseSystemException
  {
    ...
    ArrayList oList;
    int count = 0;
    MaintDetIncHeaderBean oMaintAnnIncHeaderBean = (MaintDetIncHeaderBean)oBaseHeaderBean;
    ArrayList oOutArray; //Output 
      ...
      oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtTransportAllowance())));
      oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtTransportRebate())));
      oParameters.add(new DBObject(5,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtHRA())));
      oParameters.add(new DBObject(6,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtTaxableHrr())));
      //System.out.println("oMaintAnnIncHeaderBean.getTxtTransportAllowance()==="+oMaintAnnIncHeaderBean.getTxtTaxableHrr());

      oParameters.add(new DBObject(7,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtIncomeTaxPaid())));
      oParameters.add(new DBObject(8,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtProfessionalTax())));
      oParameters.add(new DBObject(9,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtMedicalReimb())));
      oParameters.add(new DBObject(10,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtHRPaid())));
      oParameters.add(new DBObject(11,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtTaxDueToAppor())));
      oParameters.add(new DBObject(12,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtApporAmt())));
      oParameters.add(new DBObject(13,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtExternalIncome())));
      oParameters.add(new DBObject(14,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtGIS())));
      oParameters.add(new DBObject(15,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtCPF())));
      oParameters.add(new DBObject(16,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtEPF())));
      oParameters.add(new DBObject(17,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtFPF())));
      oParameters.add(new DBObject(18,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtLIC())));
      oParameters.add(new DBObject(19,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtVPF())));
      oParameters.add(new DBObject(20,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtOtherDedn())));
      oParameters.add(new DBObject(21,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtHbaInt())));
      oParameters.add(new DBObject(22,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtHbaPrincipal())));
      oParameters.add(new DBObject(23,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtSalPrevEmployer())));
      oParameters.add(new DBObject(24,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtExternalITPaid())));
...
//    oParameters.add(new DBObject(30,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtIntDiffPerq())));
      ...
      oParameters.add(new DBObject(31,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtENCPF())));            
      oParameters.add(new DBObject(32,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtBonus())));                  
      oParameters.add(new DBObject(33,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtFinYYMM())));            
      oParameters.add(new DBObject(34,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtUserID())));
      oParameters.add(new DBObject(35,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtSiteID())));
      oParameters.add(new DBObject(36,DBObject.OUT,ParameterTypes.INTEGER));
      

      oOutArray = oBean.callProc(oParameters,"PKG_PAYROLL_MISC.proc_UpdateAnnIncome(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
  ...
  public String saveNewHeaderImpl(BaseHeaderBean oBaseHeaderBean) throws EnrgiseSystemException
  {
    ...
    ArrayList oOutArray; //Output 
//System.out.println("inside saveNewHeaderImpl");
      oParameters = new ArrayList();
      ...
      oParameters.add(new DBObject(24,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtCTD())));
      oParameters.add(new DBObject(25,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtPLI())));
      oParameters.add(new DBObject(26,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtULI())));
      oParameters.add(new DBObject(27,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtGPF())));
      oParameters.add(new DBObject(28,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtEdnCessPaid())));
      oParameters.add(new DBObject(29,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtENCPF())));      
      oParameters.add(new DBObject(30,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtBonus())));            
      oParameters.add(new DBObject(31,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtFinYYMM())));     
      oParameters.add(new DBObject(32,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtUserID())));
      oParameters.add(new DBObject(33,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtSiteID())));
      oParameters.add(new DBObject(34,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtTransportAllowance())));
      oParameters.add(new DBObject(35,DBObject.IN,ParameterTypes.VARCHAR,new String(oMaintAnnIncHeaderBean.getTxtTransportRebate())));  
      oParameters.add(new DBObject(36,DBObject.OUT,ParameterTypes.VARCHAR)); // Primary Key
      oParameters.add(new DBObject(37,DBObject.OUT,ParameterTypes.INTEGER));
      oOutArray = oBean.callProc(oParameters,"PKG_PAYROLL_MISC.proc_InsertAnnIncome(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
  ...
  public RecordMetaInfo getDetIncHeaderMetaInfo(MaintAnnIncQueryVO oMaintAnnIncQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    ArrayList oOutArray; //Output 
    //System.out.println("inside getAnnIncHeaderMetaInfo");
      oParameters = new ArrayList();
      ...
      oOutArray = oBean.callProc(oParameters,"PKG_PAYROLL_MISC.proc_GetAnnIncomeCount(?,?,?,?,?)");
  ...
  public ArrayList getDetIncHeader(MaintAnnIncQueryVO oMaintAnnIncQueryVO,long lStartPosition,long lLastPosition) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    ArrayList oHeaderList = null;
      ...
      oOutArray = oBean.callProc(oParameters,"PKG_PAYROLL_MISC.proc_GetAnnIncomeDetailNew(?,?,?,?,?,?)");
      ...
      MaintDetIncHeaderBean oMaintAnnIncHeaderBean;
      count = 0;
      QueryRow oRow = null;
      ...
      while(oIt.hasNext())
      {
          ...
          oMaintAnnIncHeaderBean = new MaintDetIncHeaderBean();
          ...
          oMaintAnnIncHeaderBean.setTxtTaxableIncome(oRow.get("ytm_taxable_erng").getString()); //commented on 26 th august 2010
...
//          oMaintAnnIncHeaderBean.setTxtIntDiffPerq(oRow.get("INTERST_DIFF_PERK").getString());
      ...
      //    oMaintAnnIncHeaderBean.setTxtMthEdnCess(oRow.get("MTH_EDN_CESS").getString()); //commented on 26 th august 2010
          ...
          oMaintAnnIncHeaderBean.setTxtTransportAllowance(oRow.get("YTM_TRANS_ALLOW").getString());   //  added by yogesh aug 2010
          oMaintAnnIncHeaderBean.setTxtTransportRebate(oRow.get("YTM_TRANS_ALLOW_REBATE").getString());  //  added by yogesh aug 2010
  ...
  public LovVO getAnnIncLOVData(LovQueryVO oLovQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    System.out.println("inside getAnnIncLOVData");
    ...
    while(iter.hasNext())
    {
      ...
      oLOVBean = new LOVBean();
       ...
       oLOVBean.setDetailField3(oRow.get("cpf_code").getString());       // added by yogesh on 7 sep 2010     
