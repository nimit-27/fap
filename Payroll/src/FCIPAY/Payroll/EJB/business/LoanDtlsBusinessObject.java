...
public class LoanDtlsBusinessObject extends BaseBO
{
  public LoanDtlsBusinessObject()
  {
  }
    ...
    DBUtilitiesBean oBeanDelete = null;   
      ...
      while(oIt.hasNext())
      {
        ...
        if(oLoanDtlsDetailBean.getStatus().equals(EnrgiseConstants.NEW_MODE))
        {
          ...
          oParameters.add(new DBObject(12,DBObject.IN,ParameterTypes.VARCHAR,new String(oLoanDtlsDetailBean.getTxtITAmt())));//added by geetika on 28/03/2014 to save income tax amount entered manually
          ...
          //oOutArray = oBeanInsert.callProc(oParameters,"PKG_LOAN.proc_InsertLoanDetail(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",true,true); //commented by swapnendu to bifurcate send invoice from insertion.
          oOutArray = oBeanInsert.callProc(oParameters,"PKG_LOAN.proc_InsertLoanDetail_Adv(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",true,true);
        ...
        else if(oLoanDtlsDetailBean.getStatus().equals(EnrgiseConstants.UPDATE_MODE))
        {
          if(!bUpdate)
          {
            ...
            //oBean.createBatch("PKG_LOAN.proc_UpdateLoanDetail(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");  //commented by swapnendu Dt 12 Mar 2012
            oBean.createBatch("PKG_LOAN.proc_UpdateLoanDetail_Adv(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); //addded by swapnendu Dt 12 Mar 2012 to update Income Tax Deduction mannually.
            bUpdate = true;
          }
          oParameters = new ArrayList();
          oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsHeaderBean.getTxtEmpNo())));          
          ...
          oParameters.add(new DBObject(13,DBObject.IN,ParameterTypes.VARCHAR,new String(oLoanDtlsDetailBean.getTxtITAmt()))); //added by swapnendu
          oParameters.add(new DBObject(14,DBObject.IN,ParameterTypes.VARCHAR,new String(oLoanDtlsHeaderBean.getTxtUserID())));
          oParameters.add(new DBObject(15,DBObject.IN,ParameterTypes.VARCHAR,new String(oLoanDtlsHeaderBean.getTxtSiteID())));          
        ...
        else if(oLoanDtlsDetailBean.getStatus().equals(EnrgiseConstants.DELETE_MODE))
        {
          ...
          oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsHeaderBean.getTxtEmpNo())));          
          oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getLoanType())));   
          oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getTransMastId())));
          oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getInvoiceNo())));
    ...
    ArrayList oLoanDtlsDetail = null;      
      ...
      oOutArray = oBean.callProc(oParameters,"PKG_LOAN.proc_GetLoanDetail(?,?,?,?,?)");
        ...
        while(oIt.hasNext())
        {
          ...
          oLoanDtls.setInvoiceNo((oRow.get("INVOICE_NUM").getString()));        // added by dushyant on 29-11-2010
          oLoanDtls.setStatus("Q");   
          oLoanDtls.setLoanFlag(oRow.get("loan_adv_flag").getString());
           //  added by varalika on 03-Oct-2011
          DateFormat formatter = new SimpleDateFormat("dd-MM-yyyy");
          oLoanDtls.setTxtCreationDate(formatter.format(new Date(oRow.get("created_date").getString())));
          oLoanDtls.setTxtCreatedBy(oRow.get("created_by").getString());
          oLoanDtls.setTxtCreatedSite(oRow.get("created_site").getString());
          if(oRow.get("updated_date").getDate() != null && !"".equals(oRow.get("updated_date").getDate()))
          {
          oLoanDtls.setTxtUpdationDate(formatter.format(oRow.get("updated_date").getDate()));
          }
          if(oRow.get("updated_by").getString() != null && !"".equals(oRow.get("updated_by").getString()))
          {
          oLoanDtls.setTxtUpdatedBy(oRow.get("updated_by").getString());
          }
           if(oRow.get("updated_site").getString() != null && !"".equals(oRow.get("updated_site").getString()))
          {
          oLoanDtls.setTxtUpdatedSite(oRow.get("updated_site").getString());
          }
          oLoanDtls.setTxtITAmt((oRow.get("it_deducted").getString()));  //added by swapnendu Dt 22 Feb 2012
  ...
  {  
    ...
    count = 0;
      ...
      oOutArray = oGetLovAction.GetLovInst(oLovQueryVO,"N");
      DBObject oOutObject=(DBObject)oOutArray.get(0);
      oList=(ArrayList)(oOutObject.getObject());
  ...
  {  
    ...
    count = 0;
      ...
      oParameters.add(new DBObject(1,DBObject.OUT,ParameterTypes.CURSOR));
      oParameters.add(new DBObject(2,DBObject.OUT,ParameterTypes.INTEGER));
      oOutArray = oBean.callProc(oParameters,"PKG_SUPER_USER_SCREEN.proc_GetLoanTypeAdminLOV(?,?)");
      DBObject oOutObject=(DBObject)oOutArray.get(0);
      oList=(ArrayList)(oOutObject.getObject());
    ...
    private void checkYrEndRemittance(BaseHeaderBean oBaseHeaderBean, ArrayList oList) throws EnrgiseSystemException, EnrgiseApplicationException
    {
        ...
        Iterator oIt = null;
        LoanDtlsHeaderBean oLoanDtlsHeaderBean = (LoanDtlsHeaderBean)oBaseHeaderBean;
        oParameters.add(new DBObject(1, DBObject.IN, ParameterTypes.VARCHAR, new String(oLoanDtlsHeaderBean.getHdnEmpLbrFlag())));
        oParameters.add(new DBObject(2, DBObject.IN, ParameterTypes.VARCHAR, new String(oLoanDtlsHeaderBean.getTxtUserID())));
        oParameters.add(new DBObject(3, DBObject.IN, ParameterTypes.VARCHAR, new String(oLoanDtlsHeaderBean.getTxtSiteID())));
  ...
  public void additionalFieldValidationImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName, String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {
        LoanDtlsDetailBean oLoanDtlsDetailBean = (LoanDtlsDetailBean)oIt.next();
        if((oLoanDtlsDetailBean.getLoanType()).equals("67"))
        {
    ...
    if(bDetailDataChanged)
    {
        ...
        {
           CheckIfInvCancelled(oDetailBeanArray,oList);   
        }
  ...
  {    
    ArrayList oList = new ArrayList();  
    if(screenName.equals("LoanDtlsScreen"))
    {      
      checkRecYYMM(oBaseHeaderBean,oDetailBeanArray, oList);
      validateFestivalAdvDtls(oBaseHeaderBean, oDetailBeanArray,oList, screenName);
      reportError(oList);
    }    
  }   
  ...
  {  
    ...
    oParameters.add(new DBObject(4,DBObject.OUT,ParameterTypes.INTEGER));
    //oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG.proc_GetMaxPayYear(?,?,?,?)"); //commented by swapnendu Dt 21 Nov 2012
    oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG.proc_GetMaxPayYear_OvrAbv_Lbr(?,?,?,?)");  //added by swapnendu Dt 21 Nov 2012 to enable advance payment after salary month end.
  ...
  private void validateFestivalAdvDtls(BaseHeaderBean oBaseHeaderBean,ArrayList oDetailBeanArray,ArrayList oList, String screenName) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ArrayList oParameters = new ArrayList(); //Input Parameters
    DBUtilitiesBean oBean = new DBUtilitiesBean();
    int count = 0;
    ...
    while(oIt.hasNext())
    {
      LoanDtlsDetailBean oLoanDetailBean = (LoanDtlsDetailBean)oIt.next();
      if(!oLoanDetailBean.getStatus().equals("D"))
      count++;
      
      if(oLoanDetailBean.getStatus().equals("N"))
      {
        oParameters = new ArrayList();
        oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,new String(oLoanDtlsHeaderBean.getTxtEmpNo())));                                 
        oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR,new String(oLoanDetailBean.getLoanType())));                                 
        oParameters.add(new DBObject(3,DBObject.OUT,ParameterTypes.VARCHAR));        
        oParameters.add(new DBObject(4,DBObject.OUT,ParameterTypes.INTEGER));        
        oOutArray = oBean.callProc(oParameters,"PAYROLL_PKG_EXT.proc_ValidateFestiveAdv(?,?,?,?)",true,true);            
  ...
  public ArrayList computePayAdvIntRate(String loanAmnt,String empLbrFlag,String prnInstlNo, long siteId) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    public String computeITPayAdv(BaseDetailInfo oBaseDetailInfo, ArrayList oDetailBeanArray) throws EnrgiseSystemException, EnrgiseApplicationException
    {
        ...
        String errmsg=null;
        DBUtilitiesBean oBean = new DBUtilitiesBean();
        LoanDtlsDetailInfo oLoanDtlsDetailInfo = (LoanDtlsDetailInfo)oBaseDetailInfo;
        Iterator oIt = oDetailBeanArray.iterator();
        while(oIt.hasNext())
        {
            LoanDtlsDetailBean oLoanDtlsDetailBean = (LoanDtlsDetailBean)oIt.next();
            if((new String(oLoanDtlsDetailBean.getItemChecked())).equals("Y"))
            {
                oParameters = new ArrayList();
                oParameters.add(new DBObject(1, DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getTransMastId())));          
                oParameters.add(new DBObject(2, DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailInfo.getTxtEmpNo())));          
                oParameters.add(new DBObject(3, DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getLoanType())));
                oParameters.add(new DBObject(4, DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getLoanAmnt())));
                oParameters.add(new DBObject(5, DBObject.IN,ParameterTypes.INTEGER, new Long(oLoanDtlsDetailInfo.getUserId())));
                oParameters.add(new DBObject(6, DBObject.IN,ParameterTypes.INTEGER, new Long(oLoanDtlsDetailInfo.getSiteId())));
                oParameters.add(new DBObject(7, DBObject.OUT,ParameterTypes.VARCHAR));
                oParameters.add(new DBObject(8, DBObject.OUT,ParameterTypes.INTEGER));
                oBean = new DBUtilitiesBean();
                oOutArray = oBean.callProc(oParameters,"PKG_LOAN.proc_ComputeTaxLoanAdv(?,?,?,?,?,?,?,?)",true,true);
                Integer errCode = (Integer)((DBObject)oOutArray.get(1)).getObject();
                errmsg =(String)(((DBObject)oOutArray.get(0)).getObject());
                /*if( ! errCode.equals(new Integer(0)))
                {
    ...
    public String sendInvLoanAdv(BaseDetailInfo oBaseDetailInfo, ArrayList oDetailBeanArray) throws EnrgiseSystemException, EnrgiseApplicationException
    {
        ...
        while(oIt.hasNext())
        {
            ...
            if((new String(oLoanDtlsDetailBean.getItemChecked())).equals("Y"))
            {
                ...
                oParameters.add(new DBObject(1, DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getTransMastId())));          
                oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailInfo.getTxtEmpNo())));          
                oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailInfo.getHdnEmpLbrFlag())));          
                oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getLoanType())));
                oParameters.add(new DBObject(5,DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getLoanAmnt())));
                oParameters.add(new DBObject(6,DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getTxtITAmt())));
                oParameters.add(new DBObject(7,DBObject.IN,ParameterTypes.INTEGER, new Long(oLoanDtlsDetailInfo.getUserId())));
                oParameters.add(new DBObject(8,DBObject.IN,ParameterTypes.INTEGER, new Long(oLoanDtlsDetailInfo.getSiteId())));
                ...
                oBean = new DBUtilitiesBean();
                oOutArray = oBean.callProc(oParameters,"PKG_LOAN.proc_SendInvoiceLoanDetail_Adv(?,?,?,?,?,?,?,?,?,?)",true,true);
                Integer errCode = (Integer)((DBObject)oOutArray.get(1)).getObject();
  ...
  public void CheckIfInvCancelled(ArrayList oDetailBeanArray,ArrayList oList) throws EnrgiseSystemException, EnrgiseApplicationException
  {      
      ArrayList oParameters = new ArrayList(); //Input Parameters
      DBUtilitiesBean oBean = new DBUtilitiesBean();
      ArrayList oOutArray; //Output
      ...
      {
          LoanDtlsDetailBean oLoanDtlsDetailBean = (LoanDtlsDetailBean)oIt.next();
                 System.out.println("hii"+oLoanDtlsDetailBean.getInvoiceNo()+oLoanDtlsDetailBean.getStatus());
          if (oLoanDtlsDetailBean.getStatus().equals("D") )
          {
       
              oParameters.add(new DBObject(1, DBObject.IN, ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getInvoiceNo())));
              oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR, new String(oLoanDtlsDetailBean.getTransMastId()))); 
              oParameters.add(new DBObject(3, DBObject.OUT,ParameterTypes.VARCHAR));
              oParameters.add(new DBObject(4, DBObject.OUT,ParameterTypes.INTEGER));
              oOutArray = oBean.callProc(oParameters,"pkg_cancel_othr_pymnt_inv.proc_isInvoice_Cancel(?,?,?,?)",true,true);
