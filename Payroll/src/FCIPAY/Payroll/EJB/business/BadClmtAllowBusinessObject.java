...
import FCIPAY.Payroll.UTILITY.MaintBadClmtAllowBean;
...
public class BadClmtAllowBusinessObject extends BaseBO
{
  public BadClmtAllowBusinessObject()
  {
  }
  ...
  public void saveDetailImpl(String sHeaderPrimaryKey,BaseHeaderBean oBaseHeaderBean,String sScreenName, ArrayList oDetailBeanArray) throws EnrgiseSystemException
  {
    ...
    if(sScreenName.equals("BadClmtCdaScreen"))
    {
      sPayScaleType = "CDA";
      saveBadClmtAllow(sHeaderPrimaryKey,sPayScaleType,(MaintBadClmtAllowHeaderBean)oBaseHeaderBean,oDetailBeanArray);
    }
    else
    {
      sPayScaleType = "IDA";
  ...
  private void saveBadClmtAllow(String sHeaderPrimaryKey,String sPayScaleType, MaintBadClmtAllowHeaderBean oBaseHeaderBean, ArrayList oDetailBeanArray) throws EnrgiseSystemException
  {
    ...
    while(oIt.hasNext())
    {
      MaintBadClmtAllowBean oMaintBadClmtAllowBean = (MaintBadClmtAllowBean)oIt.next();
  ...
  public ArrayList getBadClmtDetail(String sPrimaryKey, long lDetailFirstPosition,long lDetailLastPosition,MaintBadClmtAllowDetailInfo oMaintBadClmtAllowDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ArrayList oParameters = new ArrayList(); //Input Parameters
    DBUtilitiesBean oBean = new DBUtilitiesBean();
    int count = 0;
    ArrayList oOutArray; //Output
    MaintBadClmtAllowBean oMaintBadClmtAllowBean;
    ...
    while(oIt.hasNext())
    {
      ...
      oMaintBadClmtAllowBean = new MaintBadClmtAllowBean();
...
//      {
 ...
 //     }
  ...
  public BadClmtComboVO getBadClmtComboDetails() throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ArrayList oParameters = new ArrayList(); //Input Parameters
    DBUtilitiesBean oBean = new DBUtilitiesBean();
    BadClmtComboVO oBadClmtComboVO = new BadClmtComboVO();
    int count = 0;
    ArrayList oOutArray; //Output
    ...
    while(oIt.hasNext())
    {
      ...
      oBadClmtCtgry.add(oComboVO);
    }
    oBadClmtComboVO.setCtgryList(oBadClmtCtgry);
  ...
  public ArrayList getBadClmtAllowHeader(BadClmtQueryVO oBadClmtQueryVO,long lStartPosition,long lLastPosition) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    if(oBadClmtQueryVO == null)
    {
      ...
      MaintBadClmtAllowHeaderBean oMaintBadClmtAllowHeaderBean;
      count = 0;
      QueryRow oRow = null;
      ...
      while(oIt.hasNext())
      {
          ...
          count++;
          oRow = (QueryRow)oIt.next();
          oMaintBadClmtAllowHeaderBean = new MaintBadClmtAllowHeaderBean();       
  ...
  private void chkEffDate(BaseHeaderBean oBaseHeaderBean,String sScreenMode,String sPayScaleType,ArrayList oList) throws EnrgiseSystemException, EnrgiseApplicationException
  {
      ...
      MaintBadClmtAllowHeaderBean oMaintBadClmtAllowHeaderBean = (MaintBadClmtAllowHeaderBean)oBaseHeaderBean;
      oParameters = new ArrayList();
