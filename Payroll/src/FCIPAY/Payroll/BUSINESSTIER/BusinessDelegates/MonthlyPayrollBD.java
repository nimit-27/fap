...
public class MonthlyPayrollBD extends BaseBD
{
  public MonthlyPayrollBD()
  {
  }
 ...
 public String MonthlyPayTransaction( String empNo,String all,long lUserID,long lSiteID,String hdnEmpLbrFlag, String hdnMaxRebFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollFacade oMonthlyPayrollFacade = oHome.create();
      
     return oMonthlyPayrollFacade.MonthlyPayTransaction( empNo,all,lUserID,lSiteID,hdnEmpLbrFlag,hdnMaxRebFlag);
