...
public class CompPayrollBD extends BaseBD
{
  public CompPayrollBD()
  { 
  }
  public void compPayTransaction(String empNo) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    try
    {      
      ...
      PayrollFacade oCompPayFacade = oHome.create();
      
      oCompPayFacade.compMonthlyPayroll(empNo);
    }
