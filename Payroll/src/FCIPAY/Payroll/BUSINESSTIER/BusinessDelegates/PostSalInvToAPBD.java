...
public class PostSalInvToAPBD extends BaseBD
{
  public PostSalInvToAPBD() 
  {
  }
  //Modified  By Neeraj Starts//
 public String PostSalInvToAP(long lUserID,long lSiteID,String hdnEmpLbrFlag,String invoice_date) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    try
    {      
      ...
      PayrollFacade oPostSalFacade = oHome.create();
      
     return oPostSalFacade.PostSalAP(lUserID,lSiteID,hdnEmpLbrFlag,invoice_date);
    }
  ...
  public String getMaxPayYear(long locCode,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollFacade oInitFacade = oHome.create();
       ...
       return oInitFacade.getPostSalMaxPayYear(locCode,hdnEmpLbrFlag);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
