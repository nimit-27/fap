...
public class LoanRescheduleBD extends PayrollBaseBD
{
  public LoanRescheduleBD()
  {
   super(); 
  }
  ...
  public RecordMetaInfo getTotalDetailRecordCountImpl(String sPrimaryKey,String sScreenName) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      {
        return oPayFacade.getPaycodeAgencycodeDetailMetaInfo(sPrimaryKey);
      }
  ...
  /*  try
    {      
      ...
      {
        return oPayFacade.getPaycodeAgencycodeDetail(sPrimaryKey,lAbsoluteStart,lAbsoluteEnd);
      }
  ...
  public String saveImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName,String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oPayFacade = oHome.create();
      return oPayFacade.saveLoanRescheduleDetails((LoanRescheduleBean)oBaseHeaderBean , oWhenPicked, sScreenName,sScreenMode, bHeaderDataChanged, oDetailBeanArray, bDetailDataChanged, oDetailPicked);
//      return null;
    }
    catch(RemoteException oRe)
    {
...
//      return oSysFacade.saveGlobalCodeHeader((GlobalCodeHeaderBean)oBaseHeaderBean);
  ...
  public RecordMetaInfo getHeaderMetaImpl(BaseQueryVO oQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oPayFacade = oHome.create();
      return oPayFacade.getLoanRescheduleHeaderMetaInfo((LoanRescheduleVO)oQueryVO);
  ...
  public ArrayList getHeaderRecordImpl(BaseQueryVO oQueryVO,long lStartPosition,long lLastPosition) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      ArrayList oHeaderList = oPayFacade.getLoanRescheduleHeader(((LoanRescheduleVO) oQueryVO),lStartPosition,lLastPosition);

      return oHeaderList;

    }//getLoanForeclosureHeader
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
    }
  ...
  public BaseHeaderBean getLoanRescheduleDtls(LoanRescheduleVO oLoanRescheduleVO) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      return oEmpFinInfoFacade.getLoanRescheduleDtls(oLoanRescheduleVO);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
   ...
   public BaseHeaderBean getInterestDtls(LoanRescheduleVO oLoanRescheduleVO) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      return oEmpFinInfoFacade.getInterestDtls(oLoanRescheduleVO);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
