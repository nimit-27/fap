...
public class GenDAArrearBD extends PayrollBaseBD
{
  public GenDAArrearBD()
  {
    super();  
  }
...
//      return oAnnIncFacade.saveAnnIncHeader((MaintAnnIncHeaderBean)oBaseHeaderBean);
 ...
 public String genDAArrear(BaseHeaderBean oBaseHeaderBean,long loginUserId ,long lLoginSiteId ) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    try
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oGenDAFacade = oHome.create();
      return oGenDAFacade.genDAArrear((GenDAArrearHeaderBean)oBaseHeaderBean,loginUserId ,lLoginSiteId );
//      return null;
    }
    catch(RemoteException oRe)
    {
 ...
 public String undoDAArrear(BaseHeaderBean oBaseHeaderBean,long loginUserId ,long lLoginSiteId ) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    try
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oGenDAFacade = oHome.create();
      return oGenDAFacade.undoDAArrear((GenDAArrearHeaderBean)oBaseHeaderBean ,loginUserId ,lLoginSiteId );
//      return null;
    }
    catch(RemoteException oRe)
    {
