...
public class ComputeFscBD extends BaseBD
{
  public ComputeFscBD()
  {
  }

public String ComputeFsc(long lUserID,long lSiteID, String lFinYear) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    try
    {      
      ...
      PayrollFacade oComputeFscFacade = oHome.create();
      
    //   return oComputeFscFacade.ComputeFSC(lUserID,lSiteID, lFinYear);
    return null;
    }
