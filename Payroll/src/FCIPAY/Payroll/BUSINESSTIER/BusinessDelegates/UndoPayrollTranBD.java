...
public class UndoPayrollTranBD extends BaseBD
{
  public UndoPayrollTranBD()
  {
      super();
  }
  ...
  public String undoPayrollTran(String dflag,String empNum,long loginUserId,long lLoginSiteId,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      PayrollFacade oUndoPayFacade = oHome.create();
      return oUndoPayFacade.undoPayrollTran(dflag,empNum,loginUserId,lLoginSiteId,hdnEmpLbrFlag);
      //return "undo";
    }
  ...
  public String getMaxPayYear(long locCode,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollFacade oInitFacade = oHome.create();
       ...
       return oInitFacade.getUndoMaxPayYear(locCode,hdnEmpLbrFlag);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
