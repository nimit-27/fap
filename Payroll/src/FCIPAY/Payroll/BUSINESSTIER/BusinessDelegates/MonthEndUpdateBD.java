...
public class MonthEndUpdateBD extends BaseBD
{
  public MonthEndUpdateBD()
  {
  }
  public String startMonthEndUpdate(long lUserID,long lSiteID,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    try
    {      
      ...
      PayrollFacade oMonthEndFacade = oHome.create();
      
   return oMonthEndFacade.monthEndUpdate(lUserID,lSiteID,hdnEmpLbrFlag);
    }
  ...
  public String startSingleMonthEndUpdate(long lUserID,long lSiteID,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    try
    {      
            ...
            return oPayFacade.singleMonthEndUpdate(lUserID,lSiteID,hdnEmpLbrFlag);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
  ...
  public String getMaxPayYear(long locCode,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollFacade oInitFacade = oHome.create();
       ...
       return oInitFacade.getMonthEndMaxPayYear(locCode,hdnEmpLbrFlag);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
    ...
    public String getEmpWaitingToJoin(long lUserId,long lSiteId) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
    {
        try
        {
            PayrollNewFacadeHome oHome = (PayrollNewFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollNewFacade");
            PayrollNewFacade oPayFacade = oHome.create();
            return(oPayFacade.getEmpWaitingToJoin(lUserId, lSiteId));
        }
        catch(RemoteException oRe)
        {
            throw new EnrgiseSystemException(oRe);
