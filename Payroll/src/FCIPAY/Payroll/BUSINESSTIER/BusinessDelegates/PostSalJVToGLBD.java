...
public class PostSalJVToGLBD extends BaseBD
{
  public PostSalJVToGLBD() 
  {
  }
 public String PostSalJVGL(long lUserID,long lSiteID) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    try
    {      
     ...
     return oPostSalFacade.PostSal(lUserID,lSiteID);
    }
