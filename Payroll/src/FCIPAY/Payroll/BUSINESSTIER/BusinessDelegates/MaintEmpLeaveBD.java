...
public class MaintEmpLeaveBD extends PayrollBaseBD 
{
  
  public MaintEmpLeaveBD()
  {
  }
  ...
  public RecordMetaInfo getTotalDetailRecordCountImpl(String sPrimaryKey,String sScreenName,BaseDetailInfo oBaseDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      {
        return oPayFacade.getEmpLeaveDetailMetaInfo(sPrimaryKey,(EmpLeaveDetailInfo)oBaseDetailInfo);
      }
      return null;
    }
    catch(RemoteException oRe)
  ...
  public ArrayList getDetailRecordImpl(String sPrimaryKey,String sScreenName,long lAbsoluteStart,long lAbsoluteEnd,BaseDetailInfo oBaseDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      if(sScreenName.equals("LeaveScreen"))
      {
        return oPayFacade.getEmpLeaveDetail(sPrimaryKey,lAbsoluteStart,lAbsoluteEnd,(EmpLeaveDetailInfo)oBaseDetailInfo);
      }
  ...
  public String saveImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName,String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      if(sScreenMode.equals("C"))
      {
        return oPayFacade.cancelLeaveDetail((DummyHeaderBean)oBaseHeaderBean , oWhenPicked, sScreenName,sScreenMode, bHeaderDataChanged, oDetailBeanArray, bDetailDataChanged, oDetailPicked);
      }
      else if(sScreenMode.equals("V"))
      {
        return oPayFacade.convertLeaveDetail((DummyHeaderBean)oBaseHeaderBean , oWhenPicked, sScreenName,sScreenMode, bHeaderDataChanged, oDetailBeanArray, bDetailDataChanged, oDetailPicked);
      }
      else
      {
         return oPayFacade.saveEmpLeaveDetail((DummyHeaderBean)oBaseHeaderBean , oWhenPicked, sScreenName,sScreenMode, bHeaderDataChanged, oDetailBeanArray, bDetailDataChanged, oDetailPicked);
      }
    }
    catch(RemoteException oRe)
    {
...
//      return oSysFacade.getGlobalCodeHeaderMetaInfo((GlobalCodeQueryVO)oQueryVO);
  ...
  public void getComboDetails(HttpServletRequest request) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oPayFacade = oHome.create();
      EmpLeaveComboVO oEmpLeaveComboVO = oPayFacade.getEmpLeaveComboDetails();
      if(request.getSession().getAttribute("LeaveTyp")!=null)
      {
        request.getSession().removeAttribute("LeaveTyp");
      }
      request.getSession().setAttribute("LeaveTyp",oEmpLeaveComboVO);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
