...
public class GenerateCPVBD extends BaseBD
{
  public GenerateCPVBD()
  {
  }

public String GenerateCPV(long lUserID,long lSiteID) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    try
    {      
      ...
      PayrollFacade oGenCPVFacade = oHome.create();
      
     return oGenCPVFacade.GenCPV(lUserID,lSiteID);
    }
