...
public class EditPayImageBD extends PayrollBaseBD 
{
  public EditPayImageBD()
  {
    super();  
  }  
  ...
  public RecordMetaInfo getTotalDetailRecordCountImpl(String sPrimaryKey, String sScreenName, BaseDetailInfo oBaseDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      MasterFacade oEnqPayImageFacade = oHome.create();
      return oEnqPayImageFacade.getEnqPayImageDetailMetaInfo(sPrimaryKey,(EnqPayImageDetailInfo)oBaseDetailInfo);
  ...
  public ArrayList getDetailRecordImpl(String sPrimaryKey,String sScreenName,long lAbsoluteStart,long lAbsoluteEnd,BaseDetailInfo oBaseDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      return oMasterFacade.getEnqPayImageDetail(sPrimaryKey,lAbsoluteStart,lAbsoluteEnd,(EnqPayImageDetailInfo)oBaseDetailInfo);  
     }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
 ...
 /*public void getComboDetails(HttpServletRequest request) throws EnrgiseSystemException, EnrgiseApplicationException
 {
    ...
    {      
      MasterFacadeHome oHome = (MasterFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("MasterFacade");
      MasterFacade oEnqPayImageFacade = oHome.create();
      EditPayImgComboVO oEditPayImgComboVO = oEnqPayImageFacade.getEnqPayImageComboDetails();
      ...
      request.getSession().setAttribute("SalaryYrMonth",oEditPayImgComboVO);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
 ...
 public String getMaxPayYear(long locCode,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      MasterFacadeHome oHome = (MasterFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("MasterFacade");
      MasterFacade oInitFacade = oHome.create();
      return oInitFacade.getMaxPayYear(locCode,hdnEmpLbrFlag);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
  ...
  public String saveImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName,String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      MasterFacadeHome oHome = (MasterFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("MasterFacade");
      MasterFacade oEditPayImgFacade = oHome.create();
      return oEditPayImgFacade.saveEditPayImg((EnqPayImageHeaderBean)oBaseHeaderBean , oWhenPicked, sScreenName,sScreenMode, bHeaderDataChanged, oDetailBeanArray, bDetailDataChanged, oDetailPicked);
     // return null;
    }
    catch(RemoteException oRe)
    {
  ...
  public ArrayList getPayCodeDetail(String sPayCode) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    try
      {      
        MasterFacadeHome oHome = (MasterFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("MasterFacade");
        MasterFacade oMasterFacade = oHome.create();
        return oMasterFacade.getPayCodeDetail(sPayCode);
      }
      catch(RemoteException oRe)
      {
        throw new EnrgiseSystemException(oRe);
