...
public class LoanForeclosureBD extends PayrollBaseBD
{
  public LoanForeclosureBD()
  {
   super(); 
  }
...
public RecordMetaInfo getTotalDetailRecordCountImpl(String sPrimaryKey,String sScreenName) throws EnrgiseSystemException, EnrgiseApplicationException
  ...
  public String saveImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName,String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oPayFacade = oHome.create();
      return oPayFacade.saveLoanForeclosureDetails((LoanForeclosureBean)oBaseHeaderBean , oWhenPicked, sScreenName,sScreenMode, bHeaderDataChanged, oDetailBeanArray, bDetailDataChanged, oDetailPicked);
//      return null;
    }
    catch(RemoteException oRe)
    {
...
//      return oSysFacade.saveGlobalCodeHeader((GlobalCodeHeaderBean)oBaseHeaderBean);
  ...
  public RecordMetaInfo getHeaderMetaImpl(BaseQueryVO oQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oPayFacade = oHome.create();
      return oPayFacade.getLoanForeclosureHeaderMetaInfo((LoanForeclosureVO)oQueryVO);
  ...
  public ArrayList getHeaderRecordImpl(BaseQueryVO oQueryVO,long lStartPosition,long lLastPosition) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      ArrayList oHeaderList = oPayFacade.getLoanForeclosureHeader(((LoanForeclosureVO) oQueryVO),lStartPosition,lLastPosition);
  ...
  public BaseHeaderBean getLoanForeclosureDtls(LoanForeclosureVO oLoanForeclosureVO) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      return oEmpFinInfoFacade.getLoanForeclosureDtls(oLoanForeclosureVO);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
   ...
   public BaseHeaderBean getForecloseInterestDtls(LoanForeclosureVO oLoanForeclosureVO) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      return oEmpFinInfoFacade.getForecloseInterestDtls(oLoanForeclosureVO);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
