...
public class PostRemitToAPBD extends BaseBD
{
  public PostRemitToAPBD() 
  {
  }
 public String PostRemitToAP(long lUserID,long lSiteID,String hdnEmpLbrFlag,String invoice_date) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      return oPayFacade.PostRemitToAP(lUserID,lSiteID,hdnEmpLbrFlag,invoice_date);
    }
  ...
  public String getMaxPayYear(long locCode,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollFacade oInitFacade = oHome.create();
       ...
       return oInitFacade.getPostRemitMaxPayYear(locCode,hdnEmpLbrFlag);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
