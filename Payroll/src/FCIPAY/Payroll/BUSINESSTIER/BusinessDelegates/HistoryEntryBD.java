...
public class HistoryEntryBD  extends PayrollBaseBD
{
  public HistoryEntryBD()
  {
  }

 public RecordMetaInfo getTotalDetailRecordCountImpl(String sPrimaryKey,HistoryEntryDetailInfo oHistoryEntryDetailInfo,String sScreenName) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      {
       return oInterestFacade.getHistoryEntDetailMetaInfo(sPrimaryKey, oHistoryEntryDetailInfo);
...
public BaseDetailVO getDetailRecord(String sFormName, String sScreenName,String sPrimaryKey,long lPageRequested,DetailSizeValues oDetailSizeValues,BaseDetailVO oBaseDetailVO,boolean bForce,UserSession oUser,BaseDetailInfo oBaseDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      if(oBaseDetailVO == null || bForce)
      {
        ...
        RecordMetaInfo oHistoryEntryDetailInfo = getTotalDetailRecordCountImpl(sPrimaryKey,(HistoryEntryDetailInfo)oBaseDetailInfo,sScreenName);
        if(null == oHistoryEntryDetailInfo)
        {
        ...
        oBaseDetailVO.setTotalDetailRecord(oHistoryEntryDetailInfo.getRecordCount());
        oBaseDetailVO.setOWhenPicked(oHistoryEntryDetailInfo.getOWhenPicked());
        if(oHistoryEntryDetailInfo.getRecordCount() == 0)
        {
...
//      oDetailList = getDetailRecordImpl(sPrimaryKey,sScreenName,lAbsoluteStart,lAbsoluteEnd);
      oDetailList = oInterestFacade.getHistoryEntDetail(sPrimaryKey,lAbsoluteStart,lAbsoluteEnd,(HistoryEntryDetailInfo)oBaseDetailInfo);
  ...
  public String saveImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName,String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oInterestFacade = oHome.create();
      return oInterestFacade.saveHistoryEnt((HistoryEntryHeaderBean)oBaseHeaderBean , oWhenPicked, sScreenName,sScreenMode, bHeaderDataChanged, oDetailBeanArray, bDetailDataChanged, oDetailPicked);
...
//      return oDAFacade.saveDARateHeader((MaintDARatesHeaderBean)oBaseHeaderBean);
  ...
  public RecordMetaInfo getHeaderMetaImpl(BaseQueryVO oQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oInterestFacade = oHome.create();
      return oInterestFacade.getHistoryEntHeaderMetaInfo((HistoryEntryQueryVO)oQueryVO);
  ...
  public ArrayList getHeaderRecordImpl(BaseQueryVO oQueryVO,long lStartPosition,long lLastPosition) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      ArrayList oHeaderList = oInterestFacade.getHistoryEntHeader((HistoryEntryQueryVO)oQueryVO,lStartPosition,lLastPosition);
