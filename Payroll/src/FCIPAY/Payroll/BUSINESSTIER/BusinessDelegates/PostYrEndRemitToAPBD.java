...
public class PostYrEndRemitToAPBD extends BaseBD
{
  public PostYrEndRemitToAPBD() 
  {
  }
 public String PostOthrPayments(long lUserID,long lSiteID,String hdnEmpLbrFlag,String invoice_date) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      return oPayrollNewFacade.PostOthrPayments(lUserID,lSiteID,hdnEmpLbrFlag,invoice_date);
    }
 ...
 public String PostRemitSalary(long lUserID,long lSiteID,String hdnEmpLbrFlag,String invoice_date) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      return oPayrollNewFacade.PostRemitSalary(lUserID,lSiteID,hdnEmpLbrFlag,invoice_date);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
  ...
  public String getMaxPayYear(long locCode,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollNewFacade oInitFacade = oHome.create();
       ...
       return oInitFacade.getPostYrEndRemitMaxPayYear(locCode,hdnEmpLbrFlag);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
