...
public class OverNAboveArrear extends PayrollBaseBD
{
  public OverNAboveArrear()
  {
    super();  
  }
...
//      return oAnnIncFacade.saveAnnIncHeader((MaintAnnIncHeaderBean)oBaseHeaderBean);
  ...
  public RecordMetaInfo getHeaderMetaImpl(BaseQueryVO oQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollNewFacade oFacade = oHome.create();
      return oFacade.getOvrAbvArrearHeaderMetaInfo((GenDAArrearQueryVO)oQueryVO);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
  ...
  public ArrayList getHeaderRecordImpl(BaseQueryVO oQueryVO,long lStartPosition,long lLastPosition) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      ArrayList oHeaderList = oFacade.getOvrAbvArrearHeader((GenDAArrearQueryVO)oQueryVO,lStartPosition,lLastPosition);
      return oHeaderList;
    }
    catch(RemoteException oRe)
    {
 ...
 public String genOverNAboveArrear(BaseHeaderBean oBaseHeaderBean,long loginUserId ,long lLoginSiteId ,String payYYMM) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    try
    {      
      PayrollNewFacadeHome oHome = (PayrollNewFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollNewFacade");
      PayrollNewFacade oGenOvrAbvFacade = oHome.create();
      return oGenOvrAbvFacade.genOverNAboveArrear((OverNAboveArrearHeaderBean)oBaseHeaderBean,loginUserId ,lLoginSiteId,payYYMM );
//      return null;
    }
    catch(RemoteException oRe)
    {
  ...
  public String getMaxPayYear(long locCode,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollFacade oInitFacade = oHome.create();
       ...
       return oInitFacade.getDAArrearMaxPayYear(locCode,hdnEmpLbrFlag);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
  ...
  public String undoOvrAbvArrear(BaseHeaderBean oBaseHeaderBean,long loginUserId ,long lLoginSiteId ) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    try
    {      
      PayrollNewFacadeHome oHome = (PayrollNewFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollNewFacade");
      PayrollNewFacade oFacade = oHome.create();
      return oFacade.undoOvernAboveArrear((OverNAboveArrearHeaderBean)oBaseHeaderBean ,loginUserId ,lLoginSiteId );
//      return null;
    }
    catch(RemoteException oRe)
    {
