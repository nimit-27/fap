...
public class MaintSiteDetailBD extends PayrollBaseBD
{
  public MaintSiteDetailBD()
  {
   super();
  }
...
public RecordMetaInfo getTotalDetailRecordCountImpl(String sPrimaryKey,String sScreenName) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollFacade oSiteFacade = oHome.create();
     if(sScreenName.equals("SiteMasterScreen"))
      {
        return oSiteFacade.getSiteDetailMetaInfo(sPrimaryKey);
      }
  ...
  public ArrayList getDetailRecordImpl(String sPrimaryKey,String sScreenName,long lAbsoluteStart,long lAbsoluteEnd) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      if(sScreenName.equals("SiteMasterScreen"))
      {
        return oSiteFacade.getSiteDetail(sPrimaryKey,lAbsoluteStart,lAbsoluteEnd);
      }
...
public String saveImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName,String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oSiteFacade = oHome.create();
     return oSiteFacade.saveSiteDetail((DummyHeaderBean)oBaseHeaderBean , oWhenPicked, sScreenName,sScreenMode, bHeaderDataChanged, oDetailBeanArray, bDetailDataChanged, oDetailPicked);
     // return null;
    }
    catch(RemoteException oRe)
    {
 ...
 public void getComboDetails(HttpServletRequest request) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      SiteTypeComboVO oSiteTypeComboVO = oPayFacade.getLocTypesComboDetails();
      if(request.getSession().getAttribute("LocTypes")!=null)
      {
        request.getSession().removeAttribute("LocTypes");
      }
      request.getSession().setAttribute("LocTypes",oSiteTypeComboVO);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
