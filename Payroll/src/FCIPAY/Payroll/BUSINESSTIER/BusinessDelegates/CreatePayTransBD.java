...
public class CreatePayTransBD extends BaseBD
{
  public CreatePayTransBD()
  {
  }
  public String createPayTransaction(String procs, String empNo,long lUserID,long lSiteID,String hdnEmpLbrFlag ) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollFacade oCreatePayFacade = oHome.create();      
      return oCreatePayFacade.createPayTransaction(procs, empNo,lUserID,lSiteID,hdnEmpLbrFlag);
    }
  ...
  public String getMaxPayYear(long locCode,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollFacade oInitFacade = oHome.create();
       ...
       return oInitFacade.getCreatePayMaxPayYear(locCode,hdnEmpLbrFlag);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
