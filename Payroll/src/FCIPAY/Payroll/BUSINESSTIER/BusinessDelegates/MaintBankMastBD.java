...
public class MaintBankMastBD  extends PayrollBaseBD
{
  public MaintBankMastBD()
  {
    super();
  }

 public RecordMetaInfo getTotalDetailRecordCountImpl(String sPrimaryKey,BankMastDetailInfo oBankMastDetailInfo,String sScreenName) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      {
        return oInterestFacade.getBankMasterDetailMetaInfo(sPrimaryKey,oBankMastDetailInfo);
      }
...
public BaseDetailVO getDetailRecord(String sFormName, String sScreenName,String sPrimaryKey,long lPageRequested,DetailSizeValues oDetailSizeValues,BaseDetailVO oBaseDetailVO,boolean bForce,UserSession oUser,BaseDetailInfo oBaseDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      if(oBaseDetailVO == null || bForce)
      {
        ...
        RecordMetaInfo oBankMastDetailInfo = getTotalDetailRecordCountImpl(sPrimaryKey,(BankMastDetailInfo)oBaseDetailInfo,sScreenName);
        if(null == oBankMastDetailInfo)
        {
        ...
        oBaseDetailVO.setTotalDetailRecord(oBankMastDetailInfo.getRecordCount());
        oBaseDetailVO.setOWhenPicked(oBankMastDetailInfo.getOWhenPicked());
        if(oBankMastDetailInfo.getRecordCount() == 0)
        {
...
//      oDetailList = getDetailRecordImpl(sPrimaryKey,sScreenName,lAbsoluteStart,lAbsoluteEnd);
      oDetailList = oInterestFacade.getBankMasterDetail(sPrimaryKey,lAbsoluteStart,lAbsoluteEnd,(BankMastDetailInfo)oBaseDetailInfo);
      if(oDetailList == null)
      {        
        throw new EnrgiseApplicationException("IBA.Payroll.common.nodetailrecord",FCIPAY.Payroll.common.utility.EnrgiseConstants.MESSAGE);
      }
  ...
  public String saveImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName,String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      MasterFacadeHome oHome = (MasterFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("MasterFacade");
      MasterFacade oInterestFacade = oHome.create();
      return oInterestFacade.saveBankDetail((MaintBankMastHeaderBean)oBaseHeaderBean , oWhenPicked, sScreenName,sScreenMode, bHeaderDataChanged, oDetailBeanArray, bDetailDataChanged, oDetailPicked);
     // return null;
    }
    catch(RemoteException oRe)
    {
...
//      return oDAFacade.saveDARateHeader((MaintDARatesHeaderBean)oBaseHeaderBean);
  ...
  public RecordMetaInfo getHeaderMetaImpl(BaseQueryVO oQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      MasterFacadeHome oHome = (MasterFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("MasterFacade");
      MasterFacade oInterestFacade = oHome.create();
      return oInterestFacade.getBankHeaderMetaInfo((MaintBankMastQueryVO)oQueryVO);
  ...
  public ArrayList getHeaderRecordImpl(BaseQueryVO oQueryVO,long lStartPosition,long lLastPosition) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      ArrayList oHeaderList = oInterestFacade.getBankMasterHeader((MaintBankMastQueryVO)oQueryVO,lStartPosition,lLastPosition);
      return oHeaderList;
      // return null;
    }
    catch(RemoteException oRe)
