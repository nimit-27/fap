...
public class IncomeTaxBD extends PayrollBaseBD
{
  public IncomeTaxBD()
  {
    super();  
 ...
 public String computeProjectedTax(BaseHeaderBean oBaseHeaderBean,long loginUserId,long lLoginSiteId) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException  
  {
    try
    {      
      ...
      return oCompIncomeTaxFacade.computeProjectedTax((ComputeTaxHeaderBean)oBaseHeaderBean,loginUserId,lLoginSiteId );
//      return null;
    }
 ...
 public String computeActualTax(BaseHeaderBean oBaseHeaderBean,long loginUserId,long lLoginSiteId) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException  
  {
    try
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oCompIncomeTaxFacade = oHome.create();
      return oCompIncomeTaxFacade.computeActualTax((ComputeTaxHeaderBean)oBaseHeaderBean,loginUserId,lLoginSiteId );
//      return null;
    }
    catch(RemoteException oRe)
    {
  ...
  public String getMaxPayYear(long locCode,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      PayrollFacade oInitFacade = oHome.create();
       ...
       return oInitFacade.getITaxMaxPayYear(locCode,hdnEmpLbrFlag);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
