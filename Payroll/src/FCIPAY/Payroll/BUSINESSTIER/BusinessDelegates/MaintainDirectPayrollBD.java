...
public class MaintainDirectPayrollBD extends PayrollBaseBD
{
  public MaintainDirectPayrollBD()
  {
    super();  
  }
...
/*  public RecordMetaInfo getTotalDetailRecordCountImpl(String sPrimaryKey,String sScreenName) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
     PayrollFacadeHome oHome = (PayrollFacadeHome)ServiceLocator.getLocator().getService("PayrollFacade");
      ...
      {
        return oDirFacade.getDirectPayrollDetailMetaInfo(sPrimaryKey);
      }
  ...
  public ArrayList getDetailRecordImpl(String sPrimaryKey,String sScreenName,long lAbsoluteStart,long lAbsoluteEnd)throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      if(sScreenName.equals("DirectPayrollScreen"))
      {
        return oDirFacade.getDirectPayrollDetail(sPrimaryKey,lAbsoluteStart,lAbsoluteEnd);
      }
  ...
  public RecordMetaInfo getTotalDetailRecordCountImpl(String sPrimaryKey,DirPayrollDetailInfo oDirPayrollDetailInfo,String sScreenName) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      if(sScreenName.equals("DirectPayrollScreen"))
      {
        return oDirFacade.getDirectPayrollDetailMetaInfo(sPrimaryKey,oDirPayrollDetailInfo);
      }
...
/*  public BaseDetailVO getDetailRecord(String sFormName, String sScreenName,String sPrimaryKey,long lPageRequested,DetailSizeValues oDetailSizeValues,BaseDetailVO oBaseDetailVO,UserSession oUser,BaseDetailInfo oBaseDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      if(oBaseDetailVO == null)
      {
        ...
        RecordMetaInfo oDirPayrollDetailInfo = getTotalDetailRecordCountImpl(sPrimaryKey,(DirPayrollDetailInfo)oBaseDetailInfo,sScreenName);
        if(null == oDirPayrollDetailInfo)
        {
          throw new EnrgiseApplicationException("IBA.Payroll.common.nodetailrecord",EnrgiseConstants.MESSAGE);          
        }
        oBaseDetailVO.setTotalDetailRecord(oDirPayrollDetailInfo.getRecordCount());
        oBaseDetailVO.setOWhenPicked(oDirPayrollDetailInfo.getOWhenPicked());
        if(oDirPayrollDetailInfo.getRecordCount() == 0)
        {
  ...
  public ArrayList getDetailRecordImpl(String sPrimaryKey,String sScreenName,long lAbsoluteStart,long lAbsoluteEnd) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
{
  ...
  public String saveImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName,String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oDirFacade = oHome.create();
      return oDirFacade.saveDirectPayroll((MaintDirectPayrollHeaderBean)oBaseHeaderBean , oWhenPicked, sScreenName,sScreenMode, bHeaderDataChanged, oDetailBeanArray, bDetailDataChanged, oDetailPicked);
//      return null;
    }
    catch(RemoteException oRe)
    {
...
// Added by dushaynt on 28-Jun-2013
  public String sGetEmpNumchk(String  sEmpNum,long  lSiteId,String  sEmplbr) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      return payrollNewFacade.sGetEmpNumchk(sEmpNum,lSiteId,sEmplbr); 
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
...
// End 
     ...
     public ArrayList getDepuPayCodes() throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      PayrollNewFacadeHome oHome = (PayrollNewFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollNewFacade");
      PayrollNewFacade payrollNewFacade = oHome.create();      
      return payrollNewFacade.getDepuPayCodes();
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
