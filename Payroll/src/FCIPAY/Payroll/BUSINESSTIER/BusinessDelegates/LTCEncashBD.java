...
public class LTCEncashBD extends BaseBD 
{
  public LTCEncashBD()
  {
    super();
  ...
  public String saveImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName,String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      return oEmpFinInfoFacade.saveLTCEncashInfo((LTCEncashHeaderBean)oBaseHeaderBean , oWhenPicked, sScreenName,sScreenMode, bHeaderDataChanged, oDetailBeanArray, bDetailDataChanged, oDetailPicked);
    //  return null;
    }
...
//      return oEmpFinInfoFacade.saveAnnIncHeader((MaintAnnIncHeaderBean)oBaseHeaderBean);
  ...
  public RecordMetaInfo getHeaderMetaImpl(BaseQueryVO oQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      PayrollFacadeHome oHome = (PayrollFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollFacade");
      PayrollFacade oEmpFinInfoFacade = oHome.create();
      return oEmpFinInfoFacade.getLTCEncashHeaderMetaInfo((LTCEncashQueryVO)oQueryVO);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
  ...
  public ArrayList getHeaderRecordImpl(BaseQueryVO oQueryVO,long lStartPosition,long lLastPosition) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      ArrayList oHeaderList = oEmpFinInfoFacade.getLTCEncashHeader((LTCEncashQueryVO)oQueryVO,lStartPosition,lLastPosition);
      return oHeaderList;
    }
    catch(RemoteException oRe)
    {
  ...
  public ArrayList getITDed(BaseQueryVO oQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      ArrayList oPayInfo = oEmpFinInfoFacade.getLTCEncashITDed((LTCEncashQueryVO)oQueryVO);
      return oPayInfo;
    }
    catch(RemoteException oRe)
    {
  ...
  public String sendLTCEncashInv(String sPrimaryKey,String hdnEmpLbrFlag,long lUserID,long lSiteID) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      return oEmpFinInfoFacade.sendLTCEncashInv(sPrimaryKey,hdnEmpLbrFlag,lUserID,lSiteID);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
  ...
  public String  deleteLTCEncashPayment(BaseQueryVO oQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    try
    {      
      ...
      String oLeaveInfo = oEmpFinInfoFacade.deleteLTCEncash((LTCEncashQueryVO)oQueryVO);
      return oLeaveInfo;
    }
    catch(RemoteException oRe)
    {
    ...
    public String cancelLTCEncashInv(BaseQueryVO oQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    try
    {      
      PayrollNewFacadeHome oHome = (PayrollNewFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("PayrollNewFacade");
      PayrollNewFacade oEmpFinInfoFacade = oHome.create();
      String oLeaveInfo = oEmpFinInfoFacade.cancelLTCEncashInv((LTCEncashQueryVO)oQueryVO);
     return oLeaveInfo;
    }
    catch(RemoteException oRe)
    {
