...
public class MaintRmtAreaAllowBean extends PayrollBaseDetailBean 
{
  ...
  private String txtRmtArea;
  
  public MaintRmtAreaAllowBean()
  {
  }
  
  public MaintRmtAreaAllowBean(String sBasicFrom,String sBasicTo,String sCtgry,String sRmtArea,String sAllow,String sStartDt,String sEndDt)
  {
  ...
  public String getTxtRmtArea()
  {
    return txtRmtArea;
  }

  public void setTxtRmtArea(String newTxtRmtArea)
  {
    txtRmtArea = newTxtRmtArea;
  }
