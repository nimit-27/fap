...
public class EmpBriefcaseReimbursementHistoryDetailParm extends BaseDetailInfo implements Serializable{
    ...
    public EmpBriefcaseReimbursementHistoryDetailParm() {
