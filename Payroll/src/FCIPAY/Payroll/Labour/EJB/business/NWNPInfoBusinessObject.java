...
public class NWNPInfoBusinessObject extends BaseBO 
{

  public NWNPInfoBusinessObject()
  {
  }
  ...
  public void updateHeaderImpl(BaseHeaderBean oBaseHeaderBean) throws EnrgiseSystemException,EnrgiseApplicationException
  {
    ...
    String sPayModeType;
    int count = 0;
    NWNPInfoHeaderBean oEmpFinInfoHeaderBean = (NWNPInfoHeaderBean)oBaseHeaderBean;
  ...
  */  // Commented by dushyant on 23-MAy-2013  
    ...
    ArrayList oAddOutArray; //Output 
      ...
      oParameters.add(new DBObject(45,DBObject.IN,ParameterTypes.TIMESTAMP,FCIPAY.Payroll.common.utility.EnrgiseUtil.convertToSqlDate(oEmpFinInfoHeaderBean.getTxtCPFIntEndDt())));  // Added by Ravindra on date 18/june/2020
     ...
     // oParameters.add(new DBObject(45,DBObject.OUT,ParameterTypes.VARCHAR));
     // oParameters.add(new DBObject(46,DBObject.OUT,ParameterTypes.INTEGER));
     // oOutArray = oBean.callProc(oParameters,"PKG_PAY_LABOUR.proc_UpdateDpsLbrFinDetails(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",true,true);   
 ...
 */
    ArrayList oOutArray; //Output  
      ...
      oParameters.add(new DBObject(47,DBObject.OUT,ParameterTypes.VARCHAR,new String(oEmpFinInfoHeaderBean.getHeaderPrimaryKey())));
      oParameters.add(new DBObject(48,DBObject.IN,ParameterTypes.VARCHAR,new String(oEmpFinInfoHeaderBean.getTxtMemberId())));
  ...
  public RecordMetaInfo getNWNPInfoHeaderMetaInfo(NWNPInfoQueryVO oEmpFinanceQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ArrayList oParameters = new ArrayList(); //Input Parameters
    DBUtilitiesBean oBean = new DBUtilitiesBean();
    ArrayList oList;
  ...
  public ArrayList getNWNPInfoHeader(NWNPInfoQueryVO oEmpFinanceQueryVO,long lStartPosition,long lLastPosition) throws EnrgiseSystemException, EnrgiseApplicationException
  {      
    ArrayList oParameters = new ArrayList(); //Input Parameters
    DBUtilitiesBean oBean = new DBUtilitiesBean();
    ArrayList oList;
    ...
    {
      oEmpFinanceQueryVO = new NWNPInfoQueryVO();
    }
    ...
    NWNPInfoHeaderBean oEmpFinInfoHeaderBean ;
    count = 0;
    QueryRow oRow = null;
    ...
    while(oIt.hasNext())
    {
        ...
        oEmpFinInfoHeaderBean = new NWNPInfoHeaderBean();
       ...
       /*   if(oRow.get("EPS_FLAG")!=null && (oRow.get("EPS_FLAG").getString().equalsIgnoreCase("Y") || oRow.get("EPS_FLAG").getString().equalsIgnoreCase("P")))
        ...
        oEmpFinInfoHeaderBean.setTxtCPFIntEndDt(FCIPAY.Payroll.common.utility.EnrgiseUtil.convertToString(oRow.get("interest_end_date").getDate())); //// Added by Ravindra on date 18/june/2020
  ...
  private ArrayList getNWNPComboRecords(String sProc, String sField_id, String sField_desc)  throws EnrgiseSystemException, EnrgiseApplicationException 
  {
    DBUtilitiesBean oBean = new DBUtilitiesBean();
  ...
  public NWNPInfoComboVO getNWNPInfoComboDetails()  throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    NWNPInfoComboVO oEmpFin=null;
    QueryRow oRow = null;
    QueryValue oValue = null;
    ArrayList oList = null;
    Iterator oIt = null;       
        
    oEmpFin = new NWNPInfoComboVO();  
    
    ArrayList oEmpStatList = new ArrayList();
    oEmpStatList = getNWNPComboRecords("PKG_PAY_LABOUR.proc_GetDeptLbrStatus(?,?)","deptLbrstatus_id","DeptLbrstatus_desc");
    oEmpFin.setValueEmpStatArrayList(oEmpStatList);
    
    ArrayList oEmpStatAllList = new ArrayList();
    oEmpStatAllList = getNWNPComboRecords("PAYROLL_PKG_EXT.proc_GetEmpStatusLOV(?,?)","gbl_code","code_desc");
    oEmpFin.setValueEmpStatAllArrayList(oEmpStatAllList);
       
    ArrayList oParentZoneList = new ArrayList();
    oParentZoneList = getNWNPComboRecords("pkg_pay_labour.proc_GetLbrParentZone(?,?)","loc_id","loc_desc");
    oEmpFin.setValueParentZoneArrayList(oParentZoneList);

    ArrayList oEpsSepTypeList = new ArrayList();
    oEpsSepTypeList = getNWNPComboRecords("PAYROLL_PKG_EXT.getEPSSepType(?,?)","code_sdesc","code_desc");
    oEmpFin.setEpsSepTypList(oEpsSepTypeList);
   
    ArrayList oCasteCategList = new ArrayList();
    oCasteCategList = getNWNPComboRecords("PAYROLL_PKG_EXT.proc_getcastecateg(?,?)","code_sdesc","code_desc");
    oEmpFin.setValueCasteCategList(oCasteCategList);   
      
    ArrayList oHandiTypeList = new ArrayList();
    oHandiTypeList = getNWNPComboRecords("PAYROLL_PKG_EXT.proc_gethanditype(?,?)","code_sdesc","code_desc");
    oEmpFin.setValueHandiTypeList(oHandiTypeList);
    
    ArrayList oReligionList = new ArrayList();
    oReligionList = getNWNPComboRecords("PAYROLL_PKG_EXT.proc_getreligion(?,?)","code_sdesc","code_desc");
  ...
  public LovVO getQueryNWNPLabourLOVData(LovQueryVO oLovQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    oParameters.add(new DBObject(5,DBObject.IN,ParameterTypes.VARCHAR,new String("N")));   // added by dushyant on 15-11-2010
  ...
  {  
    ArrayList oList = new ArrayList();
      ...
      NWNPInfoHeaderBean oNWNPInfoHeaderBean =(NWNPInfoHeaderBean)oBaseHeaderBean;
      checkMaxPayYear(oNWNPInfoHeaderBean.getTxtSiteID(),oNWNPInfoHeaderBean.getHdnEmpLbrFlag());
      reportError(oList);
 ...
 */ 
  ...
  public LovVO getNWNPInfoDsgnLOVData(LovQueryVO oLovQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {     
    LovVO oLovVO=new LovVO();  
    ArrayList arylstHeaderNames=new ArrayList();
    ...
    ArrayList oOutArray; //Output 
    oParameters = new ArrayList();
    oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,new String("N")));
