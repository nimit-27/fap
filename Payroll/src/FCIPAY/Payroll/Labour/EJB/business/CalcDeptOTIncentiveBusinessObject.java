...
public class CalcDeptOTIncentiveBusinessObject extends BaseBO
{
  public CalcDeptOTIncentiveBusinessObject()
  {
  }
  ...
  public String calcDeptOTIncentive(long lUserID,long lSiteID,CalcDeptOTIncentiveHeaderBean oCalcDeptOTIncentiveHeaderBean) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    ArrayList oOutArray; //Output 
      ...
      oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,new String(oCalcDeptOTIncentiveHeaderBean.getTxtGangId())));
      oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR,new String(oCalcDeptOTIncentiveHeaderBean.getTxtLocId())));
      ...
      oOutArray = oBean.callProc(oParameters,"pkg_lbr_compute_inct_v2.proc_createDeptLabrOTIncnt_txn(?,?,?,?,?,?)",true,true);      
