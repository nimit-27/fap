...
public class CalcDeptIncentiveBusinessObject extends BaseBO
{
  public CalcDeptIncentiveBusinessObject()
  {
  }
  ...
  public String calcDeptIncentive(long lUserID,long lSiteID,CalcDeptIncentiveHeaderBean oCalcDeptIncentiveHeaderBean) throws EnrgiseSystemException, EnrgiseApplicationException
  {
   ...
   /* oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,new String(oCalcDeptIncentiveHeaderBean.getTxtGangId())));
    oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR,new String(oCalcDeptIncentiveHeaderBean.getTxtLocId())));
    oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,new String(oCalcDeptIncentiveHeaderBean.getScreenFlag())));
    oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.TIMESTAMP,EnrgiseUtil.convertToSqlDate(oCalcDeptIncentiveHeaderBean.getTxtFrom())));
    oParameters.add(new DBObject(5,DBObject.IN,ParameterTypes.TIMESTAMP,EnrgiseUtil.convertToSqlDate(oCalcDeptIncentiveHeaderBean.getTxtTo())));
    ...
    oOutArray = oBean.callProc(oParameters,"pkg_lbr_compute_inct_v2.proc_computedptlbrincentive_v2(?,?,?,?,?,?,?,?,?)",true,true);      */
       ...
       oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,""));
        ...
        oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,new String(oCalcDeptIncentiveHeaderBean.getHdnEmpLbrFlag())));
       ...
       oParameters.add(new DBObject(9,DBObject.IN,ParameterTypes.INTEGER,new Integer(0)));
        ...
        oParameters.add(new DBObject(10,DBObject.IN,ParameterTypes.VARCHAR,new String(oCalcDeptIncentiveHeaderBean.getTxtGangId())));
        oParameters.add(new DBObject(11,DBObject.IN,ParameterTypes.VARCHAR,new String(oCalcDeptIncentiveHeaderBean.getTxtLocId())));
        ...
        oParameters.add(new DBObject(17,DBObject.IN,ParameterTypes.VARCHAR,new String(oCalcDeptIncentiveHeaderBean.getScreenFlag())));
        oParameters.add(new DBObject(18,DBObject.IN,ParameterTypes.TIMESTAMP,EnrgiseUtil.convertToSqlDate(oCalcDeptIncentiveHeaderBean.getTxtFrom())));
        oParameters.add(new DBObject(19,DBObject.IN,ParameterTypes.TIMESTAMP,EnrgiseUtil.convertToSqlDate(oCalcDeptIncentiveHeaderBean.getTxtTo())));
 ...
 /*   if(!(errCode.equals(new Integer(1))))
    {
        updateSessionStatus("INCENTIVE", lSiteID, oCalcDeptIncentiveHeaderBean.getHdnEmpLbrFlag());
    } */
