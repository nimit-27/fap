...
import FCIPAY.Payroll.Labour.Utility.NWNPLbrAncllryAttndBean;
...
public class NWNPLbrAncllryAttndBusinessObject extends BaseBO{
    public NWNPLbrAncllryAttndBusinessObject() {
    ...
    public RecordMetaInfo getNWNPAncllryAttndHeaderMetaInfo(NWNPLbrAncllryAttndQueryVO oLbrAncllryAttndQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
     {
       ...
       ArrayList oOutArray; //Output 
         ...
         oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,new String(oLbrAncllryAttndQueryVO.getHdnEmpLbrFlag())));
         ...
         oOutArray = oBean.callProc(oParameters,"PKG_PAY_LABOUR.proc_GetNwnpAncyAttndCount(?,?,?,?,?,?)");      
     ...
     public ArrayList getNWNPAncllryAttndHeader(NWNPLbrAncllryAttndQueryVO oLbrAncllryAttndQueryVO,long lStartPosition,long lLastPosition) throws EnrgiseSystemException, EnrgiseApplicationException
     {
       ...
       {
         oLbrAncllryAttndQueryVO = new NWNPLbrAncllryAttndQueryVO();
       }
       ...
       ArrayList oHeaderList = null;
         ...
         oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,new String(oLbrAncllryAttndQueryVO.getHdnEmpLbrFlag())));
         ...
         oOutArray = oBean.callProc(oParameters,"PKG_PAY_LABOUR.proc_GetNwnpAncyAttndHeader(?,?,?,?,?,?,?)");
         ...
         NWNPLbrAncllryAttndHeaderBean oLbrAncllryAttndHeaderBean;
         count = 0;
         QueryRow oRow = null;
         ...
         while(oIt.hasNext())
         {
             ...
             oLbrAncllryAttndHeaderBean = new NWNPLbrAncllryAttndHeaderBean();          
             oLbrAncllryAttndHeaderBean.setLstLabourType(oRow.get("lbr_typ").getString());
             oLbrAncllryAttndHeaderBean.setTxtLocId(oLbrAncllryAttndQueryVO.getTxtLocId().toString());
             oLbrAncllryAttndHeaderBean.setTxtLocation(oRow.get("loc_desc").getString());
    ...
    public RecordMetaInfo getNWNPAncllryAttndDetailMetaInfo(String sPrimaryKey,NWNPLbrAncllryAttndDetailInfo oLbrAncllryAttndDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException
     //public RecordMetaInfo getDARatesDetailMetaInfo(String sYear, String sDAType, String sPayScaleType) throws EnrgiseSystemException, EnrgiseApplicationException
     {
       ...
       ArrayList oOutArray; //Output 
         ...
         {
             return getNWNPLabourDetailMetaInfo(oLbrAncllryAttndDetailInfo);
         }
                  
         oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,oLbrAncllryAttndDetailInfo.getLstLabourType()));  
         oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR,oLbrAncllryAttndDetailInfo.getTxtLocId()));
         ...
         oParameters.add(new DBObject(5,DBObject.OUT,ParameterTypes.TIMESTAMP));
         oParameters.add(new DBObject(6,DBObject.OUT,ParameterTypes.INTEGER));      
         oOutArray = oBean.callProc(oParameters,"PKG_PAY_LABOUR.proc_GetNwnpAncyAttndDtlCt(?,?,?,?,?,?)");    
    ...
    public ArrayList getNWNPAncllryAttndDetail(String sPrimaryKey, long lDetailFirstPosition,long lDetailLastPosition, NWNPLbrAncllryAttndDetailInfo oLbrAncllryAttndDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException  
     {  
       ArrayList oParameters = new ArrayList(); //Input Parameters
       DBUtilitiesBean oBean = new DBUtilitiesBean();
       int count = 0;
       ArrayList oOutArray; //Output 
       NWNPLbrAncllryAttndBean oLbrAncllryAttndBean;
       QueryRow oRow = null;
       ...
       ArrayList oDARateDetail = null;    
         ...
         oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,oLbrAncllryAttndDetailInfo.getLstLabourType()));
         oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.VARCHAR,oLbrAncllryAttndDetailInfo.getTxtLocId()));
         ...
         oParameters.add(new DBObject(6,DBObject.OUT,ParameterTypes.CURSOR));
         oParameters.add(new DBObject(7,DBObject.OUT,ParameterTypes.INTEGER));
         oOutArray = oBean.callProc(oParameters,"PKG_PAY_LABOUR.proc_getnwnpancyattnddetail(?,?,?,?,?,?,?)");
           ...
           while(oIt.hasNext())
           {
             ...
             count++;
             oRow = (QueryRow)oIt.next();
             oLbrAncllryAttndBean = new NWNPLbrAncllryAttndBean();          
     ...
     private RecordMetaInfo getNWNPLabourDetailMetaInfo(NWNPLbrAncllryAttndDetailInfo oLbrAncllryAttndDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException
     //public RecordMetaInfo getDARatesDetailMetaInfo(String sYear, String sDAType, String sPayScaleType) throws EnrgiseSystemException, EnrgiseApplicationException
     {
       ArrayList oParameters = new ArrayList(); //Input Parameters
       DBUtilitiesBean oBean = new DBUtilitiesBean();
       ArrayList oOutArray; //Output 
         ...
         oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.VARCHAR,oLbrAncllryAttndDetailInfo.getHdnEmpLbrFlag()));  
         oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.VARCHAR,oLbrAncllryAttndDetailInfo.getTxtLocId()));
         //oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,sPrimaryKey));            
         ...
         oOutArray = oBean.callProc(oParameters,"PKG_PAY_LABOUR.proc_GetNwnpAncllryLabourDtlCt(?,?,?,?,?)");      
     ...
     private ArrayList getLabourDetail(String sPrimaryKey, long lDetailFirstPosition,long lDetailLastPosition,NWNPLbrAncllryAttndDetailInfo oLbrAncllryAttndDetailInfo) throws EnrgiseSystemException, EnrgiseApplicationException  
     {  
       ArrayList oParameters = new ArrayList(); //Input Parameters
       DBUtilitiesBean oBean = new DBUtilitiesBean();
       int count = 0;
       ...
       ArrayList oDARateDetail = null;
         ...
         oParameters.add(new DBObject(1,DBObject.IN,ParameterTypes.BIGINT,new Long(lDetailFirstPosition)));
         oParameters.add(new DBObject(2,DBObject.IN,ParameterTypes.BIGINT,new Long(lDetailLastPosition)));
         oParameters.add(new DBObject(3,DBObject.IN,ParameterTypes.VARCHAR,oLbrAncllryAttndDetailInfo.getHdnEmpLbrFlag()));      
         oParameters.add(new DBObject(4,DBObject.IN,ParameterTypes.VARCHAR,oLbrAncllryAttndDetailInfo.getTxtLocId()));
         //oParameters.add(new DBObject(5,DBObject.IN,ParameterTypes.VARCHAR,sPrimaryKey));
         oParameters.add(new DBObject(5,DBObject.OUT,ParameterTypes.CURSOR));
         oParameters.add(new DBObject(6,DBObject.OUT,ParameterTypes.INTEGER));
         oOutArray = oBean.callProc(oParameters,"PKG_PAY_LABOUR.proc_GetNwnpAncyLabourDetail(?,?,?,?,?,?)");
     ...
     public boolean savePayScaleHeader(NWNPLbrAncllryAttndHeaderBean oLbrAncllryAttndHeaderBean) throws EnrgiseSystemException, EnrgiseApplicationException
     {
          return true;
     }
    ...
    //  public void saveDetailImpl(String sHeaderPrimaryKey,String sScreenName, ArrayList oDetailBeanArray) throws EnrgiseSystemException
     ...
     if(sScreenName.equals("NWNPAncllryAttndScreen"))
       {
         sPayScaleType = "IDA";    
         saveAncllryAttnd(sPayScaleType,oDetailBeanArray,(NWNPLbrAncllryAttndHeaderBean)oBaseHeaderBean);
       }
       else 
       {
         sPayScaleType = "CDA";    
    ...
    private void saveAncllryAttnd(String sHeaderPrimaryKey, ArrayList oDetailBeanArray,NWNPLbrAncllryAttndHeaderBean oLbrAncllryAttndHeaderBean) throws EnrgiseSystemException
     {
       ...
       DBUtilitiesBean oBeanDelete = null;
         ...
         while(oIt.hasNext())
         {
           NWNPLbrAncllryAttndBean oLbrAncllryAttndBean = (NWNPLbrAncllryAttndBean)oIt.next();
    ...
    public void additionalFieldValidationImpl(BaseHeaderBean oBaseHeaderBean, Timestamp oWhenPicked, String sScreenName, String sScreenMode, boolean bHeaderDataChanged, ArrayList oDetailBeanArray,boolean bDetailDataChanged, Timestamp oDetailPicked) throws EnrgiseSystemException, EnrgiseApplicationException
     {
       if(bDetailDataChanged)
       {
           ...
           NWNPLbrAncllryAttndHeaderBean oLbrAncllryAttndHeaderBean=(NWNPLbrAncllryAttndHeaderBean)oBaseHeaderBean;
    ...
    //        System.out.println(oMaintCityTypeBean.getStatus());
     ...
     private void checkLWPCountBeforeSave(BaseHeaderBean oBaseHeaderBean,String sScreenMode,ArrayList oDetailBeanArray, ArrayList oList) throws EnrgiseSystemException, EnrgiseApplicationException
     {
       ...
       while(oIt.hasNext())
       {
           NWNPLbrAncllryAttndBean ooLbrAncllryAttndBean = (NWNPLbrAncllryAttndBean)oIt.next();
           vLWPcount=0;
