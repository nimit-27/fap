...
public class CalcDeptOTIncentiveBD extends BaseBD
{
  public CalcDeptOTIncentiveBD()
  {
  }
 public String calcDeptOTIncentive(long lUserID,long lSiteID,CalcDeptOTIncentiveHeaderBean oCalcDeptOTIncentiveHeaderBean) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      LabourFacade oLabourFacade = oHome.create();
       ...
       return oLabourFacade.calcDeptOTIncentive(lUserID,lSiteID,oCalcDeptOTIncentiveHeaderBean);
    }
