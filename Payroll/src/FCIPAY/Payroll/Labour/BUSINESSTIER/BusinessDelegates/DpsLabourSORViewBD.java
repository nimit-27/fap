...
public class DpsLabourSORViewBD extends PayrollBaseBD
{
  public DpsLabourSORViewBD()
  {
      super();  
  }
  ...
  { 
    ...
    {      
      ...
      if(sScreenName.equalsIgnoreCase("MaintDpsLbrSORView"))  
      {
          return oLabourFacade.getDpsLbrSORViewMetaInfo(sPrimaryKey,sScreenName);
      }
      return null;
    }
  ...
  public ArrayList getDetailRecordImpl(String sPrimaryKey,String sScreenName,long lAbsoluteStart,long lAbsoluteEnd) throws EnrgiseSystemException, EnrgiseApplicationException, RemoteException
  {
    ...
    {      
      ...
      if(sScreenName.equalsIgnoreCase("MaintDpsLbrSORView"))  
      {
          return oLabourFacade.getDpsLbrSORViewDetail(sPrimaryKey,lAbsoluteStart,lAbsoluteEnd);     
      }
      return null;
    }
    catch(RemoteException oRe)
...
//      return oSysFacade.saveGlobalCodeHeader((GlobalCodeHeaderBean)oBaseHeaderBean);
  ...
  public RecordMetaInfo getHeaderMetaImpl(BaseQueryVO oQueryVO) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      LabourFacadeHome oHome = (LabourFacadeHome)FCIPAY.Payroll.common.utility.ServiceLocator.getLocator().getService("LabourFacade");
      LabourFacade oLabourFacade = oHome.create();
      return oLabourFacade.getSORViewHeaderMetaInfo((DpsLabourSORViewQryVO)oQueryVO);
    }
  ...
  public ArrayList getHeaderRecordImpl(BaseQueryVO oQueryVO,long lStartPosition,long lLastPosition) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {       
      ...
      ArrayList oHeaderList = oLabourFacade.getSORViewHeader((DpsLabourSORViewQryVO)oQueryVO,lStartPosition,lLastPosition);
      return oHeaderList;
    }
    catch(RemoteException oRe)
    {
