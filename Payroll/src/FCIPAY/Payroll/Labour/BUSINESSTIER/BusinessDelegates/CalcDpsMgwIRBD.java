...
public class CalcDpsMgwIRBD extends BaseBD
{
  public CalcDpsMgwIRBD()
  {
  }
 public String calcDpsMgwIR (long lUserID,long lSiteID,CalcDpsMgwIRHeaderBean oCalcDpsMgwIRHeaderBean) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      LabourFacade oLabourFacade = oHome.create();
       ...
       return oLabourFacade.calcDpsMgwIR(lUserID,lSiteID,oCalcDpsMgwIRHeaderBean);
    }
  ...
  public String getMaxPayYear(long locCode,String hdnEmpLbrFlag) throws EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    {      
      ...
      return oInitFacade.getCalcDpsMgwMaxPayYear(locCode,hdnEmpLbrFlag);
    }
    catch(RemoteException oRe)
    {
      throw new EnrgiseSystemException(oRe);
