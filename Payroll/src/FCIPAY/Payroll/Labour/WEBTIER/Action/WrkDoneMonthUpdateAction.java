...
public class WrkDoneMonthUpdateAction extends BaseAction
{
  public WrkDoneMonthUpdateAction()
  {
  }
 ...
 public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
      ...
      /*End of Code */
          ...
          String oErrorCode = oCalcDpsWrkDoneBD.monthEnd(lUserID,lSiteID,(CalcDpsWrkDoneHeaderBean)oBaseHeaderBean);
          System.out.println(oErrorCode);
       
       /*   if(EmpLbrFlag.equals("L"))          
            throw new EnrgiseApplicationException("Pay.Lbr.MonthEndIncentive.Success.Message",EnrgiseConstants.MESSAGE);      
          else  
            throw new EnrgiseApplicationException("Pay.Lbr.MonthEndWrkDone.Success.Message",EnrgiseConstants.MESSAGE); */
