...
import FCIPAY.Payroll.Labour.WEBTIER.Form.CalcDpsMgwIRForm;
import FCIPAY.Payroll.Labour.BUSINESSTIER.BusinessDelegates.CalcDpsMgwIRBD;
import FCIPAY.Payroll.Labour.Utility.CalcDpsMgwIRHeaderBean;
import java.util.ArrayList;
import FCIPAY.Payroll.common.utility.EnrgiseConstants;
import FCIPAY.COMMON.UTILITY.UserInfoBean;

public class CalcDpsMgwIRAction extends BaseAction 
{
  public CalcDpsMgwIRAction()
  {
  }
  ...
  public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
      ...
      CalcDpsMgwIRBD oCalcDpsMgwIRBD=(CalcDpsMgwIRBD)oBaseBD;
      long lUserID = 200;
      long lSiteID = 200;
      String butAction = "";   

      CalcDpsMgwIRForm fedoForm = (CalcDpsMgwIRForm)oBaseForm;
      ...
      {
          String oErrorCode = oCalcDpsMgwIRBD.calcDpsMgwIR(lUserID,lSiteID,(CalcDpsMgwIRHeaderBean)oBaseHeaderBean);
...
//      Modified By Balpreet Dt 23-Oct 2007. for displaying success msg properly...
          ...
          if(oErrorCode.equals("0SUCCESS")) {
            throw new EnrgiseApplicationException("Pay.Lbr.Mgw.Success.Message",EnrgiseConstants.MESSAGE);
          }
          else {
      ...
      {
            throw new EnrgiseApplicationException("Pay.Lbr.Mgw.Progress.Message",FCIPAY.Payroll.common.utility.EnrgiseConstants.MESSAGE);        
      }      
