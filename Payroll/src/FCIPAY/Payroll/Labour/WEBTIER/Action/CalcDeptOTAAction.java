...
import FCIPAY.Payroll.Labour.WEBTIER.Form.CalcDeptOTAForm;
import FCIPAY.Payroll.Labour.BUSINESSTIER.BusinessDelegates.CalcDeptOTABD;
import FCIPAY.Payroll.Labour.Utility.CalcDeptOTAHeaderBean;
import java.util.ArrayList;
import FCIPAY.Payroll.common.utility.EnrgiseConstants;
import FCIPAY.COMMON.UTILITY.UserInfoBean;

public class CalcDeptOTAAction extends BaseAction 
{
  public CalcDeptOTAAction()
  {
  }
  ...
  public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
      ...
      CalcDeptOTABD oCalcDeptOTABD=(CalcDeptOTABD)oBaseBD;
      long lUserID = 200;
      long lSiteID = 200;
      String butAction = "";   

      CalcDeptOTAForm fedoForm = (CalcDeptOTAForm)oBaseForm;
      ...
      {
          String oErrorCode = oCalcDeptOTABD.calcDeptOTA(lUserID,lSiteID,(CalcDeptOTAHeaderBean)oBaseHeaderBean);
