...
import FCIPAY.Payroll.Labour.WEBTIER.Form.CalcDeptIncentiveForm;
import FCIPAY.Payroll.Labour.BUSINESSTIER.BusinessDelegates.CalcDeptIncentiveBD;
import FCIPAY.Payroll.Labour.Utility.CalcDeptIncentiveHeaderBean;
import java.util.ArrayList;
import FCIPAY.Payroll.common.utility.EnrgiseConstants;
import FCIPAY.COMMON.UTILITY.UserInfoBean;

public class CalcDeptIncentiveAction extends BaseAction 
{
  public CalcDeptIncentiveAction()
  {
  }
  ...
  public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
      ...
      CalcDeptIncentiveBD oCalcDeptIncentiveBD=(CalcDeptIncentiveBD)oBaseBD;
      long lUserID = 200;
      long lSiteID = 200;
      String butAction = "";   

      CalcDeptIncentiveForm fedoForm = (CalcDeptIncentiveForm)oBaseForm;
      ...
      {
          String oErrorCode = oCalcDeptIncentiveBD.calcDeptIncentive(lUserID,lSiteID,(CalcDeptIncentiveHeaderBean)oBaseHeaderBean);
...
//      Modified By Balpreet Dt 23-Oct 2007. for displaying success msg properly...
          ...
          if(oErrorCode.equals("0SUCCESS")) {
            throw new EnrgiseApplicationException("Pay.Lbr.Incentive.Success.Message",EnrgiseConstants.MESSAGE);
          }
          else {
