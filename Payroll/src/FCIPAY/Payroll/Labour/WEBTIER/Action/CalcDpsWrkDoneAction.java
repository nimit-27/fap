...
public class CalcDpsWrkDoneAction extends BaseAction 
{
  public CalcDpsWrkDoneAction()
  {
  }
  ...
  public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
      ...
      {
            String oErrorCode = oCalcDpsWrkDoneBD.calcDpsWrkDone(lUserID,lSiteID,(CalcDpsWrkDoneHeaderBean)oBaseHeaderBean);
      ...
      {
            throw new EnrgiseApplicationException("Pay.Lbr.WrkDone.Progress.Message",FCIPAY.Payroll.common.utility.EnrgiseConstants.MESSAGE);        
      }      
