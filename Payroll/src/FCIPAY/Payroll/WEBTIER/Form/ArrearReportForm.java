...
public class ArrearReportForm extends PayrollBaseForm
{
...
public String getTxtGangName()
 ...
 public void setTxtGangName(String newTxtGangName)
  ...
  {
  System.out.println("inside getter  "+txtGangId);
    return txtGangId;
  }
  ...
  public void setTxtGangId(String newTxtGangId)
  {
    txtGangId = newTxtGangId;
     System.out.println("inside setter  "+txtGangId);
  }
