...
//import FCIPAY.Payroll.WEBTIER.Form.EditPayImageForm; //commented by devendra
import FCIPAY.Payroll.UTILITY.EnqPayImgBean;

public class EditPayImgAddRowAction extends BaseAction
{
  public EditPayImgAddRowAction()
  {
  }
...
//      oBaseDetailVO = oBaseBD.getDetailRecord(sFormName,sScreenName,sHeaderPrimaryKey,lPageRequested,oDetailSizeValues,oBaseDetailVO,false,oUser);
      ...
      // Get another new bean instance
      //BaseDetailBean oBaseDetailBean = getDetailBean(form);
      /*String sEarnDedVal = request.getParameter("IncVal");
      if(sScreenName.equals("EditPayImgScreen"))
      {
        //EditPayImageForm fedoForm = (EditPayImageForm)oBaseForm;
        EnqPayImgBean fedoBean = (EnqPayImgBean)oBaseDetailBean;
        if (sEarnDedVal.equals("Earn"))
          fedoBean.setTxtPayMode(new String("1"));
        else
          fedoBean.setTxtPayMode(new String("2"));
