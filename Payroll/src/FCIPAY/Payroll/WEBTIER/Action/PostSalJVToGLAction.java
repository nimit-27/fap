...
import FCIPAY.Payroll.BUSINESSTIER.BusinessDelegates.PostSalJVToGLBD;
import java.util.ArrayList;
public class PostSalJVToGLAction extends BaseAction
{
  public PostSalJVToGLAction()
  {
  }
 ...
 public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
     ...
     PostSalJVToGLBD oPostSalJVToGLBD=(PostSalJVToGLBD)oBaseBD;
    //PostSalJVToGLBD oPostSalJVToGLBD = new PostSalJVToGLBD();
     String oErrorCode =oPostSalJVToGLBD.PostSalJVGL(lUserID,lSiteID);
