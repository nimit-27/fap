...
import FCIPAY.Payroll.BUSINESSTIER.BusinessDelegates.PostRemitToAPBD;
import java.util.ArrayList;
import FCIPAY.Payroll.WEBTIER.Form.PostRemitToAPForm;

public class PostRemitToAPAction extends BaseAction
{
  public PostRemitToAPAction()
  {
  }
 ...
 public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
      ...
      if(request.getSession().getAttribute("USERINFO")==null){}
        ...
        PostRemitToAPForm fedoForm = (PostRemitToAPForm)oBaseForm;
        PostRemitToAPBD oPostRemitToAPBD=(PostRemitToAPBD)oBaseBD;
        ...
        {
            String oErrorCode =oPostRemitToAPBD.PostRemitToAP(lUserID,lSiteID,fedoForm.getHdnEmpLbrFlag(),invoice_date); 
