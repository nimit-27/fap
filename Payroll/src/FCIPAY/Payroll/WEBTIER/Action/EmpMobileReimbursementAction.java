...
import FCIPAY.Payroll.BUSINESSTIER.BusinessDelegates.EmpMobileReimbursementBD;
import java.util.ArrayList;
import FCIPAY.Payroll.common.utility.EnrgiseConstants;
import FCIPAY.Payroll.DATAACCESSTIER.VO.EmpMobileReimbursementQueryVO;

public class EmpMobileReimbursementAction extends BaseAction
{
  public EmpMobileReimbursementAction()
  {
  }
  ...
  public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
        ...
        EmpMobileReimbursementForm fedoForm = (EmpMobileReimbursementForm)oBaseForm;
        EmpMobileReimbursementBD oEmpMobileReimbursementBD=(EmpMobileReimbursementBD)oBaseBD;
        lUserID = fedoForm.getLoginEmployeeNo();
        lSiteID = fedoForm.getLoginLocCode();
        String errMsg = oEmpMobileReimbursementBD.sendInv(fedoForm.getHeaderPrimaryKey(),fedoForm.getHdnEmpLbrFlag(),lUserID,lSiteID);
