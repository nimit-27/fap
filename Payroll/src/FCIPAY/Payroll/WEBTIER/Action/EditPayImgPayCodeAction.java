...
import FCIPAY.Payroll.WEBTIER.Form.EditPayImgForm;
import FCIPAY.Payroll.BUSINESSTIER.BusinessDelegates.EditPayImageBD;
import java.util.ArrayList;
import FCIPAY.Payroll.common.utility.EnrgiseConstants;
import FCIPAY.Payroll.DATAACCESSTIER.VO.EmpMediBillsQueryVO;
import java.io.PrintWriter;

public class EditPayImgPayCodeAction extends BaseAction
{
  public EditPayImgPayCodeAction()
  {
  }
  ...
  {        
    ...
    EditPayImageBD oBaseBD = new EditPayImageBD();  
    EditPayImgForm fedoForm = (EditPayImgForm)oBaseForm;
    ...
    String sPayCode=request.getParameter("payCodeVal");
    //String fldName=request.getParameter("fldVal");    
    
    
    ArrayList payCodeInfo = new ArrayList();    
    payCodeInfo = oBaseBD.getPayCodeDetail(sPayCode);
