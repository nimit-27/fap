...
public class GetLocationsAjax extends Action 
{
	StringBuffer xml;
    ...
    private void getData(HttpServletRequest req) throws EnrgiseSystemException
    {
        ...
        oOutArray = oBean.callProc(oParameters,"pkg_payroll_misc_ext.proc_getLastPostedLocation(?,?,?)");
        ...
        while(oIt.hasNext())
        {
            ...
            xml.append("<record>");
            xml.append("<locid>"+ oRow.get("created_site_id").getString() +"</locid>");
            xml.append("<locid>"+ oRow.get("loc_desc").getString() +"</locid>");
            xml.append("</record>");
        } 
