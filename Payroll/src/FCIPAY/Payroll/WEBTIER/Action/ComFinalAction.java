...
public class ComFinalAction extends BaseAction
{
  public ComFinalAction()
  {
  }
  ...
  public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
    ...
    BaseHeaderBean oBaseHeaderBean=new BaseHeaderBean();
    ...
    //added by swarnika in ref to VRS
    if(procs.equals("VRS"))
    {
      errorCode = oComFinalSetBD.compute(procs,oComFinalSetQueryVO);
    }
    if(procs.equals("DEL"))
    {
       oComFinalSetBD.deleteComSepEntry( oBaseHeaderBean);
    }
     if(procs.equals("EDIT"))
    {
      errorCode = oComFinalSetBD.compute(procs,oComFinalSetQueryVO);
    }
