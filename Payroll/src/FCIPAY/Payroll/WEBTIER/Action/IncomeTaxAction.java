...
import FCIPAY.Payroll.WEBTIER.Form.CompIncTaxForm;
import FCIPAY.Payroll.BUSINESSTIER.BusinessDelegates.IncomeTaxBD;
...
public class IncomeTaxAction extends BaseAction
{
  ...
  public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
      ...
      IncomeTaxBD oIncomeTaxBD=(IncomeTaxBD)oBaseBD;
      String butAction = "";  
      long loginUserId = 100 ;
      long lLoginSiteId = 100  ;
      CompIncTaxForm fedoForm = (CompIncTaxForm)oBaseForm;
      ...
      {  
          //String oErrorCode = oIncomeTaxBD.computeProjectedTax(oBaseHeaderBean,loginUserId,lLoginSiteId);
          String oErrorCode = oIncomeTaxBD.computeActualTax(oBaseHeaderBean,loginUserId,lLoginSiteId);
          ...
          throw new EnrgiseApplicationException("Pay.Undo.Payroll_ERROR",oArguments);
            ...
            /*if(oErrorCode.equals("INCTAX_MTHY_PRYL_RUN_EX"))
             ...
             if(oErrorCode.equals("INCTAX_SUCCES_EX"))
                  {
                    throw new EnrgiseApplicationException("INCTAX.SUCCES.EX",FCIPAY.Payroll.common.utility.EnrgiseConstants.MESSAGE);
                  }
      ...
      {
            throw new EnrgiseApplicationException("Pay.Comp.IncTax.Progress.Message",FCIPAY.Payroll.common.utility.EnrgiseConstants.MESSAGE);        
      }      
