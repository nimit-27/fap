...
import FCIPAY.Payroll.BUSINESSTIER.BusinessDelegates.EmpLocalTravelAllowanceBD;
import java.util.ArrayList;
import FCIPAY.Payroll.common.utility.EnrgiseConstants;
import FCIPAY.Payroll.DATAACCESSTIER.VO.EmpLocalTravelAllowanceQueryVO;

public class EmpLocalTravelAllowanceAction extends BaseAction
{
  public EmpLocalTravelAllowanceAction()
  {
  }
  ...
  public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
        ...
        EmpLocalTravelAllowanceForm fedoForm = (EmpLocalTravelAllowanceForm)oBaseForm;
        EmpLocalTravelAllowanceBD oEmpLocalTravelAllowanceBD=(EmpLocalTravelAllowanceBD)oBaseBD;
        lUserID = fedoForm.getLoginEmployeeNo();
        lSiteID = fedoForm.getLoginLocCode();
        String errMsg = oEmpLocalTravelAllowanceBD.sendInv(fedoForm.getHeaderPrimaryKey(),fedoForm.getHdnEmpLbrFlag(),lUserID,lSiteID);
