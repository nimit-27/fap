...
import FCIPAY.Payroll.BUSINESSTIER.BusinessDelegates.EmpLtcHomeReimbursementBD;
import java.util.ArrayList;
import FCIPAY.Payroll.common.utility.EnrgiseConstants;
import FCIPAY.Payroll.DATAACCESSTIER.VO.EmpLtcHomeReimbursementQueryVO;

public class EmpLtcHomeReimbursementAction extends BaseAction
{
  public EmpLtcHomeReimbursementAction()
  {
  }
  ...
  public ActionForward executeImpl(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, ClassNotFoundException, InstantiationException, InvocationTargetException, IllegalAccessException, EnrgiseSystemException, EnrgiseApplicationException
  {
        ...
        EmpLtcHomeReimbursementForm fedoForm = (EmpLtcHomeReimbursementForm)oBaseForm;
        EmpLtcHomeReimbursementBD oEmpLtcHomeReimbursementBD=(EmpLtcHomeReimbursementBD)oBaseBD;
        lUserID = fedoForm.getLoginEmployeeNo();
        lSiteID = fedoForm.getLoginLocCode();
        String errMsg = oEmpLtcHomeReimbursementBD.sendInv(fedoForm.getHeaderPrimaryKey(),fedoForm.getHdnEmpLbrFlag(),lUserID,lSiteID);
